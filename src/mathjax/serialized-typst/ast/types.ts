...
export const enum TypstMathNodeType {
  Seq = 'seq',
  Symbol = 'symbol',
  Text = 'text',
  Number = 'number',
...
export const enum DelimiterSize {
  Big = 'big',
  Bigg = 'bigg',
}
...
export const enum ArgValueType {
  Math = 'math',
  String = 'string',
  Bool = 'bool',
  Ident = 'ident',
...
export type ArgValue =
  | { readonly type: ArgValueType.Math; readonly node: TypstMathNode }
  | { readonly type: ArgValueType.String; readonly value: string }
  | { readonly type: ArgValueType.Bool; readonly value: boolean }
  | { readonly type: ArgValueType.Ident; readonly value: string }
  | { readonly type: ArgValueType.Length; readonly value: string }
  | { readonly type: ArgValueType.Raw; readonly value: string }
  | { readonly type: ArgValueType.InlineMath; readonly node: TypstMathNode; readonly display?: boolean }
  | { readonly type: ArgValueType.Call; readonly node: FuncCallNode };
...
export const astNodeStore = new WeakMap<object, {
