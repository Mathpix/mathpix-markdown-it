...
export const menuStyle = () => {
  return `
    .mmd-menu {
        ...
        box-shadow: 0px 10px 20px ${COLOR_MENU_SHADOW};
        -webkit-box-shadow: 0px 10px 20px ${COLOR_MENU_SHADOW};
        -moz-box-shadow: 0px 10px 20px ${COLOR_MENU_SHADOW};
        -khtml-box-shadow: 0px 10px 20px ${COLOR_MENU_SHADOW};
    }
