...
2. **Command arguments with `\\`** — the escape parity in `findEndMarker` (`common.ts`). Reverting it brings back the dropped caption and heading; its optional `inlineCodePositions` parameter must stay, or group 5 loses it.
