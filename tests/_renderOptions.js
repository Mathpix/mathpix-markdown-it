...
describe("Check renderOptions:", () => {
  ...
  //disableRulesGroup
  describe("Should be disable only chem rules. {disableRulesGroup: {chem: true}}", () => {
    const mmdContent = require("./_data/_renderOprions/_mmd");
    const htmlContent = require("./_data/_renderOprions/_html_disable_chem_only");
    const html = MM.markdownToHTML(mmdContent, Object.assign({}, options, {
      renderOptions: {
        disableRulesGroup: {
          chem: true
  ...
  describe("Should be disable math rules. {disableRulesGroup: {math: true}}", () => {
    const mmdContent = require("./_data/_renderOprions/_mmd");
    const htmlContent = require("./_data/_renderOprions/_html_disable_math_only");
    const html = MM.markdownToHTML(mmdContent, Object.assign({}, options, {
      renderOptions: {
        disableRulesGroup: {
          math: true
  ...
  describe("Should be disable only simpleMath rules. {disableRulesGroup: {simpleMath: true}}", () => {
    const mmdContent = require("./_data/_renderOprions/_mmd");
    const htmlContent = require("./_data/_renderOprions/_html_disable_simpleMath_only");
    const html = MM.markdownToHTML(mmdContent, Object.assign({}, options, {
      renderOptions: {
        disableRulesGroup: {
          simpleMath: true
