...
+ \\quad 7 x ^ { 2 } - 11 x +7 \\\\ \\hline \\end{array}`,
    asciimath: `5x^(2)-11 x-3+7x^(2)-11 x+7`,
    linearmath: `5x²−11 x−3+7x²−11 x+7`,
  },
  {
  ...
  },
  {
    ...
    asciimath: `(40 xx(5)/(18))^(2)+2xx(-f xx9.81)xx12.2`,
    linearmath: `(40 ×5/(18))²+2×(−f×9.81)×12.2`,
  },
  {
    latex: `\\begin{array} { r } 208,756 \\\\ + \\quad 91,300 \\end{array}`,
    asciimath: `208,756+91,300`,
    linearmath: `208,756+91,300`,
  },
  {
    latex: `\\begin{array}{r}
...
\\end{array}`,
    asciimath: `{:[3.75xx6.25=1875],[7500+225000=23.4375]:}`,
    linearmath: `3.75×6.25=1875\n7500+225000=23.4375`,
  },
  {
    latex: `\\begin{array} { r } 3 \\frac { 1 } { 6 } \\\\ + 2 \\frac { 1 } { 3 } \\\\ \\hline \\end{array}`,
    asciimath: `3(1)/(6)+2(1)/(3)`,
    linearmath: `3(1/6)+2(1/3)`,
  },
  {
    latex: `\\begin{array} { r } 4 \\mathrm {~L} 800 \\mathrm {~mL} \\\\ + 4 \\mathrm {~L} 300 \\mathrm {~mL}\\\\\\hline \\end{array}`,
    asciimath: `4L800mL+4L300mL`,
    linearmath: `4L800mL+4L300mL`,
  },
  {
    latex: `\\begin{array} { r } 100000 \\\\ {\\times} 100000 \\\\ \\hline \\end{array} `,
    asciimath: `100000xx100000`,
    linearmath: `100000×100000`,
  },
  {
    latex: `\\begin{array} { r } 100000 \\\\ {\\times 1} 100000 \\\\ \\hline \\end{array}`,
    asciimath: `100000xx1100000`,
    linearmath: `100000×1100000`,
  },
  {
    ...
    asciimath: `u_(B)(c_(k))=sqrt(((delc_(k))/(delc_(wH_(2)O)))^(2)u_(B)^(2)(c_(wH_(2)O))+((delc_(k))/(delm_(1H_(2)O)))^(2)u_(B)^(2)(m_(1H_(2)O))+((delc_(k))/(delm_(2H_(2)O)))^(2)u_(B)^(2)(m_(2H_(2)O))+((delc_(k))/(delT_(k)))^(2)u_(B)^(2)(T_(k))+((delc_(k))/(delT_(1H_(2)O)))^(2)u_(B)^(2)(T_(1H_(2)O))+((delc_(k))/(delT_(2H_(2)O)))^(2)u_(B)^(2)(T_(2H_(2)O)))`,
    linearmath: 'u_B(cₖ)=√(((∂cₖ)/(∂c_(wH₂O)))²u_B²(c_(wH₂O))+((∂cₖ)/(∂m_(1H₂O)))²u_B²(m_(1H₂O))+((∂cₖ)/(∂m_(2H₂O)))²u_B²(m_(2H₂O))+((∂cₖ)/(∂Tₖ))²u_B²(Tₖ)+((∂cₖ)/(∂T_(1H₂O)))²u_B²(T_(1H₂O))+((∂cₖ)/(∂T_(2H₂O)))²u_B²(T_(2H₂O)))',
  },
  {
    latex: `\\begin{array}{r}
4241 \\\\
...
\\hline
\\end{array}`,
    asciimath: `4241+2067+763+1529`,
    linearmath: `4241+2067+763+1529`,
  },
  {
    latex: `\\begin{array} {r}
356 \\\\
...
+ \\quad 299 \\\\ \\hline \\end{array}`,
    asciimath: `356+123+299`,
    linearmath: `356+123+299`,
  },
  {
    latex: `\\begin{array} {r}
356 \\\\
...
+ \\quad 299 \\\\ \\hline \\end{array}`,
  ...
  },
  {
    ...
    asciimath: `{:[S_(i)={b in{0,1}^(**):EE" some "c in B" s.t. "cb inS_(i-1)}],[uu{b in{0","1}^(**):EE" some "c inS_(i-1)" s.t. "cb in B}]:}`,
    linearmath: 'Sᵢ={b∈{0,1}^∗:∃ some c∈B s.t. cb∈Sᵢ₋₁}\n' +
  ...
  },
  {
    ...
    asciimath: `{:[(6)/(x)+(16 )/(y)=6],[-(6)/(x)-(4)/(y)=-4]:}`,
    linearmath: `6/x+(16 )/y=6\n−6/x−4/y=−4`,
  },
  {
  ...
  /** quad */
  {
    ...
    asciimath: `{:[((3)/(657quad1314))],[((◻)/(219quad438))],[((73)/(73quad146))],[◻quad◻]:}`,
    linearmath: `((3)/(657 1314))\n((◻)/(219 438))\n((73)/(73 146))\n◻ ◻`,
  },
  {
    latex: ``,
    asciimath: ``,
