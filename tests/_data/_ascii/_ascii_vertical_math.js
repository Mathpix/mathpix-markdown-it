...
\\end{array}`,
  ...
  },
  {
    ...
    linear: 'u_B(cₖ)=√(((∂cₖ)/(∂c_(wH₂O)))²u_B²(c_(wH₂O))+((∂cₖ)/(∂m_(1H₂O)))²u_B²(m_(1H₂O))+((∂cₖ)/(∂m_(2H₂O)))²u_B²(m_(2H₂O))+((∂cₖ)/(∂Tₖ))²u_B²(Tₖ)+((∂cₖ)/(∂T_(1H₂O)))²u_B²(T_(1H₂O))+((∂cₖ)/(∂T_(2H₂O)))²u_B²(T_(2H₂O)))',
  },
  {
    latex: `\\begin{array}{r}
4241 \\\\
...
+ \\quad 299 \\\\ \\hline \\end{array}`,
  ...
  },
  {
    ...
    linear: 'Sᵢ={b∈{0,1}^∗:∃ some c∈B s.t. cb∈Sᵢ₋₁}\n' +
