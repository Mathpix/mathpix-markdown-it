module.exports = [
  {
    ...
    linearmath:  '(∂ f)/(∂ A):T=d/(d α)[α³det(A)(1/(α³)+I₁(A⁻¹⋅T)1/(α²)+I₂(A⁻¹⋅T)1/α+I₃(A⁻¹⋅T))]|₀\n' +
      '=det(A)d/(d α)[1+I₁(A⁻¹⋅T)α+I₂(A⁻¹⋅T)α²+I₃(A⁻¹⋅T)α³]|ₐ₋₀\n' +
      '=det(A)[I₁(A⁻¹⋅T)+2I₂(A⁻¹⋅T)α+3I₃(A⁻¹⋅T)α²]|_(α=0)\n' +
      '=det(A)I₁(A⁻¹⋅T)',
  ...
  },
  {
    ...
    linearmath:  '⟨U_(T_∗)ⁿ1,1⟩=∏_(n∈Z)∫_(Z₊)√(((dκₖ₋ₙ)/(dκₖ))(yₖ))dκₖ(yₖ)\n' +
      '=∏_(n∈Z)(1−H²(κₖ₋ₙ,κₖ))\n' +
      '≤∏_(n∈Z)(1−H²(κₖ₋ₙ,κₖ))\n' +
  ...
  },
  {
    ...
    asciimath: '(root(4)(32z^(6)y^(3)))/(root(4)(2z^(2)y^(11)))',
    linearmath: '(∜(32z⁶y³))/(∜(2z²y¹¹))',
  }
];
