module.exports = [
  ...
  },
  {
    ...
    linear:    'V̂_L =∑_(m,n)∑_(l,mₗ)vₗ(k_(m²),k_(n²))Y_(lmₗ)^∗(m̂)Y_(lmₗ)(n̂)|m⟩⟨n|\n' +
  ...
  },
  {
    ...
    linear:    `1+∫_(vR)ᵛ((ϵ(bu−F(u)−I)))/((F(u)−W(u)+I)²))((∂ W(u))/(∂w₀))du`,
  ...
  },
  {
    ...
    linear:    `W(R,γ)=Tr_RPexp(i∮_γA_μdx^μ)≡χ_R(U_γ)`,
  ...
  },
  {
    ...
    linear:    `16∫₀³[(1/2)θ+(1/4)sin(2θ)+cos(θ)−(1/3)cos³(θ)]|₀^(2π)dz`,
  ...
  },
  {
    ...
    linear:    `Pr( test error ⩽ training error +√((1/N)[D(log((2N)/D)+1)−log(η/4)]))=1−η`,
  ...
  },
  {
    ...
    linear:    'This is one of the best things I have seen in a while.\n' +
