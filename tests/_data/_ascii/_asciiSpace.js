module.exports = [
  ...
  },
  {
    ...
    liner:    `W(R,γ)=Tr_RPexp(i∮_γA_μdx^μ)≡χ_R(U_γ)`,
  ...
  },
  {
    ...
    liner:    `Pr( test error ⩽ training error +√((1/N)[D(log((2N)/D)+1)−log(η/4)]))=1−η`,
  ...
  },
  {
    ...
    liner:    'This is one of the best things I have seen in a while. \n' +
