const htmlContent = '<div>First <sup class="footnote-ref"><a href="#fn1" id="fnref1">[1]</a></sup></div>\n' +
  ...
  '<ul data-padding-inline-start="9.4" class="itemize" style="padding-inline-start: 9.4ex; list-style-type: none">' +
    '<li class="li_itemize">' +
  ...
  '<ol data-padding-inline-start="9.4" class="enumerate decimal" style="padding-inline-start: 9.4ex; list-style-type: decimal">' +
