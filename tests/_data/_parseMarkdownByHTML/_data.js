module.exports = [
  ...
  },
  {
    ...
    asciimath: '[(:U_(T_(**))^(n)1,1:),=prod_(n inZ)int_(Z_(+))sqrt(sqrt(((dkappa_(k-n))/(dkappa_(k))(y_(k))))dkappa_(k)(y_(k))],[,=prod_(n inZ)(1-H^(2)(kappa_(k-n),kappa_(k)))],[,<=prod_(n inZ)(1-H^(2)(kappa_(k-n),kappa_(k)))],[,=prod_((n)/(3)<k<(2n)/(3))^((n)/(3)<k<(2n)/(3))],[,<(1-delta^(2))^(n//3)]',
    mathml: '<math>\n' +
      '  <mtable displaystyle="true" columnalign="right left right left right left right left right left right left" columnspacing="0em 2em 0em 2em 0em 2em 0em 2em 0em 2em 0em" rowspacing="3pt">\n' +
      '    <mtr>\n' +
      '      <mtd>\n' +
