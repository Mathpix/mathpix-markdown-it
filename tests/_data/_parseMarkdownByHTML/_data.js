module.exports = [
  ...
  },
  {
    ...
    asciimath: '{:[(:U_(T_(**))^(n)1,1:)=prod_(n in Z)int_(Z_(+))sqrt((d kappa_(k-n))/(d kappa_(k))(y_(k)))d kappa_(k)(y_(k))],[=prod_(n in Z)(1-H^(2)(kappa_(k-n),kappa_(k)))],[ <= prod_(n in Z)(1-H^(2)(kappa_(k-n),kappa_(k)))],[=prod_((n)/(3) < k < (2n)/(3))^((n)/(3) < k < (2n)/(3))],[ < (1-delta^(2))^(n//3)]:}',
    mathml: '<math xmlns="http://www.w3.org/1998/Math/MathML">\n' +
      '  <mtable displaystyle="true" columnalign="right left right left right left right left right left right left" columnspacing="0em 2em 0em 2em 0em 2em 0em 2em 0em 2em 0em" rowspacing="3pt">\n' +
      '    <mtr>\n' +
      '      <mtd>\n' +
