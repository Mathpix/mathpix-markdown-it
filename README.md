...
| `maxNesting`                          | number;*`100`*               | Markdown-it internal protection: recursion limit for nested block rules (lists, blockquotes, etc.). Each list nesting level adds 2 to `state.level`; lower values cap max list/blockquote depth (e.g. `12` ≈ up to 6 list levels).|
| `width`                               | number;*`1200`*              | Sets text container width                                                                                              |
