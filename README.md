...
|                | type&nbsp;*`default`*       |                                           |
|----------------|-----------------------------|-------------------------------------------|
| `footnotetext` | Footnotetext&nbsp;*`unset`* | Set options to `\footnotetext`            |
...
|              | type&nbsp;*`default`*  |                                                                                                |
|--------------|------------------------|------------------------------------------------------------------------------------------------|
| `autonumbers`| boolean&nbsp;*`false`* | If this value is set to `true` then automatic numbering will be applied to the `\footnotetext` |
