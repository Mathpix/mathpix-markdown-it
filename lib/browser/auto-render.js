...
var RE_TEX_DISPLAY_BRACKETS_DOUBLE = /^\\\\\[[\s\S]*\\\\\]$/;
var RE_TEX_INLINE_PARENS_DOUBLE = /^\\\\\([\s\S]*\\\\\)$/;
var defaultConfig = {
    accessibility: {
        assistive_mml: true,
 ...
 */
var stripOuterMathDelimitersIfWhole = function (raw, mode) {
 ...
 */
var shouldTypesetNode = function (el, mode) {
    var _a;
    if (mode === void 0) { mode = 'strict'; }
    ...
    var match = stripOuterMathDelimitersIfWhole(text, mode);
    if (!match) {
        return null;
    }
    return {
...
var renderMathInElement = function (container, config) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    var cfg, outMath, cwidth, mathDelimiterMode, mathNodes, accessibility, mathNodes_1, mathNodes_1_1, mathEl, target, metric, result, isInline, isBlock, width, widthEx;
    var e_1, _a;
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                mathDelimiterMode = cfg.mathDelimiterMode === 'legacy' ? 'legacy' : 'strict';
            ...
            case 1:
                ...
                try {
                    for (mathNodes_1 = tslib_1.__values(mathNodes), mathNodes_1_1 = mathNodes_1.next(); !mathNodes_1_1.done; mathNodes_1_1 = mathNodes_1.next()) {
                        ...
                        target = shouldTypesetNode(mathEl, mathDelimiterMode);
                        if (!target)
                            continue;
                        try {
