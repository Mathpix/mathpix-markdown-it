...
exports.removeListenerCopyToClipboardEvents = exports.addListenerCopyToClipboardEvents = exports.clicked = exports.clickInsideCopyElement = void 0;
...
var addListenerCopyToClipboardEvents = function () {
    document.addEventListener('click', exports.clicked);
    document.addEventListener('clipboard-copy', handleClipboardCopy);
};
exports.addListenerCopyToClipboardEvents = addListenerCopyToClipboardEvents;
var removeListenerCopyToClipboardEvents = function () {
    document.removeEventListener('click', exports.clicked);
    document.removeEventListener('clipboard-copy', handleClipboardCopy);
};
exports.removeListenerCopyToClipboardEvents = removeListenerCopyToClipboardEvents;
