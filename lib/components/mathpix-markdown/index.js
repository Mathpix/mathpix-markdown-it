...
var MathpixMarkdown = /** @class */ (function (_super) {
    ...
    MathpixMarkdown.prototype.render = function () {
        ...
        return (React.createElement("div", { id: 'preview', style: { justifyContent: alignMathBlock, padding: '10px', overflowY: 'auto', willChange: 'transform' } },
            ...
            textDirection
                ?
                    React.createElement("div", { id: 'setText', dir: textDirection, style: { display: display, justifyContent: 'inherit' }, dangerouslySetInnerHTML: { __html: mathpix_markdown_model_1.MathpixMarkdownModel.convertToHTML(text, markdownItOptions) } })
                :
