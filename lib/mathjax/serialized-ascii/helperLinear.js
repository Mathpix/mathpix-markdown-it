...
exports.formatLinearFromAscii = exports.replaceUnicodeWhitespace = exports.hasAnyWhitespace = exports.isWrappedWithParens = exports.needBrackets = exports.needsParensForFollowingDivision = exports.findRootSymbol = exports.findAmSymbolsToLinear = exports.replaceScripts = exports.rootSymbols = exports.amSymbolsToLinear = void 0;
...
var findAmSymbolsToLinear = function (input, tag) {
    if (tag === void 0) { tag = ''; }
    var linearData = null;
    if (tag) {
        linearData = exports.amSymbolsToLinear.find(function (item) { return item.tag === tag && item.input === input; });
        if (linearData) {
            return linearData;
        }
    }
    return exports.amSymbolsToLinear.find(function (item) { return item.input === input; });
};
exports.findAmSymbolsToLinear = findAmSymbolsToLinear;
...
var needBrackets = function (serialize, node, isFunction) {
    ...
    try {
        ...
        if (isFunction) {
            ...
            if (isNextFunction || helperA_1.regExpIsFunction.test(data.linear.trim())
                || ((nextNode === null || nextNode === void 0 ? void 0 : nextNode.kind) === 'mo' && (nextNode === null || nextNode === void 0 ? void 0 : nextNode.texClass) === -1)) {
                return false;
            }
        }
        if ((_a = data.linear) === null || _a === void 0 ? void 0 : _a.trim()) {
            var first = (_b = Array.from(data.linear.trimStart())[0]) !== null && _b !== void 0 ? _b : '';
            if (!first)
                return false;
...
var formatLinearFromAscii = function (ascii, childLinear, tag) {
    if (tag === void 0) { tag = ''; }
    var linearData = (0, exports.findAmSymbolsToLinear)(ascii, tag);
    if (!linearData)
        return '';
    var child = (childLinear !== null && childLinear !== void 0 ? childLinear : '').trim();
...
exports.formatLinearFromAscii = formatLinearFromAscii;
//# sourceMappingURL=helperLinear.js.map