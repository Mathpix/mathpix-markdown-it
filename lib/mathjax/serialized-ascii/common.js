...
exports.regW = /^\w/;
exports.AddToAsciiData = function (data, arr, serialize, node) {
    ...
    if ((arr === null || arr === void 0 ? void 0 : arr.length) > 3) {
        ...
        data.ascii_md += arr[3];
        exports.pushToSerializedStack(serialize, {
            ascii: arr[0],
            ascii_tsv: arr[1],
            ascii_csv: arr[2],
            ascii_md: arr[3],
...
exports.pushToSerializedStack = function (serialize, data, node) {
    var _a, _b;
    if (node === void 0) { node = null; }
...
exports.clearSerializedChildStack = function (serialize) {
    serialize.serializedChildStack = [];
};
exports.getLastSymbolFromSerializedStack = function (serialize) {
    var _a, _b, _c;
    var lastResAscii = null;
    if (serialize.isSerializeChildStack) {
        lastResAscii = ((_a = serialize.serializedChildStack) === null || _a === void 0 ? void 0 : _a.length) ? serialize.serializedChildStack[serialize.serializedChildStack.length - 1]
            : null;
    }
    else {
        lastResAscii = ((_b = serialize.serializedStack) === null || _b === void 0 ? void 0 : _b.length) ? serialize.serializedStack[serialize.serializedStack.length - 1]
            : null;
    }
...
exports.getLastItemFromSerializedStack = function (serialize) {
    var _a, _b;
    var lastResAscii = null;
    if (serialize.isSerializeChildStack) {
        lastResAscii = ((_a = serialize.serializedChildStack) === null || _a === void 0 ? void 0 : _a.length) ? serialize.serializedChildStack[serialize.serializedChildStack.length - 1]
...
exports.needFirstSpaceBeforeLetter = function (node, currentText, serialize) {
    var _a, _b, _c;
    try {
        var lastResAscii = exports.getLastItemFromSerializedStack(serialize);
...
exports.needSpaceBetweenLetters = function (strBefore, strAfter) {
...
exports.needFirstSpaceBeforeCurrentNode = function (node, serialize) {
    ...
    try {
        ...
        var lastSymbol = exports.getLastSymbolFromSerializedStack(serialize);
