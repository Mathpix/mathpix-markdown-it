...
var SerializedAsciiVisitor = /** @class */ (function (_super) {
    ...
    SerializedAsciiVisitor.prototype.visitTextNode = function (node, space) {
        ...
        try {
            ...
            res = (0, common_1.AddToAsciiData)(res, { ascii: text, linear: text });
            return res;
        }
        catch (e) {
    ...
    SerializedAsciiVisitor.prototype.visitXMLNode = function (node, space) {
        ...
        try {
            ...
            res = (0, common_1.AddToAsciiData)(res, { ascii: str, linear: str });
            return res;
        }
        catch (e) {
                ...
                if ((child === null || child === void 0 ? void 0 : child.kind) === "mfrac") {
                    if (beforeAscii === null || beforeAscii === void 0 ? void 0 : beforeAscii.trim()) {
                        ...
                        if (isFunction
                            ...
                            if ((0, helperLinear_1.needBrackets)(this, child, true)) {
                                res = (0, common_1.AddToAsciiData)(res, { ascii: '', linear: '(' });
                                parenthesisLinearOpen = true;
                            }
                        }
                        else {
                            if ((0, helperLinear_1.needsParensForFollowingDivision)(beforeLinear) || (0, helperLinear_1.needBrackets)(this, child)) {
                                res = (0, common_1.AddToAsciiData)(res, { ascii: '', linear: '(' });
                                parenthesisLinearOpen = true;
                            }
                        }
                        ...
                        if ((0, helperLinear_1.needBrackets)(this, child)) {
                            res = (0, common_1.AddToAsciiData)(res, { ascii: '', linear: '(' });
                            parenthesisLinearOpen = true;
                        }
                    }
    ...
    SerializedAsciiVisitor.prototype.visitTeXAtomNode = function (node, space) {
        ...
        try {
            ...
            var customCmd = (_b = (_a = node).getProperty) === null || _b === void 0 ? void 0 : _b.call(_a, 'data-custom-cmd');
            var customSym = customCmd && (0, custom_cmd_map_1.getCustomCmdUnicode)(customCmd);
            if (customSym) {
                return (0, common_1.AddToAsciiData)(res, {
            ...
            res = (0, common_1.AddToAsciiData)(res, {
                ascii: ((_c = children.ascii) === null || _c === void 0 ? void 0 : _c.match(/\S/)) ? children.ascii : '',
                linear: ((_d = children.linear) === null || _d === void 0 ? void 0 : _d.match(/\S/)) ? children.linear : '',
                ascii_tsv: ((_e = children.ascii_tsv) === null || _e === void 0 ? void 0 : _e.match(/\S/)) ? children.ascii_tsv : '',
                ascii_csv: ((_f = children.ascii_csv) === null || _f === void 0 ? void 0 : _f.match(/\S/)) ? children.ascii_csv : '',
                ascii_md: ((_g = children.ascii_md) === null || _g === void 0 ? void 0 : _g.match(/\S/)) ? children.ascii_md : ''
            });
