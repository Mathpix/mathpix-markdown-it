...
var SerializedAsciiVisitor = /** @class */ (function (_super) {
    ...
    SerializedAsciiVisitor.prototype.visitTree = function (node) {
        ...
        common_1.pushToSerializedStack(this, tslib_1.__assign({}, res), node);
        return res;
    };
    SerializedAsciiVisitor.prototype.visitNode = function (node) {
        ...
        var res = handler.call.apply(handler, tslib_1.__spread([this, node], args));
    ...
    SerializedAsciiVisitor.prototype.visitTextNode = function (node, space) {
        ...
        try {
            res = common_1.AddToAsciiData(res, [node.getText()], this);
            return res;
        }
        catch (e) {
    ...
    SerializedAsciiVisitor.prototype.visitXMLNode = function (node, space) {
        ...
        try {
            res = common_1.AddToAsciiData(res, [space + node.getSerializedXML()], this);
            return res;
        }
        catch (e) {
    ...
    SerializedAsciiVisitor.prototype.visitInferredMrowNode = function (node, space) {
        ...
        try {
            ...
            if (iclose > -1) {
                ...
                if ((!atr.notation && atrDef.notation === "longdiv") ||
                    ...
                    if (iclose === 0) {
                        ...
                        res = common_1.AddToAsciiData(res, ["(("], this);
                        res = common_1.AddToAsciiData(res, [dataDivisor.ascii, dataDivisor.ascii_tsv, dataDivisor.ascii_csv, dataDivisor.ascii_md], this);
                        res = common_1.AddToAsciiData(res, [")/("], this);
                        mnList.forEach(function (item) {
                            var dataDividend = _this.visitNode(item, '');
                            res = common_1.AddToAsciiData(res, [dataDividend.ascii, dataDividend.ascii_tsv, dataDividend.ascii_csv, dataDividend.ascii_md], _this);
                        });
                        res = common_1.AddToAsciiData(res, ["))"], this);
                        if (iclose < node.childNodes.length - 1) {
                            for (var i_2 = iclose + 1; i_2 < node.childNodes.length; i_2++) {
                                ...
                                res = common_1.AddToAsciiData(res, [data.ascii, data.ascii_tsv, data.ascii_csv, data.ascii_md], this);
                            }
                        }
                    }
                    return res;
                    ...
                    if (iclose === 0) {
                        ...
                        if (iclose - mnList.length > 0) {
                            for (var i_3 = 0; i_3 < iclose - mnList.length; i_3++) {
                                ...
                                res = common_1.AddToAsciiData(res, [data_1.ascii, data_1.ascii_tsv, data_1.ascii_csv, data_1.ascii_md], this);
                            }
                        }
                        res = common_1.AddToAsciiData(res, ['(('], this);
                        mnList.forEach(function (item) {
                            var data = _this.visitNode(item, '');
                            res = common_1.AddToAsciiData(res, [data.ascii, data.ascii_tsv, data.ascii_csv, data.ascii_md], _this);
                        });
                        res = common_1.AddToAsciiData(res, [')/('], this);
                        var data = this.visitNode(mclose, '');
                        res = common_1.AddToAsciiData(res, [data.ascii, data.ascii_tsv, data.ascii_csv, data.ascii_md], this);
                        ...
                        if (iclose < node.childNodes.length - 1) {
                            for (var i_4 = iclose + 1; i_4 < node.childNodes.length; i_4++) {
                                ...
                                res = common_1.AddToAsciiData(res, [data_2.ascii, data_2.ascii_tsv, data_2.ascii_csv, data_2.ascii_md], this);
                            }
                        }
                    }
                    return res;
            ...
            res = common_1.AddToAsciiData(res, [needBranch && hasFunc ? '{:' : ''], this);
            if (addParens && !group) {
                res = common_1.AddToAsciiData(res, ['('], this);
            }
            try {
    ...
    SerializedAsciiVisitor.prototype.visitTeXAtomNode = function (node, space) {
        ...
        try {
            var needFirstSpace = common_1.needFirstSpaceBeforeCurrentNode(node, this);
            ...
            res = common_1.AddToAsciiData(res, [needFirstSpace ? ' ' : ''], this);
            res = common_1.AddToAsciiData(res, [
    ...
    SerializedAsciiVisitor.prototype.childNodeMml = function (node, space, nl) {
        ...
        try {
            if (node.kind === 'mover' && node.childNodes.length > 1 && node.childNodes[0].kind === 'TeXAtom' && node.childNodes[1].kind === 'TeXAtom') {
                ...
                res = common_1.AddToAsciiData(res, [dataFirstChild.ascii, dataFirstChild.ascii_tsv, dataFirstChild.ascii_csv, dataFirstChild.ascii_md], this, firstChild);
                res = common_1.AddToAsciiData(res, ['^'], this);
                res = common_1.AddToAsciiData(res, ['('], this);
                res = common_1.AddToAsciiData(res, [dataChildNodes.ascii, dataChildNodes.ascii_tsv, dataChildNodes.ascii_csv, dataChildNodes.ascii_md], this, secondChild);
                res = common_1.AddToAsciiData(res, [')'], this);
            }
            else {
                var data = handleCh(node, this);
                res = common_1.AddToAsciiData(res, [data.ascii, data.ascii_tsv, data.ascii_csv, data.ascii_md], this, node);
            }
            return res;
        }
        catch (e) {
