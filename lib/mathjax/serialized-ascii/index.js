                ...
                if ((child === null || child === void 0 ? void 0 : child.kind) === "mfrac") {
                    if (beforeAscii === null || beforeAscii === void 0 ? void 0 : beforeAscii.trim()) {
                        ...
                        if (isFunction
                            ...
                            if ((0, halperLiner_1.needBrackets)(this, child, true)) {
                                res = (0, common_1.AddToAsciiData)(res, { ascii: '', liner: '(' });
                                parenthesisLinerOpen = true;
                            }
                        }
                        else {
                            if ((0, halperLiner_1.needsParensForFollowingDivision)(beforeLiner) || (0, halperLiner_1.needBrackets)(this, child)) {
                                res = (0, common_1.AddToAsciiData)(res, { ascii: '', liner: '(' });
                                parenthesisLinerOpen = true;
                            }
                        }
                        ...
                        if ((0, halperLiner_1.needBrackets)(this, child)) {
                            res = (0, common_1.AddToAsciiData)(res, { ascii: '', liner: '(' });
                            parenthesisLinerOpen = true;
                        }
                    }
