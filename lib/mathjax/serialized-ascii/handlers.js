...
exports.handle = exports.getAttributes = exports.FindSymbolToAM = exports.FindSymbolReplace = exports.SymbolToAM = exports.getSymbolType = exports.needLastSpace = exports.needFirstSpaceBeforeCurrentNode = exports.needFirstSpace = void 0;
...
exports.needFirstSpace = function (node, currentText, serialize) {
    var _a, _b, _c, _d;
    try {
        if (isFirstChild(node)) {
            ...
            var lastResAscii = ((_a = serialize.resAscii) === null || _a === void 0 ? void 0 : _a.length) ? serialize.resAscii[serialize.resAscii.length - 1]
                : null;
            var lastSymbol = lastResAscii && ((_c = (_b = lastResAscii.res) === null || _b === void 0 ? void 0 : _b.ascii) === null || _c === void 0 ? void 0 : _c.length)
                ? (_d = lastResAscii.res) === null || _d === void 0 ? void 0 : _d.ascii[lastResAscii.res.ascii.length - 1] : '';
            if (((prev.kind === 'mi' || prev.kind === 'mo') && (currentText === null || currentText === void 0 ? void 0 : currentText.length) > 1 && regW.test(lastSymbol))
                || prev.texClass === MmlNode_1.TEXCLASS.OP) {
                if (prev.childNodes[0] && prev.childNodes[0].hasOwnProperty('text') && prev.childNodes[0].text) {
                    var text = prev.childNodes[0].text;
                    if (currentText === null || currentText === void 0 ? void 0 : currentText.length) {
...
exports.needFirstSpaceBeforeCurrentNode = function (node, serialize) {
    var _a, _b, _c, _d, _e;
    try {
        ...
        var lastResAscii = ((_b = serialize.resAscii) === null || _b === void 0 ? void 0 : _b.length) ? serialize.resAscii[serialize.resAscii.length - 1]
            : null;
        var lastSymbol = lastResAscii && ((_d = (_c = lastResAscii.res) === null || _c === void 0 ? void 0 : _c.ascii) === null || _d === void 0 ? void 0 : _d.length)
            ? (_e = lastResAscii.res) === null || _e === void 0 ? void 0 : _e.ascii[lastResAscii.res.ascii.length - 1] : '';
...
exports.needLastSpace = function (node, currentText) {
    var haveSpace = false;
    try {
        ...
        if (isLastChild(node)) {
            ...
            if (((next.kind === 'mi' || next.kind === 'mo') && (currentText === null || currentText === void 0 ? void 0 : currentText.length) > 1)
                || next.texClass === MmlNode_1.TEXCLASS.OP) {
                if (next.childNodes[0] && next.childNodes[0].kind === 'text' && next.childNodes[0].text === '\u2061') {
                    return true;
                }
                var text = next.childNodes[0] && next.childNodes[0].hasOwnProperty('text') ? next.childNodes[0].text : '';
    ...
    return function (node, serialize) {
        ...
        try {
            ...
            if (secondChild && secondChild.kind === 'mo') {
                ...
                if (asc) {
                    res = common_1.AddToAsciiData(res, [asc + '(']);
                    serialize.resAscii.push({ kind: '', res: tslib_1.__assign({}, res) });
                    var dataFirstChild = firstChild ? serialize.visitNode(firstChild, '') : null;
                    res = common_1.AddToAsciiData(res, [
                        dataFirstChild ? dataFirstChild.ascii : '',
                        dataFirstChild ? dataFirstChild.ascii_tsv : '',
    ...
    return function (node, serialize) {
        ...
        try {
            ...
            if (abs && abs.length && regW.test(abs[0])) {
                res = common_1.AddToAsciiData(res, [exports.needFirstSpace(node, abs, serialize) ? ' ' : '']);
                res = common_1.AddToAsciiData(res, [abs]);
                res = common_1.AddToAsciiData(res, [exports.needLastSpace(node, abs) ? ' ' : '']);
            }
            else {
                res = common_1.AddToAsciiData(res, [abs]);
            }
...
var mo = function () {
    return function (node, serialize) {
        ...
        try {
            ...
            if (abs && abs.length > 1) {
                res = common_1.AddToAsciiData(res, [regW.test(abs[0]) && exports.needFirstSpace(node, abs, serialize) ? ' ' : '']);
                res = common_1.AddToAsciiData(res, [abs]);
                res = common_1.AddToAsciiData(res, [regW.test(abs[abs.length - 1]) && exports.needLastSpace(node, abs) ? ' ' : '']);
            }
            else {
    ...
    return function (node, serialize) {
        ...
        try {
            ...
            if (atr && atr.width === "2em") {
                res = common_1.AddToAsciiData(res, [node.parent.parent && exports.needFirstSpace(node.parent.parent, 'qquad', serialize) ? ' ' : '']);
                res = common_1.AddToAsciiData(res, ['qquad']);
                res = common_1.AddToAsciiData(res, [node.parent.parent && exports.needLastSpace(node.parent.parent, 'qquad') ? ' ' : '']);
                return res;
            }
            if (atr && atr.width === "1em") {
                res = common_1.AddToAsciiData(res, [node.parent.parent && exports.needFirstSpace(node.parent.parent, 'quad', serialize) ? ' ' : '']);
                res = common_1.AddToAsciiData(res, ['quad']);
                res = common_1.AddToAsciiData(res, [node.parent.parent && exports.needLastSpace(node.parent.parent, 'quad') ? ' ' : '']);
                return res;
            }
            var data = handlerApi.handleAll(node, serialize);
            res = common_1.AddToAsciiData(res, [data.ascii, data.ascii_tsv, data.ascii_csv, data.ascii_md]);
