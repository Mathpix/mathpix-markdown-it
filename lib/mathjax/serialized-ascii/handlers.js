...
var needLastSpace = function (node, isFunction, isLiner) {
    var _a;
    ...
    try {
        ...
        if ((0, node_utils_1.isLastChild)(node)) {
            ...
            if (next.kind === 'mi' || next.kind === 'mo') {
                ...
                return isLiner ? regW.test(data.liner) : regW.test(data.ascii);
            }
            else {
                if (next.kind === 'mrow') {
                    return false;
...
var SymbolToAM = function (tag, output, atr, showStyle) {
    ...
    if (!tags && atr && atrsNames.length > 0 && Object.getOwnPropertyNames(atr) && atr.stretchy === false) {
        ...
        return {
            ascii: res,
            liner: res_liner ? res_liner.split(' ').join('') : ''
        };
    }
    return {
...
var getDataForVerticalMath = function (serialize, node, rowNumber) {
    ...
    for (var k = 0; k < mtdNode.childNodes.length; k++) {
        ...
        if ((child === null || child === void 0 ? void 0 : child.kind) === "mfrac"
            && (((_a = res.mmlCollVerticalMath_liner) === null || _a === void 0 ? void 0 : _a.trim()) && (0, helperLiner_1.needsParensForFollowingDivision)(res.mmlCollVerticalMath_liner)
                || (0, helperLiner_1.needBrackets)(serialize, child))) {
            res.mmlCollVerticalMath_liner += '(';
        ...
        try {
            ...
            for (var i = 0; i < countRow; i++) {
                ...
                for (var j = 0; j < countColl; j++) {
                    ...
                    var _0 = serialize.visitNode(mtdNode, ''), _1 = _0.ascii, ascii = _1 === void 0 ? '' : _1, _2 = _0.liner, liner = _2 === void 0 ? '' : _2, _3 = _0.ascii_tsv, ascii_tsv = _3 === void 0 ? '' : _3, _4 = _0.ascii_csv, ascii_csv = _4 === void 0 ? '' : _4, _5 = _0.ascii_md, ascii_md = _5 === void 0 ? '' : _5, _6 = _0.liner_tsv, liner_tsv = _6 === void 0 ? '' : _6;
                ...
                arrRows.push({
                    ...
                    mmlRow_md: mmlRow_md,
                    mmlRow_liner_tsv: mmlRow_liner_tsv,
            ...
            for (var i = 0; i < arrRows.length; i++) {
                ...
                var mmlRow_liner_tsv = isVerticalMath ? arrRows[i].mmlRowVerticalMath_liner : arrRows[i].mmlRow_liner_tsv;
                ...
                mmlTableContent_liner_tsv += mmlRow_liner_tsv;
            ...
            mml_liner_tsv = mmlTableContent_liner_tsv;
            if (toCsv) {
    ...
    return function (node, serialize) {
        try {
            ...
            for (var i = 0; i < node.childNodes.length; i++) {
                ...
                mmlContent_liner_tsv += data.liner_tsv;
            ...
            return {
                ...
                liner_tsv: mmlContent_liner_tsv,
    ...
    return function (node, serialize) {
        ...
        try {
            ...
            for (var i = 0; i < node.childNodes.length; i++) {
                ...
                var _d = serialize.visitNode(node.childNodes[i], ''), _e = _d.ascii, ascii = _e === void 0 ? '' : _e, _f = _d.liner, liner = _f === void 0 ? '' : _f, _g = _d.ascii_tsv, ascii_tsv = _g === void 0 ? '' : _g, _h = _d.ascii_csv, ascii_csv = _h === void 0 ? '' : _h, _j = _d.ascii_md, ascii_md = _j === void 0 ? '' : _j, _k = _d.liner_tsv, liner_tsv = _k === void 0 ? '' : _k;
                res = (0, common_1.AddToAsciiData)(res, {
                    ascii: ascii,
                    liner: liner,
    ...
    return function (node, serialize) {
        ...
        try {
            ...
            if (secondChild && secondChild.kind === 'mo') {
                ...
                if (data.ascii) {
                    var liner = (0, helperLiner_1.formatLinerFromAscii)(data.ascii, dataFirstChild === null || dataFirstChild === void 0 ? void 0 : dataFirstChild.liner);
                    res = (0, common_1.AddToAsciiData)(res, { ascii: ' ', liner: '' });
                    res = (0, common_1.AddToAsciiData)(res, {
                        ascii: data.ascii,
                    ...
                    res = (0, common_1.AddToAsciiData)(res, {
                        ascii: '(',
                        liner: !liner && ((_b = (_a = dataFirstChild === null || dataFirstChild === void 0 ? void 0 : dataFirstChild.liner) === null || _a === void 0 ? void 0 : _a.trim()) === null || _b === void 0 ? void 0 : _b.length) > 1 ? '(' : '',
                    });
                    res = (0, common_1.AddToAsciiData)(res, {
                        ...
                        liner_tsv: (dataFirstChild === null || dataFirstChild === void 0 ? void 0 : dataFirstChild.liner_tsv) ? dataFirstChild.liner_tsv : '',
                    });
                    res = (0, common_1.AddToAsciiData)(res, {
                        ascii: ')',
                        liner: !liner && ((_d = (_c = dataFirstChild === null || dataFirstChild === void 0 ? void 0 : dataFirstChild.liner) === null || _c === void 0 ? void 0 : _c.trim()) === null || _d === void 0 ? void 0 : _d.length) > 1 ? ')' : ''
                    });
                }
                else {
                    var liner = (0, helperLiner_1.formatLinerFromAscii)(data.liner, dataFirstChild === null || dataFirstChild === void 0 ? void 0 : dataFirstChild.liner, 'mover');
                    res = (0, common_1.AddToAsciiData)(res, {
                    ...
                    res = (0, common_1.AddToAsciiData)(res, {
                        ...
                        liner: !liner && ((_e = dataSecondChild === null || dataSecondChild === void 0 ? void 0 : dataSecondChild.liner) === null || _e === void 0 ? void 0 : _e.length) ? '(' : '',
                    });
                    res = (0, common_1.AddToAsciiData)(res, {
                        ...
                        liner_tsv: dataSecondChild ? dataSecondChild.liner_tsv : '',
                    });
                    res = (0, common_1.AddToAsciiData)(res, {
                        ascii: serialize.options.extraBrackets ? ')' : '',
                        liner: !liner && ((_f = dataSecondChild === null || dataSecondChild === void 0 ? void 0 : dataSecondChild.liner) === null || _f === void 0 ? void 0 : _f.length) ? ')' : '',
                    });
                }
            }
            else {
                var data = handlerApi.handleAll(node, serialize);
                var liner = '';
                if (((_g = dataFirstChild === null || dataFirstChild === void 0 ? void 0 : dataFirstChild.liner) === null || _g === void 0 ? void 0 : _g.length) && ((_h = dataSecondChild.liner) === null || _h === void 0 ? void 0 : _h.length)) {
                    liner += ((_j = dataFirstChild.liner) === null || _j === void 0 ? void 0 : _j.length) > 1 ? "(".concat(dataFirstChild.liner, ")") : dataFirstChild.liner;
                    var linerData = dataSecondChild.liner.length === 1 ? (0, helperLiner_1.findAmSymbolsToLiner)(dataSecondChild.liner) : null;
                    if (linerData) {
                        liner += dataFirstChild.liner.length > 1 ? linerData.outputComplex : linerData.output;
                    }
                    else {
                        liner += '^';
                        liner += ((_k = dataSecondChild.liner) === null || _k === void 0 ? void 0 : _k.length) > 1 ? "(".concat(dataSecondChild.liner, ")") : dataSecondChild.liner;
                    }
                }
                if (liner) {
                    res = (0, common_1.AddToAsciiData)(res, tslib_1.__assign(tslib_1.__assign({}, data), { liner: liner }));
                }
                else {
                    res = (0, common_1.AddToAsciiData)(res, data);
                }
        ...
        try {
            ...
            if (secondChild && secondChild.kind === 'mo') {
                ...
                if (data.ascii) {
                    ...
                    var liner = '';
                    if (((_a = dataFirstChild === null || dataFirstChild === void 0 ? void 0 : dataFirstChild.liner) === null || _a === void 0 ? void 0 : _a.length) && ((_b = dataSecondChild.liner) === null || _b === void 0 ? void 0 : _b.length)) {
                        liner = (0, helperLiner_1.formatLinerFromAscii)(dataSecondChild.liner, dataFirstChild.liner);
                    }
                    if (liner) {
                        res = (0, common_1.AddToAsciiData)(res, tslib_1.__assign(tslib_1.__assign({}, data_2), { liner: liner }));
                    }
                    else {
...
var munderover = function () {
    return function (node, serialize) {
        ...
        try {
            ...
            var linerNeedsParens = (dataFirstChild === null || dataFirstChild === void 0 ? void 0 : dataFirstChild.liner) && (0, helperLiner_1.hasAnyWhitespace)(dataFirstChild.liner);
            res = (0, common_1.AddToAsciiData)(res, {
                ascii: '',
            ...
            res = (0, common_1.AddToAsciiData)(res, {
                ...
                liner: dataFirstChild.liner ? (0, helperLiner_1.replaceUnicodeWhitespace)(dataFirstChild.liner) : '',
            ...
            res = (0, common_1.AddToAsciiData)(res, { ascii: '_', liner: '_' });
            linerNeedsParens = ((_a = dataSecondChild === null || dataSecondChild === void 0 ? void 0 : dataSecondChild.liner) === null || _a === void 0 ? void 0 : _a.length) > 1 && !(0, helperLiner_1.isWrappedWithParens)(dataSecondChild.liner);
            res = (0, common_1.AddToAsciiData)(res, {
                ascii: serialize.options.extraBrackets ? '(' : '',
                liner: linerNeedsParens ? '(' : '',
            });
            res = (0, common_1.AddToAsciiData)(res, {
                ...
                liner_tsv: (dataSecondChild === null || dataSecondChild === void 0 ? void 0 : dataSecondChild.liner_tsv) ? dataSecondChild.liner_tsv : '',
            });
            res = (0, common_1.AddToAsciiData)(res, {
                ascii: serialize.options.extraBrackets ? ')' : '',
                liner: linerNeedsParens ? ')' : '',
            ...
            res = (0, common_1.AddToAsciiData)(res, { ascii: '^', liner: '^' });
            linerNeedsParens = ((_b = dataThirdChild === null || dataThirdChild === void 0 ? void 0 : dataThirdChild.liner) === null || _b === void 0 ? void 0 : _b.length) > 1 && !(0, helperLiner_1.isWrappedWithParens)(dataThirdChild.liner);
            res = (0, common_1.AddToAsciiData)(res, {
                ascii: serialize.options.extraBrackets ? '(' : '',
                liner: linerNeedsParens ? '(' : '',
            });
            res = (0, common_1.AddToAsciiData)(res, {
                ...
                liner_tsv: (dataThirdChild === null || dataThirdChild === void 0 ? void 0 : dataThirdChild.liner_tsv) ? dataThirdChild.liner_tsv : '',
            });
            res = (0, common_1.AddToAsciiData)(res, {
                ascii: serialize.options.extraBrackets ? ')' : '',
                liner: linerNeedsParens ? ')' : '',
...
var msub = function () {
    return function (node, serialize) {
        ...
        try {
            ...
            var liner = (0, helperLiner_1.replaceScripts)(dataSecondChild === null || dataSecondChild === void 0 ? void 0 : dataSecondChild.liner, 'sub');
            res = (0, common_1.AddToAsciiData)(res, {
                ascii: '_',
                liner: liner ? liner : '_'
            });
            var linerNeedsParens = !liner && ((_a = dataSecondChild === null || dataSecondChild === void 0 ? void 0 : dataSecondChild.liner) === null || _a === void 0 ? void 0 : _a.length) > 1 && !(0, helperLiner_1.isWrappedWithParens)(dataSecondChild.liner);
            res = (0, common_1.AddToAsciiData)(res, {
                ascii: serialize.options.extraBrackets ? '(' : '',
                liner: linerNeedsParens ? '(' : '',
            });
...
var msup = function () {
    return function (node, serialize) {
        ...
        try {
            ...
            var linerData = ((_a = dataSecondChild === null || dataSecondChild === void 0 ? void 0 : dataSecondChild.liner) === null || _a === void 0 ? void 0 : _a.length) === 1
                ? (0, helperLiner_1.findAmSymbolsToLiner)(dataSecondChild.liner, 'msup')
                : null;
            var liner = linerData ? linerData.output : '';
            ...
            if (!liner) {
                liner = (0, helperLiner_1.replaceScripts)(dataSecondChild === null || dataSecondChild === void 0 ? void 0 : dataSecondChild.liner);
            }
            var linerNeedsParens = !liner && ((_b = dataSecondChild === null || dataSecondChild === void 0 ? void 0 : dataSecondChild.liner) === null || _b === void 0 ? void 0 : _b.length) > 1 && !(0, helperLiner_1.isWrappedWithParens)(dataSecondChild.liner);
            res = (0, common_1.AddToAsciiData)(res, {
                ascii: '^',
                liner: liner ? liner : '^'
            });
...
var msubsup = function () {
    return function (node, serialize) {
        ...
        try {
            ...
            res = (0, common_1.AddToAsciiData)(res, {
                ascii: dataFirstChild ? dataFirstChild.ascii : '',
                liner: (dataFirstChild === null || dataFirstChild === void 0 ? void 0 : dataFirstChild.liner) ? (0, helperLiner_1.replaceUnicodeWhitespace)(dataFirstChild.liner) : '',
                ascii_tsv: dataFirstChild ? dataFirstChild.ascii_tsv : '',
                ascii_csv: dataFirstChild ? dataFirstChild.ascii_csv : '',
                ascii_md: dataFirstChild ? dataFirstChild.ascii_md : '',
                liner_tsv: dataFirstChild ? dataFirstChild.liner_tsv : '',
            ...
            linerNeedsParens = !liner && ((_a = dataSecondChild === null || dataSecondChild === void 0 ? void 0 : dataSecondChild.liner) === null || _a === void 0 ? void 0 : _a.length) > 1 && !(0, helperLiner_1.isWrappedWithParens)(dataSecondChild.liner);
            res = (0, common_1.AddToAsciiData)(res, {
                ascii: '(',
                liner: linerNeedsParens ? '(' : ''
            });
            ...
            liner = (0, helperLiner_1.replaceScripts)(dataThirdChild === null || dataThirdChild === void 0 ? void 0 : dataThirdChild.liner);
            res = (0, common_1.AddToAsciiData)(res, {
                ascii: '^',
                liner: liner ? liner : '^'
            });
            linerNeedsParens = !liner && ((_b = dataThirdChild === null || dataThirdChild === void 0 ? void 0 : dataThirdChild.liner) === null || _b === void 0 ? void 0 : _b.length) > 1 && !(0, helperLiner_1.isWrappedWithParens)(dataThirdChild.liner);
            res = (0, common_1.AddToAsciiData)(res, {
                ascii: '(',
                liner: linerNeedsParens ? '(' : ''
            });
            res = (0, common_1.AddToAsciiData)(res, {
                ...
                liner_tsv: dataThirdChild ? dataThirdChild.liner_tsv : '',
            });
            res = (0, common_1.AddToAsciiData)(res, {
                ascii: ')',
                liner: linerNeedsParens ? ')' : ''
...
var mroot = function () {
    return function (node, serialize) {
        ...
        try {
            ...
            var dataSecondChild = secondChild ? serialize.visitNode(secondChild, '') : null;
            var dataFirstChild = firstChild ? serialize.visitNode(firstChild, '') : null;
            var liner = (0, helperLiner_1.findRootSymbol)(dataSecondChild === null || dataSecondChild === void 0 ? void 0 : dataSecondChild.liner);
            res = (0, common_1.AddToAsciiData)(res, {
                ascii: 'root',
    ...
    return function (node, serialize) {
        ...
        try {
            ...
            if (data.ascii && data.ascii.length > 1 && regW.test(data.ascii[0])) {
                ...
                var hasLastSpaceLiner = needLastSpace(node, isFunction, true);
        ...
        try {
            ...
            if (data.ascii && data.ascii.length > 1) {
                res = (0, common_1.AddToAsciiData)(res, {
                    ...
                    liner: regW.test(data.liner[0]) && (0, exports.needFirstSpace)(node) ? ' ' : ''
                });
                res = (0, common_1.AddToAsciiData)(res, {
                    ascii: data.ascii,
                    liner: data.liner || data.ascii
