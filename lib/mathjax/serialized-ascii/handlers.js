...
var mtable = function () {
    return function (node, serialize) {
        ...
        var mml = '';
        try {
            var toTsv = serialize.options.tableToTsv && ((_a = node.Parent) === null || _a === void 0 ? void 0 : _a.kind) === 'math';
            ...
            for (var i = 0; i < node.childNodes.length; i++) {
                if (i > 0) {
                    mml += toTsv
                        ? ((_b = serialize.options.tsv_separators) === null || _b === void 0 ? void 0 : _b.row) || '\n'
                        : ',';
                }
