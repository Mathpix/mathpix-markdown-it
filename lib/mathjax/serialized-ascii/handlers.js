    ...
    return function (node, serialize) {
        ...
        try {
            ...
            if (secondChild && secondChild.kind === 'mo') {
                ...
                if (data.ascii) {
                    var liner = (0, helperLiner_1.findAmSymbolsToLiner)(data.liner);
                    if (liner) {
...
var msub = function () {
    return function (node, serialize) {
        ...
        try {
            ...
            res = (0, common_1.AddToAsciiData)(res, { ascii: '_', liner: '_' });
            var linerNeedsParens = ((_a = dataSecondChild === null || dataSecondChild === void 0 ? void 0 : dataSecondChild.liner) === null || _a === void 0 ? void 0 : _a.length) > 1 && !(0, helperLiner_1.isWrappedWithParens)(dataSecondChild.liner);
            res = (0, common_1.AddToAsciiData)(res, {
                ascii: serialize.options.extraBrackets ? '(' : '',
                liner: linerNeedsParens ? '(' : '',
            });
    ...
    return function (node, serialize) {
        ...
        try {
            ...
            var liner = /^\s*[234]\s*$/.test(dataSecondChild.liner)
                ? (0, helperLiner_1.findRootSymbol)(Number(dataSecondChild.liner))
                : '';
            res = (0, common_1.AddToAsciiData)(res, {
                ascii: 'root',
