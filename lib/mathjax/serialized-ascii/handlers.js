...
var mtable = function () {
    return function (node, serialize) {
        ...
        var mml_md = '';
        try {
            if ((_a = node.Parent) === null || _a === void 0 ? void 0 : _a.isKind('mrow')) {
                node.Parent.attributes.setInherited('isTable', true);
            }
            if (((_b = node.Parent) === null || _b === void 0 ? void 0 : _b.isKind('menclose')) && ((_d = (_c = node.Parent) === null || _c === void 0 ? void 0 : _c.Parent) === null || _d === void 0 ? void 0 : _d.isKind('mrow'))) {
                node.Parent.Parent.attributes.setInherited('isTable', true);
            }
            /** MathJax: <mrow> came from \left...\right
             *   so treat as subexpression (TeX class INNER). */
            var isSubExpression = ((_e = node.parent) === null || _e === void 0 ? void 0 : _e.texClass) === MmlNode_1.TEXCLASS.INNER;
            var parentIsMenclose = ((_f = node.Parent) === null || _f === void 0 ? void 0 : _f.kind) === 'menclose';
            ...
            var toCsv = serialize.options.tableToCsv && !serialize.options.isSubTable
                && (((_j = node.Parent) === null || _j === void 0 ? void 0 : _j.kind) === 'math' || (parentIsMenclose && ((_k = node.Parent.Parent) === null || _k === void 0 ? void 0 : _k.kind) === 'math'));
            var toMd = serialize.options.tableToMd && !serialize.options.isSubTable
                && (((_l = node.Parent) === null || _l === void 0 ? void 0 : _l.kind) === 'math' || (parentIsMenclose && ((_m = node.Parent.Parent) === null || _m === void 0 ? void 0 : _m.kind) === 'math'));
            ...
            var isHasBranchOpen = node.parent && node.parent.kind === 'mrow' && ((_o = node.parent.properties) === null || _o === void 0 ? void 0 : _o.hasOwnProperty('open'));
            var isHasBranchClose = node.parent && node.parent.kind === 'mrow' && ((_p = node.parent.properties) === null || _p === void 0 ? void 0 : _p.hasOwnProperty('close'));
            var thereAreBracketsIn_parent = (isHasBranchOpen && node.parent.properties['open'])
                || (isHasBranchClose && node.parent.properties['close']);
            var thereAreBracketsIn_Parent = parentIsMenclose && ((_q = node.Parent.Parent) === null || _q === void 0 ? void 0 : _q.isKind('mrow'))
                && ((((_r = node.Parent.Parent.properties) === null || _r === void 0 ? void 0 : _r.hasOwnProperty('open')) && node.Parent.Parent.properties['open'])
                    || (((_s = node.Parent.Parent.properties) === null || _s === void 0 ? void 0 : _s.hasOwnProperty('close')) && node.Parent.Parent.properties['close']));
            ...
            for (var i = 0; i < countRow; i++) {
                ...
                var mathOperation = '';
                var countColl = (_t = mtrNode.childNodes) === null || _t === void 0 ? void 0 : _t.length;
                ...
                for (var j = 0; j < countColl; j++) {
                    if (j > 0 && !isEqnArrayRow) {
                        mmlRow += ',';
                        mmlRow_tsv += toTsv ? ((_u = serialize.options.tsv_separators) === null || _u === void 0 ? void 0 : _u.column) || '\t' : itShouldBeFlatten ? ', ' : ',';
                        mmlRow_csv += toCsv ? ((_v = serialize.options.csv_separators) === null || _v === void 0 ? void 0 : _v.column) || ',' : itShouldBeFlatten ? ', ' : ',';
                        mmlRow_md += toMd ? ((_w = serialize.options.md_separators) === null || _w === void 0 ? void 0 : _w.column) || ' ' : itShouldBeFlatten ? ', ' : ',';
                    }
                    var mtdNode = mtrNode.childNodes[j];
                    var _5 = serialize.visitNode(mtdNode, ''), _6 = _5.ascii, ascii = _6 === void 0 ? '' : _6, _7 = _5.ascii_tsv, ascii_tsv = _7 === void 0 ? '' : _7, _8 = _5.ascii_csv, ascii_csv = _8 === void 0 ? '' : _8, _9 = _5.ascii_md, ascii_md = _9 === void 0 ? '' : _9;
                ...
                /** It's EqnArray or AmsEqnArray or AlignAt.
                 *  eqnarray*, align, align*, split, gather, gather*, aligned, gathered, alignat, alignat*, alignedat */
                var isEqnArray = (_x = mtrNode.attributes) === null || _x === void 0 ? void 0 : _x.get('displaystyle');
                arrRows.push({
                    mmlRow: mmlRow,
            ...
            for (var i = 0; i < arrRows.length; i++) {
                if (i > 0 && !isVerticalMath) {
                    ...
                    mmlTableContent_tsv += toTsv
                        ? ((_y = serialize.options.tsv_separators) === null || _y === void 0 ? void 0 : _y.row) || '\n'
                        : itShouldBeFlatten ? ', ' : ',';
                    mmlTableContent_csv += toCsv
                        ? ((_z = serialize.options.csv_separators) === null || _z === void 0 ? void 0 : _z.row) || '\n'
                        : itShouldBeFlatten ? ', ' : ',';
                    mmlTableContent_md += toMd
                        ? ((_0 = serialize.options.md_separators) === null || _0 === void 0 ? void 0 : _0.row) || ' <br> '
                        : itShouldBeFlatten ? ', ' : ',';
                }
            ...
            if (isVerticalMath) {
                if ((_1 = node.Parent) === null || _1 === void 0 ? void 0 : _1.isKind('mrow')) {
                    node.Parent.attributes.setInherited('isVerticalMath', true);
                }
                if (((_2 = node.Parent) === null || _2 === void 0 ? void 0 : _2.isKind('menclose')) && ((_4 = (_3 = node.Parent) === null || _3 === void 0 ? void 0 : _3.Parent) === null || _4 === void 0 ? void 0 : _4.isKind('mrow'))) {
...
var mrow = function () {
    return function (node, serialize) {
        try {
            ...
            var isTable = node.attributes.get('isTable');
            var open_1 = isTexClass7 && needBranchOpen && !isVerticalMath && isTable ? '{:' : '';
            var close_1 = isTexClass7 && needBranchClose && !isVerticalMath && isTable ? ':}' : '';
            return {
