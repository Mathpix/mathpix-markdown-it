...
var mtable = function () {
    return function (node, serialize) {
        ...
        var mml = '';
        try {
            var toTsv = serialize.options.tableToTsv
                && (((_a = node.Parent) === null || _a === void 0 ? void 0 : _a.kind) === 'math' || (((_b = node.Parent) === null || _b === void 0 ? void 0 : _b.kind) === 'menclose' && ((_c = node.Parent.Parent) === null || _c === void 0 ? void 0 : _c.kind) === 'math'));
            ...
            var itShouldBeFlatten = envName === 'array' &&
                !isHasBranchOpen && !parentIsMenclose && !isHasBranchClose && !parentIsMenclose;
            var mmlTableContent = '';
            for (var i = 0; i < node.childNodes.length; i++) {
                if (i > 0) {
                    mmlTableContent += toTsv
                        ? ((_d = serialize.options.tsv_separators) === null || _d === void 0 ? void 0 : _d.row) || '\n'
                        : itShouldBeFlatten ? ', ' : ',';
                }
        ...
        try {
            ...
            for (var i = 0; i < node.childNodes.length; i++) {
                if (i > 0) {
                    mtrContent += display
                        ? ''
                        : toTsv ? ((_a = serialize.options.tsv_separators) === null || _a === void 0 ? void 0 : _a.column) || '\t'
                            : itShouldBeFlatten ? ', ' : ',';
                }
                var mmlCell = serialize.visitNode(node.childNodes[i], '');
                mtrContent += !toTsv && itShouldBeFlatten ? mmlCell === null || mmlCell === void 0 ? void 0 : mmlCell.trimEnd() : mmlCell;
            }
