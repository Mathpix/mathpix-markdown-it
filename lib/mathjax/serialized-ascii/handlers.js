...
var menclose = function (handlerApi) {
    return function (node, serialize) {
        ...
        try {
            ...
            res = (0, common_1.AddToAsciiData)(res, [isLeft ? '[' : ''], serialize);
            var data = handlerApi.handleAll(node, serialize);
            res = (0, common_1.AddToAsciiData)(res, [data.ascii, data.ascii_tsv, data.ascii_csv, data.ascii_md], serialize, node);
            if (atr && atr.lcm) {
                res = (0, common_1.AddToAsciiData)(res, [''], serialize);
            }
            res = (0, common_1.AddToAsciiData)(res, [isRight ? ']' : ''], serialize);
            return res;
        }
        catch (e) {
...
var getDataForVerticalMath = function (serialize, node, rowNumber) {
    ...
    for (var k = 0; k < mtdNode.childNodes.length; k++) {
        ...
        if (child.isKind('mstyle')) {
            serialize.notApplyToSerializedStack = true;
        }
        var data = serialize.visitNode(child, '');
        serialize.notApplyToSerializedStack = false;
        ...
        try {
            ...
            for (var i = 0; i < countRow; i++) {
                ...
                for (var j = 0; j < countColl; j++) {
                    if (j > 0 && !isEqnArrayRow) {
                        ...
                        (0, common_1.pushToSerializedStack)(serialize, {
                            ascii: mmlRow,
                            ascii_tsv: mmlRow_tsv,
                            ascii_csv: mmlRow_csv,
                            ascii_md: mmlRow_md,
                        });
                    }
                    ...
                    if (isVerticalMath) {
                        (0, common_1.clearSerializedChildStack)(serialize);
                        serialize.isSerializeChildStack = true;
                        var dataColl = getDataForVerticalMath(serialize, mtdNode, i);
                        serialize.isSerializeChildStack = false;
            ...
            for (var i = 0; i < arrRows.length; i++) {
                ...
                var mmlRow = isVerticalMath
                    ? (0, common_1.needSpaceBetweenLetters)(mmlTableContent, arrRows[i].mmlRowVerticalMath)
                        ? ' ' + arrRows[i].mmlRowVerticalMath
                        : arrRows[i].mmlRowVerticalMath
                    : arrRows[i].mmlRow;
                var mmlRow_tsv = isVerticalMath
                    ? (0, common_1.needSpaceBetweenLetters)(mmlTableContent_tsv, arrRows[i].mmlRowVerticalMath)
                        ? ' ' + arrRows[i].mmlRowVerticalMath
                        : arrRows[i].mmlRowVerticalMath
                    : arrRows[i].mmlRow_tsv;
                var mmlRow_csv = isVerticalMath
                    ? (0, common_1.needSpaceBetweenLetters)(mmlTableContent_csv, arrRows[i].mmlRowVerticalMath)
                        ? ' ' + arrRows[i].mmlRowVerticalMath
                        : arrRows[i].mmlRowVerticalMath
                    : arrRows[i].mmlRow_csv;
                var mmlRow_md = isVerticalMath
                    ? (0, common_1.needSpaceBetweenLetters)(mmlTableContent_md, arrRows[i].mmlRowVerticalMath)
                        ? ' ' + arrRows[i].mmlRowVerticalMath
                        : arrRows[i].mmlRowVerticalMath
                    : arrRows[i].mmlRow_md;
...
var mrow = function () {
    return function (node, serialize) {
        try {
            ...
            var mmlContent_csv = '';
            var mmlContent_md = '';
            var needFirstSpace = (0, common_1.needFirstSpaceBeforeCurrentNode)(node, serialize);
            ...
            if (needFirstSpace) {
                needFirstSpace = (mmlContent === null || mmlContent === void 0 ? void 0 : mmlContent.length) && common_1.regLetter.test(mmlContent[0]);
            }
...
var mpadded = function (handlerApi) {
    return function (node, serialize) {
        ...
        try {
            ...
            res = (0, common_1.AddToAsciiData)(res, [mmlAdd.ascii, mmlAdd.ascii_tsv, mmlAdd.ascii_csv, mmlAdd.ascii_md], serialize, node);
            res = (0, common_1.AddToAsciiData)(res, [
                '"',
                serialize.options.tableToTsv ? '' : '"',
                '',
    ...
    return function (node, serialize) {
        ...
        try {
            ...
            if (secondChild && secondChild.kind === 'mo') {
                ...
                if (asc) {
                    res = (0, common_1.AddToAsciiData)(res, [' ' + asc + '('], serialize);
                    ...
                    res = (0, common_1.AddToAsciiData)(res, ['^'], serialize);
                    res = (0, common_1.AddToAsciiData)(res, [serialize.options.extraBrackets ? '(' : ''], serialize);
                    var dataSecondChild_1 = secondChild ? serialize.visitNode(secondChild, '') : null;
                    res = (0, common_1.AddToAsciiData)(res, [
                        dataSecondChild_1 ? dataSecondChild_1.ascii : '',
                        dataSecondChild_1 ? dataSecondChild_1.ascii_tsv : '',
                        dataSecondChild_1 ? dataSecondChild_1.ascii_csv : '',
                        dataSecondChild_1 ? dataSecondChild_1.ascii_md : ''
                    ], serialize, secondChild);
                    res = (0, common_1.AddToAsciiData)(res, [serialize.options.extraBrackets ? ')' : ''], serialize);
                }
            }
            else {
    ...
    return function (node, serialize) {
        ...
        try {
            ...
            if (secondChild && secondChild.kind === 'mo') {
                ...
                res = (0, common_1.AddToAsciiData)(res, ['_'], serialize);
                res = (0, common_1.AddToAsciiData)(res, [serialize.options.extraBrackets ? '(' : ''], serialize);
                var dataSecondChild = secondChild ? serialize.visitNode(secondChild, '') : null;
                res = (0, common_1.AddToAsciiData)(res, [
...
var msqrt = function () {
    return function (node, serialize) {
        ...
        try {
            var firstChild = node.childNodes[0] ? node.childNodes[0] : null;
            res = (0, common_1.AddToAsciiData)(res, ['sqrt'], serialize);
            var dataFirstChild = firstChild ? serialize.visitNode(firstChild, '') : null;
            res = (0, common_1.AddToAsciiData)(res, [
                dataFirstChild ? dataFirstChild.ascii : '',
                dataFirstChild ? dataFirstChild.ascii_tsv : '',
...
var mroot = function () {
    return function (node, serialize) {
        ...
        try {
            var firstChild = node.childNodes[0] ? node.childNodes[0] : null;
            var secondChild = node.childNodes[1] ? node.childNodes[1] : null;
            res = (0, common_1.AddToAsciiData)(res, ['root'], serialize);
            res = (0, common_1.AddToAsciiData)(res, [secondChild ? '(' : ''], serialize);
            var dataSecondChild = secondChild ? serialize.visitNode(secondChild, '') : null;
            res = (0, common_1.AddToAsciiData)(res, [
                dataSecondChild ? dataSecondChild.ascii : '',
                dataSecondChild ? dataSecondChild.ascii_tsv : '',
            ...
            res = (0, common_1.AddToAsciiData)(res, [secondChild ? ')' : ''], serialize);
            res = (0, common_1.AddToAsciiData)(res, [firstChild ? '(' : ''], serialize);
            var dataFirstChild = firstChild ? serialize.visitNode(firstChild, '') : null;
            res = (0, common_1.AddToAsciiData)(res, [
                dataFirstChild ? dataFirstChild.ascii : '',
                dataFirstChild ? dataFirstChild.ascii_tsv : '',
...
var mtext = function () {
    return function (node, serialize) {
        ...
        try {
            ...
            if (asc) {
                res = (0, common_1.AddToAsciiData)(res, [asc], serialize, node);
                return res;
            }
            var toTsv = node.attributes.get('toTsv');
            var toCsv = node.attributes.get('toCsv');
...
var mi = function () {
    return function (node, serialize) {
        ...
        try {
            ...
            if (abs && abs.length && common_1.regW.test(abs[0])) {
                var isNeedFirstSpace = (0, common_1.needFirstSpaceBeforeLetter)(node, abs, serialize)
                    || (0, common_1.needFirstSpaceBeforeCurrentNode)(node, serialize);
                res = (0, common_1.AddToAsciiData)(res, [isNeedFirstSpace ? ' ' : ''], serialize);
                res = (0, common_1.AddToAsciiData)(res, [abs], serialize, node);
            }
            else {
                res = (0, common_1.AddToAsciiData)(res, [abs], serialize, node);
            }
    ...
    return function (node, serialize) {
        ...
        try {
            ...
            if (abs && abs.length > 1) {
                var isNeedFirstSpace = (0, common_1.needFirstSpaceBeforeLetter)(node, abs, serialize)
                    || (0, common_1.needFirstSpaceBeforeCurrentNode)(node, serialize);
                res = (0, common_1.AddToAsciiData)(res, [common_1.regW.test(abs[0]) && isNeedFirstSpace ? ' ' : ''], serialize);
                res = (0, common_1.AddToAsciiData)(res, [abs], serialize, node);
            }
            else {
    ...
    return function (node, serialize) {
        ...
        try {
            ...
            if (atr && atr.width === "2em") {
                res = (0, common_1.AddToAsciiData)(res, [node.parent.parent && (0, common_1.needFirstSpaceBeforeLetter)(node.parent.parent, 'qquad', serialize) ? ' ' : ''], serialize);
                res = (0, common_1.AddToAsciiData)(res, ['qquad'], serialize, node);
                return res;
            }
            if (atr && atr.width === "1em") {
                res = (0, common_1.AddToAsciiData)(res, [node.parent.parent && (0, common_1.needFirstSpaceBeforeLetter)(node.parent.parent, 'quad', serialize) ? ' ' : ''], serialize);
                res = (0, common_1.AddToAsciiData)(res, ['quad'], serialize, node);
                return res;
            }
            var data = handlerApi.handleAll(node, serialize);
            res = (0, common_1.AddToAsciiData)(res, [data.ascii, data.ascii_tsv, data.ascii_csv, data.ascii_md], serialize, node);
    ...
    try {
        try {
            for (var _b = tslib_1.__values(node.childNodes), _c = _b.next(); !_c.done; _c = _b.next()) {
                var child = _c.value;
                var data = serialize.visitNode(child, '');
                res = (0, common_1.AddToAsciiData)(res, [data.ascii, data.ascii_tsv, data.ascii_csv, data.ascii_md], serialize, child);
            }
        }
