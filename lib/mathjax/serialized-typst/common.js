    ...
    try {
        ...
        if (exports.RE_TWO_DIGITS.test(nextText)) {
            ...
            while (j + 2 < node.childNodes.length) {
                ...
                if ((nextComma === null || nextComma === void 0 ? void 0 : nextComma.kind) !== 'mo' || ((_g = (_f = nextComma === null || nextComma === void 0 ? void 0 : nextComma.childNodes) === null || _f === void 0 ? void 0 : _f[0]) === null || _g === void 0 ? void 0 : _g.text) !== ',')
                    break;
                if ((nextNode === null || nextNode === void 0 ? void 0 : nextNode.kind) !== 'mn')
                    break;
                var nextDigits = ((_j = (_h = nextNode === null || nextNode === void 0 ? void 0 : nextNode.childNodes) === null || _h === void 0 ? void 0 : _h[0]) === null || _j === void 0 ? void 0 : _j.text) || '';
                if (exports.RE_THREE_DIGITS.test(nextDigits))
                    return true;
                if (!exports.RE_TWO_DIGITS.test(nextDigits))
                    break;
                j += 2;
            }
        }
...
var formatScript = function (prefix, content) {
    if (!content)
        return '';
    return prefix + ((0, exports.needsParens)(content) ? '(' + content + ')' : content);
};
