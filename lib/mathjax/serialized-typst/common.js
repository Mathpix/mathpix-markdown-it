...
exports.isNegationOverlay = exports.getContentChildren = exports.getProp = exports.getAttrs = exports.getNodeText = exports.getChildText = exports.getSiblingIndex = exports.isFirstChild = exports.needsTokenSeparator = exports.isNonLatinText = exports.isThousandSepComma = exports.escapeTypstContent = void 0;
...
var needsTokenSeparator = function (prev, next) {
    ...
    if (consts_1.RE_ESCAPED_BRACKET_START.test(next)) {
