...
exports.isNegationOverlay = exports.getContentChildren = exports.getProp = exports.getAttrs = exports.getNodeText = exports.getChildText = exports.getSiblingIndex = exports.isFirstChild = exports.needsTokenSeparator = exports.isNonLatinText = exports.isThousandSepComma = exports.escapeTypstContent = exports.sanitizeTypstLabel = void 0;
...
var sanitizeTypstLabel = function (key) {
    return key.replace(RE_INVALID_LABEL_CHARS, function (ch) { return '_' + ch.charCodeAt(0).toString(16).toUpperCase(); }) || 'label';
};
exports.sanitizeTypstLabel = sanitizeTypstLabel;
/** Escape text for Typst content mode ([...] blocks).
 *  Handles: markup specials (* _ ` @ # < [ ]) and comment starts (// /\*). */
var escapeTypstContent = function (text) {
    return text
        .replace(consts_1.RE_CONTENT_SPECIAL, '\\$&')
        .replace(RE_COMMENT_START, function (m) { return m.replace(/./g, '\\$&'); });
};
exports.escapeTypstContent = escapeTypstContent;
