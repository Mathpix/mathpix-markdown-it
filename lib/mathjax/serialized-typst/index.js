        ...
        try {
            ...
            while (j < node.childNodes.length) {
                ...
                if (child.kind === 'mn' && j + 2 < node.childNodes.length) {
                    var comma = node.childNodes[j + 1];
                    var next = node.childNodes[j + 2];
                    if ((comma === null || comma === void 0 ? void 0 : comma.kind) === 'mo' && ((_c = (_b = comma === null || comma === void 0 ? void 0 : comma.childNodes) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.text) === ','
                        && (next === null || next === void 0 ? void 0 : next.kind) === 'mn' && /^\d{3}$/.test(((_f = (_d = next === null || next === void 0 ? void 0 : next.childNodes) === null || _d === void 0 ? void 0 : _d[0]) === null || _f === void 0 ? void 0 : _f.text) || '')) {
                        ...
                        var nextData = this.visitNode(next, space);
