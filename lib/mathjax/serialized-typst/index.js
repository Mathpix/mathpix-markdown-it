    ...
    SerializedTypstVisitor.prototype.visitInferredMrowNode = function (node, space) {
        ...
        try {
            ...
            while (j < node.childNodes.length) {
                ...
                if ((child === null || child === void 0 ? void 0 : child.kind) === 'mo' && (0, common_1.getChildText)(child) === '\u222B') {
                    var next1 = node.childNodes[j + 1];
                    var next2 = node.childNodes[j + 2];
                    if ((next1 === null || next1 === void 0 ? void 0 : next1.kind) === 'mo' && (0, common_1.getChildText)(next1) === '\u22EF' && next2) {
                        ...
                        if (SCRIPT_KINDS.has(next2.kind)
                            ...
                            && (0, common_1.getChildText)(scriptBase) === '\u222B') {
