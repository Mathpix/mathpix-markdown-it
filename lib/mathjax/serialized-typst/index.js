...
var SerializedTypstVisitor = /** @class */ (function (_super) {
    ...
    function SerializedTypstVisitor(labels) {
        if (labels === void 0) { labels = null; }
        var _this = _super.call(this) || this;
        _this.astSerializer = (0, dispatcher_1.createAstSerializer)(labels);
        return _this;
    }
    ...
    SerializedTypstVisitor.prototype.visitDefault = function (node, _space) {
        ...
        var typstInline = result.nodeInline
            ...
            : undefined;
        var errors = this.astSerializer.errors.length > 0
            ? tslib_1.__spreadArray([], tslib_1.__read(this.astSerializer.errors), false) : undefined;
        return {
            typst: typst,
