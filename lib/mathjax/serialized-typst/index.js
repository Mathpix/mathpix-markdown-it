...
var SUBSCRIPT_KINDS = new Set(['msubsup', 'msub', 'msup']);
...
var tryBareDelimiterPattern = function (node, j, space, serialize) {
    ...
    var content = delimPair.isFuncCall
        ? (0, escape_utils_1.escapeContentSeparators)(rawContent.trim()) : rawContent.trim();
...
var tryIdotsintPattern = function (node, j, space, serialize) {
    ...
    if (!SUBSCRIPT_KINDS.has(next2.kind) || (scriptBase === null || scriptBase === void 0 ? void 0 : scriptBase.kind) !== 'mo' || (0, common_1.getChildText)(scriptBase) !== consts_1.INTEGRAL_SIGN)
        return null;
