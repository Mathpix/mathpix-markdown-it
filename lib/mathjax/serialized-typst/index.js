...
var isSinglePipeNode = function (node) {
    var _a, _b, _c;
    try {
        if (!node || !node.childNodes)
            return false;
        if (node.kind === 'mo') {
            return ((_a = node.childNodes[0]) === null || _a === void 0 ? void 0 : _a.text) === '|';
        }
        if (node.kind === 'mrow' || node.kind === 'TeXAtom') {
            ...
            if (children.length === 1 && children[0].kind === 'mo') {
                return ((_c = (_b = children[0].childNodes) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.text) === '|';
            }
        }
        return false;
    }
    ...
    SerializedTypstVisitor.prototype.visitInferredMrowNode = function (node, space) {
        ...
        try {
            ...
            while (j < node.childNodes.length) {
                ...
                if (isSinglePipeNode(child) && ((_a = node.parent) === null || _a === void 0 ? void 0 : _a.kind) !== 'TeXAtom') {
                    var closeIdx = -1;
                    for (var k = j + 1; k < node.childNodes.length; k++) {
                    ...
                    if (closeIdx > j + 1) {
                        ...
                        var pipeExpr = 'lr(| ' + content.trim() + ' |)';
                        if (res.typst && /^[\w."]/.test(pipeExpr)
                            && !/[\s({[,|]$/.test(res.typst)) {
                            res.typst += ' ';
                        }
                        res = (0, common_1.addToTypstData)(res, { typst: pipeExpr });
                        j = closeIdx + 1;
                        continue;
                    }
                }
