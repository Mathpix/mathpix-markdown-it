    ...
    SerializedTypstVisitor.prototype.visitInferredMrowNode = function (node, space) {
        ...
        try {
            ...
            while (j < node.childNodes.length) {
                    ...
                    if (closeIdx > j + 1) {
                        ...
                        if (closeIsScripted) {
                            ...
                            if (scriptNode.kind === 'msubsup') {
                                ...
                                if (sub)
                                    delimExpr += '_' + ((0, common_1.needsParens)(sub) ? '(' + sub + ')' : sub);
                                if (sup)
                                    delimExpr += '^' + ((0, common_1.needsParens)(sup) ? '(' + sup + ')' : sup);
                            }
                ...
                if ((child === null || child === void 0 ? void 0 : child.kind) === 'mo' && ((_c = (_b = child === null || child === void 0 ? void 0 : child.childNodes) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.text) === '\u222B') {
                    var next1 = node.childNodes[j + 1];
                    var next2 = node.childNodes[j + 2];
                    if ((next1 === null || next1 === void 0 ? void 0 : next1.kind) === 'mo' && ((_f = (_d = next1 === null || next1 === void 0 ? void 0 : next1.childNodes) === null || _d === void 0 ? void 0 : _d[0]) === null || _f === void 0 ? void 0 : _f.text) === '\u22EF' && next2) {
                        var scriptBase = (_g = next2.childNodes) === null || _g === void 0 ? void 0 : _g[0];
                        if (SCRIPT_KINDS.has(next2.kind)
                            && (scriptBase === null || scriptBase === void 0 ? void 0 : scriptBase.kind) === 'mo'
                            && ((_j = (_h = scriptBase === null || scriptBase === void 0 ? void 0 : scriptBase.childNodes) === null || _h === void 0 ? void 0 : _h[0]) === null || _j === void 0 ? void 0 : _j.text) === '\u222B') {
                            // Serialize the three base parts
                            var part1 = this.visitNode(child, space);
                            var part2 = this.visitNode(next1, space);
                            var part3 = (0, typst_symbol_map_1.findTypstSymbol)('\u222B'); // integral
                            ...
                            if (subChild) {
                                ...
                                if (sub) {
                                    ...
                                    res = (0, common_1.addToTypstData)(res, { typst: (0, common_1.needsParens)(sub) ? '(' + sub + ')' : sub });
                                }
                            }
                            if (supChild) {
                                ...
                                if (sup) {
                                    ...
                                    res = (0, common_1.addToTypstData)(res, { typst: (0, common_1.needsParens)(sup) ? '(' + sup + ')' : sup });
                                }
                            }
                            j += 3;
                            continue;
                ...
                if (child.kind === 'mtable' && res.typst.trim()) {
                    var childIsEqnArray = child.childNodes.length > 0
                        && ((_k = child.childNodes[0].attributes) === null || _k === void 0 ? void 0 : _k.get('displaystyle'));
