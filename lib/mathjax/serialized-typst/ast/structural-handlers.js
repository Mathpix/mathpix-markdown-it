...
var mencloseAst = function (node, serialize) {
    ...
    if (hasNotation(words, 'box')) {
        var boxNode = (0, builders_1.funcCall)('box', [
            ...
            (0, builders_1.posArg)((0, builders_1.inlineMathVal)(contentNode)),
        ]);
        return {
            node: (0, builders_1.funcCall)('align', [(0, builders_1.posArg)((0, builders_1.identVal)('center')), (0, builders_1.posArg)((0, builders_1.callVal)(boxNode))], { hash: true }),
            nodeInline: contentNode,
        };
    }
    ...
    if (hasNotation(words, 'circle')) {
        var circleNode = (0, builders_1.funcCall)('circle', [
            (0, builders_1.namedArg)('inset', (0, builders_1.lengthVal)(consts_1.BOX_INSET)),
            (0, builders_1.posArg)((0, builders_1.inlineMathVal)(contentNode)),
        ]);
        return {
            node: (0, builders_1.funcCall)('align', [(0, builders_1.posArg)((0, builders_1.identVal)('center')), (0, builders_1.posArg)((0, builders_1.callVal)(circleNode))], { hash: true }),
            nodeInline: contentNode,
        };
    }
    ...
    if (hasBorderNotation(words)) {
        ...
        return {
            node: (0, builders_1.funcCall)('align', [(0, builders_1.posArg)((0, builders_1.identVal)('center')), (0, builders_1.posArg)((0, builders_1.callVal)(borderBoxNode))], { hash: true }),
            nodeInline: contentNode,
        };
    }
