...
var msupAst = function (node, serialize) {
    ...
    var supEmpty = (0, builders_1.isEmptyNode)(supNode);
    ...
    if (needsLimitsMode(baseTrimmed, firstChild)) {
        return {
            node: (0, builders_1.scriptNode)(addLimitsToNode(baseNode), !supEmpty ? { sup: supNode } : {})
        };
    }
    return {
        node: (0, builders_1.scriptNode)(baseNode, !supEmpty ? { sup: supNode } : {})
    };
};
...
var msubAst = function (node, serialize) {
    ...
    var baseEmpty = (0, builders_1.isEmptyNode)(baseNode);
    var subEmpty = (0, builders_1.isEmptyNode)(subNode);
    ...
    if (needsLimitsMode(baseTrimmed, firstChild)) {
        return {
            node: (0, builders_1.scriptNode)(addLimitsToNode(baseNode), !subEmpty ? { sub: subNode } : {})
        };
    }
    return {
        node: (0, builders_1.scriptNode)(baseNode, !subEmpty ? { sub: subNode } : {})
    };
};
...
var msubsupAst = function (node, serialize) {
    if (isOpeningBracketBase(node.childNodes[0])) {
        ...
        var opts_1 = {};
        if (!(0, builders_1.isEmptyNode)(subNode_2)) {
            opts_1.sub = subNode_2;
        }
        if (!(0, builders_1.isEmptyNode)(supNode_2)) {
