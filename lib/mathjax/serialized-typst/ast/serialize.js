...
var needsSeparator = function (prev, next, prevNode) {
    ...
    var prevIsSeparator = consts_1.RE_SEPARATOR_END.test(prev) && !consts_1.RE_ESCAPED_BRACKET_END.test(prev);
    ...
    if (consts_1.RE_ESCAPED_BRACKET_START.test(next) && consts_1.RE_WORD_DOT_END.test(prev)) {
        return true;
    }
...
var applyFuncEscaping = function (expr, ctx) {
    switch (ctx) {
        ...
        case "lr-content" /* FuncEscapeContext.LrContent */: {
            ...
            var lr = (0, escape_utils_1.escapeUnpairedBrackets)(expr);
            lr = (0, escape_utils_1.escapeUnbalancedParens)(lr);
            lr = (0, escape_utils_1.escapeUnbalancedBraces)(lr);
            return (0, escape_utils_1.escapeLrSemicolons)(lr);
        }
    }
};
...
var formatScriptPart = function (prefix, content) {
    ...
    if (content.length > 1) {
        var safe = (0, escape_utils_1.escapeUnpairedBrackets)(content);
        safe = (0, escape_utils_1.escapeUnbalancedParens)(safe);
        safe = (0, escape_utils_1.escapeUnbalancedBraces)(safe);
        return prefix + '(' + safe + ')';
    }
...
var escapeLrBody = function (body, openDelim, closeDelim) {
    ...
    escaped = (0, escape_utils_1.escapeUnpairedBrackets)(escaped);
    escaped = (0, escape_utils_1.escapeUnbalancedParens)(escaped);
    escaped = (0, escape_utils_1.escapeUnbalancedBraces)(escaped);
    escaped = (0, escape_utils_1.escapeLrSemicolons)(escaped);
    // Invariant check — all backstops should leave body balanced.
    // If not, something upstream is broken; warn in dev builds.
    if (typeof process !== 'undefined' && ((_a = process.env) === null || _a === void 0 ? void 0 : _a.NODE_ENV) !== 'production' && typeof console !== 'undefined') {
        var unpaired = (0, bracket_utils_1.countUnpairedBrackets)(escaped);
        if (unpaired > 0) {
