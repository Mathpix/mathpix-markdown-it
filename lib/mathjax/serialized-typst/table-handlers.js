...
var buildMatrix = function (node, rows, branchOpen, branchClose, rowsInline) {
    ...
    if (frame === 'solid') {
        res = (0, common_1.addToTypstData)(res, { typst: "#align(center, box(stroke: 0.5pt, inset: 3pt, $ ".concat(matExpr, " $))"), typst_inline: matExprInline !== null && matExprInline !== void 0 ? matExprInline : matExpr });
    }
    else {
