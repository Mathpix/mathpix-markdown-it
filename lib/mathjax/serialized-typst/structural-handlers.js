...
var mrow = function (node, serialize) {
    ...
    if (isLeftRight && !hasTableChild) {
        ...
        for (var i = 0; i < node.childNodes.length; i++) {
            ...
            if ((0, common_1.needsSpaceBetweenNodes)(content, data.typst, i > 0 ? node.childNodes[i - 1] : null)) {
                content += ' ';
            }
            content += data.typst;
        }
        ...
        if (hasVisibleOpen && hasVisibleClose) {
            ...
            if (openDelim === '|' && closeDelim === '|') {
                ...
                res = (0, common_1.addToTypstData)(res, { typst: hasSep
                        ? "lr(| ".concat(escaped, " |)") : "abs(".concat((0, escape_utils_1.escapeContentSeparators)(trimmedContent), ")") });
            }
            else if (openDelim === consts_1.DOUBLE_VERT && closeDelim === consts_1.DOUBLE_VERT) {
                var escaped = (0, escape_utils_1.escapeLrSemicolons)(trimmedContent);
                res = (0, common_1.addToTypstData)(res, { typst: hasSep
                        ? "lr(\u2016 ".concat(escaped, " \u2016)") : "norm(".concat((0, escape_utils_1.escapeContentSeparators)(trimmedContent), ")") });
            }
            else if (openDelim === consts_1.LEFT_FLOOR && closeDelim === consts_1.RIGHT_FLOOR) {
                var escaped = (0, escape_utils_1.escapeLrSemicolons)(trimmedContent);
                res = (0, common_1.addToTypstData)(res, { typst: hasSep
                        ? "lr(\u230A ".concat(escaped, " \u230B)") : "floor(".concat((0, escape_utils_1.escapeContentSeparators)(trimmedContent), ")") });
            }
            else if (openDelim === consts_1.LEFT_CEIL && closeDelim === consts_1.RIGHT_CEIL) {
                var escaped = (0, escape_utils_1.escapeLrSemicolons)(trimmedContent);
                res = (0, common_1.addToTypstData)(res, { typst: hasSep
                        ? "lr(\u2308 ".concat(escaped, " \u2309)") : "ceil(".concat((0, escape_utils_1.escapeContentSeparators)(trimmedContent), ")") });
            }
            else {
