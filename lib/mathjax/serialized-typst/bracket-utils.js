...
var isFuncCallParen = function (expr, i) {
    var prev = expr[i - 1];
    if (consts_1.RE_ASCII_LETTER.test(prev))
        return true;
    if (prev === '.' && i > 1 && consts_1.RE_ASCII_LETTER.test(expr[i - 2]))
        return true;
    return false;
};
...
var markUnpairedBrackets = function (root) {
    ...
    var walk = function (node) {
        ...
        try {
            for (var _e = tslib_1.__values(((_c = node.childNodes) !== null && _c !== void 0 ? _c : [])), _f = _e.next(); !_f.done; _f = _e.next()) {
                var child = _f.value;
                if (SCOPE_BOUNDARIES.has(child.kind)) {
                    try {
                        ...
                        for (var _g = (e_7 = void 0, tslib_1.__values(((_d = child.childNodes) !== null && _d !== void 0 ? _d : []))), _h = _g.next(); !_h.done; _h = _g.next()) {
                            var grandchild = _h.value;
