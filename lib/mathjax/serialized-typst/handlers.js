    ...
    return function (node, _serialize) {
        ...
        try {
            ...
            if (value.length > 1 && /^\w/.test(value) && !typst_symbol_map_1.typstSymbolMap.has(value) && !TYPST_MATH_OPERATORS.has(value)) {
                ...
                var opName = value.replace(/[\u2006\u2005\u2004\u2009\u200A\u00A0]/g, ' ');
                var parentKind_1 = (_a = node.parent) === null || _a === void 0 ? void 0 : _a.kind;
                var isLimits = parentKind_1 === 'munder' || parentKind_1 === 'mover' || parentKind_1 === 'munderover';
                if (isLimits) {
                    res = (0, common_1.addToTypstData)(res, { typst: 'op("' + opName + '", limits: #true)' });
                }
                else {
        ...
        try {
            ...
            for (var i = 0; i < countRow; i++) {
                ...
                if (isEqnArray) {
                    ...
                    rows.push(cells.map(function (c) { return escapeCasesCommas(c); }).join(' & '));
                }
                else {
                    rows.push(cells.join(', '));
                }
