...
exports.LEFT_FLOOR = exports.PARALLEL_SIGN = exports.DOUBLE_VERT = exports.LEFT_ARROW = exports.RIGHT_ARROW = exports.HORIZ_BAR = exports.MINUS_PLUS = exports.PLUS_MINUS = exports.MINUS_SIGN = exports.INVISIBLE_PLUS = exports.INVISIBLE_SEP = exports.INVISIBLE_TIMES = exports.FUNC_APPLY = exports.EQ_TAG_FIGURE_KIND = exports.DEFAULT_EQ_NUMBERING = exports.TYPST_PLACEHOLDER = exports.UNPAIRED_BRACKET_PROP = exports.DATA_LABEL_KEY = exports.DATA_TAG_AUTO = exports.DATA_POST_CONTENT = exports.DATA_PRE_CONTENT = exports.RE_LETTERS_AND_MARKS = exports.RE_LATIN_WITH_MARKS = exports.RE_TRAILING_DOTTED_IDENT = exports.RE_TRAILING_IDENT = exports.RE_ALPHA_END = exports.RE_SEPARATOR_END = exports.RE_TOKEN_START = exports.RE_ESCAPED_BRACKET_END = exports.RE_ESCAPED_BRACKET_START = exports.RE_PHANTOM_BASE = exports.RE_TWO_DIGITS = exports.RE_THREE_DIGITS = exports.RE_TRAILING_SPACING = exports.RE_UNICODE_SPACES = exports.RE_LEADING_WS = exports.RE_TRAILING_WS = exports.RE_ASCII_LETTER = exports.RE_WORD_CHAR = exports.RE_BRACKET_CHARS = exports.RE_TAG_STRIP = exports.RE_TAG_EXTRACT = exports.RE_OP_WRAPPER = exports.RE_WORD_START = exports.RE_WORD_DOT_START = exports.RE_WORD_DOT_END = exports.RE_CONTENT_SPECIAL = exports.RE_NBSP = exports.MLABELEDTR = exports.TEX_ATOM = void 0;
exports.UNPAIRED_BRACKET_TABLE_TYPST = exports.UNPAIRED_BRACKET_TYPST = exports.BLOCK_CODE_FUNCS = exports.BOX_INSET = exports.BOX_STROKE = exports.TYPST_BUILTIN_OPS = exports.TYPST_MATH_OPERATORS = exports.FENCE_CLOSE_CHARS = exports.FENCE_OPEN_CHARS = exports.CLOSE_BRACKETS = exports.OPEN_BRACKETS = exports.UNWRAP_MAX_DEPTH = exports.TABLE_ANCESTOR_MAX_DEPTH = exports.ANCESTOR_MAX_DEPTH = exports.SHALLOW_TREE_MAX_DEPTH = exports.PRIME_CHARS = exports.SCRIPT_NODE_KINDS = exports.MIDLINE_ELLIPSIS = exports.INTEGRAL_SIGN = exports.RIGHT_ANGLE_OLD = exports.LEFT_ANGLE_OLD = exports.RIGHT_CHEVRON = exports.LEFT_CHEVRON = exports.RIGHT_CEIL = exports.LEFT_CEIL = exports.RIGHT_FLOOR = void 0;
...
exports.RE_ESCAPED_BRACKET_START = /^\\[()[\]{}]/;
/** Any escaped bracket at end: ...\( ...\) etc. — NOT a separator */
exports.RE_ESCAPED_BRACKET_END = /\\[()[\]{}]$/;
...
exports.FENCE_OPEN_CHARS = new Set(tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(Object.keys(exports.OPEN_BRACKETS)), false), [
    exports.LEFT_CHEVRON, exports.LEFT_ANGLE_OLD, exports.LEFT_FLOOR, exports.LEFT_CEIL,
], false));
exports.FENCE_CLOSE_CHARS = new Set(tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(Object.keys(exports.CLOSE_BRACKETS)), false), [
    exports.RIGHT_CHEVRON, exports.RIGHT_ANGLE_OLD, exports.RIGHT_FLOOR, exports.RIGHT_CEIL,
], false));
...
exports.BLOCK_CODE_FUNCS = new Set([
    'math.equation', 'grid',
]);
