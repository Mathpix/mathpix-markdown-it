...
var MathMLVisitorWord = /** @class */ (function (_super) {
    ...
    MathMLVisitorWord.prototype.visitDefault = function (node, space) {
        ...
        if (this.options.forDocx) {
            if (node.kind === 'mo') {
                var stretchy = (_b = (_a = node.attributes) === null || _a === void 0 ? void 0 : _a.attributes) === null || _b === void 0 ? void 0 : _b.stretchy;
                if (stretchy) {
            ...
            if (node.kind === 'mo' && ((_c = node.Parent) === null || _c === void 0 ? void 0 : _c.kind) === 'mover') {
                var stretchy = (_e = (_d = node.attributes) === null || _d === void 0 ? void 0 : _d.attributes) === null || _e === void 0 ? void 0 : _e.stretchy;
                if (stretchy) {
                    var text = ((_f = node.childNodes[0]) === null || _f === void 0 ? void 0 : _f.kind) === 'text' && node.childNodes[0].text;
                    if (text === "\u2015") {
                        text = "\u00AF";
