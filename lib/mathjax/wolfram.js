    ...
    WolframVisitor.prototype.visitInferredMrowNode = function (node, space) {
        ...
        try {
            ...
            for (var i = 0; i < node.childNodes.length; i++) {
                ...
                if (child.kind === "mo"
                    && i > 0
                    && (sVisitNode === null || sVisitNode === void 0 ? void 0 : sVisitNode.trim()) && ![",", "/", "×", ")", "]", "}", ".", "("].includes(sVisitNode === null || sVisitNode === void 0 ? void 0 : sVisitNode.trim())) {
                    if (child.kind === "mo"
                ...
                var childNext = i + 1 < node.childNodes.length
                    ? node.childNodes[i + 1]
                    : null;
                if ((((child.kind === "mi" || child.kind === "mn")
                    && sVisitNode !== "d"
