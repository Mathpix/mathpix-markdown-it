...
exports.MathJax = {
    ...
    TexConvert: function (string, options, throwError) {
        ...
        var _p = metric.em, em = _p === void 0 ? 16 : _p, _q = metric.ex, ex = _q === void 0 ? 8 : _q, _r = metric.cwidth, cwidth = _r === void 0 ? 1200 : _r, _s = metric.lwidth, lwidth = _s === void 0 ? 100000 : _s, _t = metric.scale, scale = _t === void 0 ? 2 : _t;
        ...
        try {
            console.log("[MMD]=>cwidth=>", cwidth);
            console.log("[MMD]=>lwidth=>", lwidth);
            console.log("[MMD]=>scale=>", scale);
