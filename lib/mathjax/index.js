...
var OuterHTML = function (node, math, outMath) {
    var _a = outMath.include_mathml, include_mathml = _a === void 0 ? false : _a, _b = outMath.include_asciimath, include_asciimath = _b === void 0 ? false : _b, _c = outMath.include_latex, include_latex = _c === void 0 ? true : _c, _d = outMath.include_svg, include_svg = _d === void 0 ? true : _d;
    var outHTML = '';
    if (include_mathml) {
