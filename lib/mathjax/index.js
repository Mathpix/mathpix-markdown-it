...
var toTypstData = function (node) {
    ...
    var visitorT = new serialized_typst_1.SerializedTypstVisitor();
...
var OuterData = function (adaptor, node, math, outMath, forDocx, accessibility) {
    ...
    var _c = outMath.include_mathml, include_mathml = _c === void 0 ? false : _c, _d = outMath.include_mathml_word, include_mathml_word = _d === void 0 ? false : _d, _e = outMath.include_asciimath, include_asciimath = _e === void 0 ? false : _e, _f = outMath.include_latex, include_latex = _f === void 0 ? false : _f, _g = outMath.include_linearmath, include_linearmath = _g === void 0 ? false : _g, _h = outMath.include_typst, include_typst = _h === void 0 ? false : _h, _j = outMath.include_svg, include_svg = _j === void 0 ? true : _j, _k = outMath.include_speech, include_speech = _k === void 0 ? false : _k, _l = outMath.optionAscii, optionAscii = _l === void 0 ? {
        showStyle: false,
        extraBrackets: true,
    ...
    if (include_typst) {
        var typstData = toTypstData(math.root);
...
var OuterDataAscii = function (adaptor, node, math, outMath, forDocx, accessibility) {
    if (forDocx === void 0) { forDocx = false; }
    var _a = outMath.include_mathml, include_mathml = _a === void 0 ? false : _a, _b = outMath.include_mathml_word, include_mathml_word = _b === void 0 ? false : _b, _c = outMath.include_asciimath, include_asciimath = _c === void 0 ? false : _c, _d = outMath.include_typst, include_typst = _d === void 0 ? false : _d, _e = outMath.include_svg, include_svg = _e === void 0 ? true : _e, _f = outMath.include_speech, include_speech = _f === void 0 ? false : _f, _g = outMath.output_format, output_format = _g === void 0 ? 'svg' : _g;
    var res = {};
    var a11y = applyMathJaxA11y(adaptor, node, accessibility, include_speech);
    if (a11y.speech) {
        res.speech = a11y.speech;
...
var OuterDataMathMl = function (adaptor, node, math, outMath, forDocx, accessibility) {
    if (forDocx === void 0) { forDocx = false; }
    var _a = outMath.include_mathml, include_mathml = _a === void 0 ? false : _a, _b = outMath.include_mathml_word, include_mathml_word = _b === void 0 ? false : _b, _c = outMath.include_asciimath, include_asciimath = _c === void 0 ? false : _c, _d = outMath.include_svg, include_svg = _d === void 0 ? true : _d, _e = outMath.include_speech, include_speech = _e === void 0 ? false : _e, _f = outMath.include_linearmath, include_linearmath = _f === void 0 ? false : _f, _g = outMath.include_typst, include_typst = _g === void 0 ? false : _g, _h = outMath.optionAscii, optionAscii = _h === void 0 ? {
        showStyle: false,
        extraBrackets: true
    } : _h, _j = outMath.output_format, output_format = _j === void 0 ? 'svg' : _j;
    var res = {};
    var a11y = applyMathJaxA11y(adaptor, node, accessibility, include_speech);
    if (a11y.speech) {
        res.speech = a11y.speech;
...
exports.MathJax = {
    ...
    TexConvertToTypstData: function (string, options) {
        var _a, _b, _c;
        if (options === void 0) { options = {}; }
        var _d = options.display, display = _d === void 0 ? true : _d, _e = options.metric, metric = _e === void 0 ? {} : _e, _f = options.accessibility, accessibility = _f === void 0 ? null : _f;
