...
var wolfram_1 = require("./wolfram");
var post_process_1 = require("./serialized-wolfram/post-process");
...
var toWolfram = function (node, optionsWolfram) {
    var visitor = new wolfram_1.WolframVisitor(optionsWolfram);
    var wolfram = visitor.visitTree(node);
    wolfram = post_process_1.postProcessWolfram(wolfram);
    return wolfram === null || wolfram === void 0 ? void 0 : wolfram.trim();
};
...
var OuterData = function (adaptor, node, math, outMath, forDocx, accessibility) {
    ...
    var _a = outMath.include_mathml, include_mathml = _a === void 0 ? false : _a, _b = outMath.include_mathml_word, include_mathml_word = _b === void 0 ? false : _b, _c = outMath.include_asciimath, include_asciimath = _c === void 0 ? false : _c, _d = outMath.include_wolfram, include_wolfram = _d === void 0 ? false : _d, _e = outMath.include_latex, include_latex = _e === void 0 ? false : _e, _f = outMath.include_svg, include_svg = _f === void 0 ? true : _f, _g = outMath.include_speech, include_speech = _g === void 0 ? false : _g, _h = outMath.optionAscii, optionAscii = _h === void 0 ? {
        showStyle: false,
        extraBrackets: true,
    } : _h, _j = outMath.wolfram_options, wolfram_options = _j === void 0 ? {
        unicode: false
    } : _j;
    var res = {};
...
var OuterHTML = function (data, outMath) {
    var _a = outMath.include_mathml, include_mathml = _a === void 0 ? false : _a, _b = outMath.include_mathml_word, include_mathml_word = _b === void 0 ? false : _b, _c = outMath.include_asciimath, include_asciimath = _c === void 0 ? false : _c, _d = outMath.include_wolfram, include_wolfram = _d === void 0 ? false : _d, _e = outMath.include_latex, include_latex = _e === void 0 ? false : _e, _f = outMath.include_svg, include_svg = _f === void 0 ? true : _f, _g = outMath.include_error, include_error = _g === void 0 ? false : _g, _h = outMath.include_speech, include_speech = _h === void 0 ? false : _h;
    var outHTML = '';
    ...
    if (include_wolfram && data.wolfram) {
        ...
        outHTML += '<wolfram style="display: none;">' + parse_mmd_element_1.formatSource(data.wolfram) + '</wolfram>';
    }
...
exports.MathJax = {
    ...
    TexConvert: function (string, options) {
        ...
        var _a = options.display, display = _a === void 0 ? true : _a, _b = options.metric, metric = _b === void 0 ? {} : _b, _c = options.outMath, outMath = _c === void 0 ? {} : _c, _d = options.mathJax, mathJax = _d === void 0 ? {} : _d, _e = options.forDocx, forDocx = _e === void 0 ? {} : _e, _f = options.accessibility, accessibility = _f === void 0 ? null : _f, _g = options.nonumbers, nonumbers = _g === void 0 ? false : _g;
        var _h = metric.em, em = _h === void 0 ? 16 : _h, _j = metric.ex, ex = _j === void 0 ? 8 : _j, _k = metric.cwidth, cwidth = _k === void 0 ? 1200 : _k, _l = metric.lwidth, lwidth = _l === void 0 ? 100000 : _l, _m = metric.scale, scale = _m === void 0 ? 1 : _m;
        var _o = mathJax.mtextInheritFont, mtextInheritFont = _o === void 0 ? false : _o;
