...
var handlers_1 = require("./serialized-typst/handlers");
...
var toTypstData = (function (node, optionTypst) {
    var _a;
    var visitorT = new serialized_typst_1.SerializedTypstVisitor(optionTypst);
    var data = visitorT.visitTree(node);
    var typstmath = (0, handlers_1.replaceUnpairedBrackets)(normalizeTypstSpaces(data === null || data === void 0 ? void 0 : data.typst));
    var typstmath_inline = (0, handlers_1.replaceUnpairedBrackets)(normalizeTypstSpaces((_a = data === null || data === void 0 ? void 0 : data.typst_inline) !== null && _a !== void 0 ? _a : data === null || data === void 0 ? void 0 : data.typst));
