...
var OuterData = function (node, math, outMath, forDocx, accessibility) {
    ...
    var res = {};
    var speech = applySpeechToNode(node, accessibility);
...
var OuterDataAscii = function (node, math, outMath, forDocx, accessibility) {
    if (forDocx === void 0) { forDocx = false; }
...
var OuterDataMathMl = function (node, math, outMath, forDocx, accessibility) {
    if (forDocx === void 0) { forDocx = false; }
...
exports.MathJax = {
    ...
    TexConvert: function (string, options) {
        ...
        var _a = options.display, display = _a === void 0 ? true : _a, _b = options.metric, metric = _b === void 0 ? {} : _b, _c = options.outMath, outMath = _c === void 0 ? {} : _c, _d = options.mathJax, mathJax = _d === void 0 ? {} : _d, _e = options.forDocx, forDocx = _e === void 0 ? {} : _e, accessibility = options.accessibility;
    ...
    TypesetMathML: function (string, options) {
        if (options === void 0) { options = {}; }
        var _a = options.display, display = _a === void 0 ? true : _a, _b = options.metric, metric = _b === void 0 ? {} : _b, _c = options.outMath, outMath = _c === void 0 ? {} : _c, _d = options.forDocx, forDocx = _d === void 0 ? {} : _d, accessibility = options.accessibility;
        ...
        var outputJax = docMathML.outputJax;
        var outerDataMathMl = OuterDataMathMl(node, outputJax.math, outMath, forDocx, accessibility);
    ...
    AsciiMathToSvg: function (string, options) {
        ...
        var outerDataAscii = OuterDataAscii(node, outputJax.math, outMath, forDocx, accessibility);
