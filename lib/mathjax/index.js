...
var OuterData = function (adaptor, node, math, outMath, forDocx, accessibility) {
    ...
    if (optionAscii === null || optionAscii === void 0 ? void 0 : optionAscii.tableToCsv) {
...
exports.MathJax = {
    ...
    TexConvert: function (string, options) {
        ...
        var _e = options.display, display = _e === void 0 ? true : _e, _f = options.metric, metric = _f === void 0 ? {} : _f, _g = options.outMath, outMath = _g === void 0 ? {} : _g, _h = options.mathJax, mathJax = _h === void 0 ? {} : _h, _j = options.forDocx, forDocx = _j === void 0 ? {} : _j, _k = options.accessibility, accessibility = _k === void 0 ? null : _k, _l = options.nonumbers, nonumbers = _l === void 0 ? false : _l;
        ...
        var _s = mathJax.mtextInheritFont, mtextInheritFont = _s === void 0 ? false : _s;
        ...
        try {
            ...
            var node = ((_b = (_a = options === null || options === void 0 ? void 0 : options.outMath) === null || _a === void 0 ? void 0 : _a.optionAscii) === null || _b === void 0 ? void 0 : _b.tableToTsv) || ((_d = (_c = options === null || options === void 0 ? void 0 : options.outMath) === null || _c === void 0 ? void 0 : _c.optionAscii) === null || _d === void 0 ? void 0 : _d.tableToCsv)
    ...
    TypesetSvgAndAscii: function (string, options) {
        var _a, _b, _c, _d;
        if (options === void 0) { options = {}; }
        var _e = options.outMath, outMath = _e === void 0 ? {} : _e;
        var _f = outMath.include_asciimath, include_asciimath = _f === void 0 ? false : _f;
        ...
        if ((_d = (_c = options === null || options === void 0 ? void 0 : options.outMath) === null || _c === void 0 ? void 0 : _c.optionAscii) === null || _d === void 0 ? void 0 : _d.tableToCsv) {
        ...
        return {
            ...
            ascii_csv: dataCSV === null || dataCSV === void 0 ? void 0 : dataCSV['asciimath_csv']
        };
    },
    /**
