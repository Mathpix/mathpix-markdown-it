...
var toTypstML = (function (node, optionTypst) {
    var visitorT = new serialized_typst_1.SerializedTypstVisitor(optionTypst);
    var data = visitorT.visitTree(node);
    return (data === null || data === void 0 ? void 0 : data.typst) ? data.typst.trim().replace(/(\S) {2,}/g, '$1 ') : '';
});
...
exports.MathJax = {
    ...
    TexConvertToTypst: function (string, options) {
        if (options === void 0) { options = {}; }
