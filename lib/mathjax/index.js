...
var addDataAttributeIntoOunputJax = function (docTeX, outMath) {
    var _a = outMath.include_mathml, include_mathml = _a === void 0 ? true : _a, _b = outMath.include_latex, include_latex = _b === void 0 ? true : _b;
    if (include_mathml && include_latex) {
        docTeX.outputJax.postFilters.add(function (args) {
            var math = args.math, node = args.data;
            if (!node.setAttribute && !node.attributes) {
                return;
            }
