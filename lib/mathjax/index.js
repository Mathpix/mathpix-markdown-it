...
var getWidthFromNode = function (node) {
    var _a;
    try {
        if (node instanceof Element_js_1.LiteElement) {
            return ((_a = node === null || node === void 0 ? void 0 : node.attributes) === null || _a === void 0 ? void 0 : _a.hasOwnProperty('width'))
                ? node.attributes['width']
                : '';
        }
        if (node instanceof HTMLElement) {
            return (node === null || node === void 0 ? void 0 : node.hasAttribute('width'))
                ? node === null || node === void 0 ? void 0 : node.getAttribute('width')
                : '';
        }
        return '';
    }
...
var OuterData = function (adaptor, node, math, outMath, forDocx, accessibility) {
    ...
    if (include_svg) {
        ...
        if (node) {
            if (node instanceof Element_js_1.LiteElement) {
                var width = getWidthFromNode(node);
                ...
                res.width = width;
                var widthEx = svgElement === null || svgElement === void 0 ? void 0 : svgElement.attributes.width;
                widthEx = widthEx ? widthEx.replace(/ex/g, '') : '';
                var heightEx = svgElement === null || svgElement === void 0 ? void 0 : svgElement.attributes.height;
