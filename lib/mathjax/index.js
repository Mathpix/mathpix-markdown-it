...
var OuterData = function (adaptor, node, math, outMath, forDocx, accessibility) {
    ...
    var _c = outMath.include_mathml, include_mathml = _c === void 0 ? false : _c, _d = outMath.include_mathml_word, include_mathml_word = _d === void 0 ? false : _d, _e = outMath.include_asciimath, include_asciimath = _e === void 0 ? false : _e, _f = outMath.include_latex, include_latex = _f === void 0 ? false : _f, _g = outMath.include_svg, include_svg = _g === void 0 ? true : _g, _h = outMath.include_speech, include_speech = _h === void 0 ? false : _h, _j = outMath.include_chtml, include_chtml = _j === void 0 ? false : _j, _k = outMath.optionAscii, optionAscii = _k === void 0 ? {
        showStyle: false,
        extraBrackets: true,
    } : _k;
    var res = {};
...
var OuterHTML = function (data, outMath, forPptx) {
    ...
    var _a = outMath.include_mathml, include_mathml = _a === void 0 ? false : _a, _b = outMath.include_mathml_word, include_mathml_word = _b === void 0 ? false : _b, _c = outMath.include_asciimath, include_asciimath = _c === void 0 ? false : _c, _d = outMath.include_latex, include_latex = _d === void 0 ? false : _d, _e = outMath.include_svg, include_svg = _e === void 0 ? true : _e, _f = outMath.include_error, include_error = _f === void 0 ? false : _f, _g = outMath.include_speech, include_speech = _g === void 0 ? false : _g, _h = outMath.include_chtml, include_chtml = _h === void 0 ? false : _h;
    var outHTML = '';
...
exports.MathJax = {
    ...
    StylesheetCHTML: function () {
        return mathjax_1.chtml.styleSheet(MJ.mDocTeXCHTML);
    },
    TexConvert: function (string, options, throwError) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m;
        if (options === void 0) { options = {}; }
        if (throwError === void 0) { throwError = false; }
        var _o = options.display, display = _o === void 0 ? true : _o, _p = options.metric, metric = _p === void 0 ? {} : _p, _q = options.outMath, outMath = _q === void 0 ? {} : _q, _r = options.mathJax, mathJax = _r === void 0 ? {} : _r, _s = options.forDocx, forDocx = _s === void 0 ? {} : _s, _t = options.accessibility, accessibility = _t === void 0 ? null : _t, _u = options.nonumbers, nonumbers = _u === void 0 ? false : _u;
        var _v = metric.em, em = _v === void 0 ? 16 : _v, _w = metric.ex, ex = _w === void 0 ? 8 : _w, _x = metric.cwidth, cwidth = _x === void 0 ? 1200 : _x, _y = metric.lwidth, lwidth = _y === void 0 ? 100000 : _y, _z = metric.scale, scale = _z === void 0 ? 1 : _z;
        var _0 = mathJax.mtextInheritFont, mtextInheritFont = _0 === void 0 ? false : _0;
        this.checkAccessibility(accessibility, nonumbers);
        MJ.mDocTeX.outputJax.options.mtextInheritFont = mtextInheritFont;
        try {
            if (outMath === null || outMath === void 0 ? void 0 : outMath.include_chtml) {
                ...
                var node_1 = ((_b = (_a = options === null || options === void 0 ? void 0 : options.outMath) === null || _a === void 0 ? void 0 : _a.optionAscii) === null || _b === void 0 ? void 0 : _b.tableToTsv) || ((_d = (_c = options === null || options === void 0 ? void 0 : options.outMath) === null || _c === void 0 ? void 0 : _c.optionAscii) === null || _d === void 0 ? void 0 : _d.tableToCsv) || ((_f = (_e = options === null || options === void 0 ? void 0 : options.outMath) === null || _e === void 0 ? void 0 : _e.optionAscii) === null || _f === void 0 ? void 0 : _f.tableToMd)
                ...
                var outputJax_1 = MJ.mDocTeXCHTML.outputJax;
                return OuterData(MJ.adaptor, node_1, outputJax_1.math, outMath, forDocx, accessibility);
            }
            /** Here we use different package settings.
             * In order to flatten arrays in asccimath for TSV/CSV we add an extra attribute to the internal mml tree.
             * So for \begin{array} we add a name attribute that points to the environment */
            var node = ((_h = (_g = options === null || options === void 0 ? void 0 : options.outMath) === null || _g === void 0 ? void 0 : _g.optionAscii) === null || _h === void 0 ? void 0 : _h.tableToTsv) || ((_k = (_j = options === null || options === void 0 ? void 0 : options.outMath) === null || _j === void 0 ? void 0 : _j.optionAscii) === null || _k === void 0 ? void 0 : _k.tableToCsv) || ((_m = (_l = options === null || options === void 0 ? void 0 : options.outMath) === null || _l === void 0 ? void 0 : _l.optionAscii) === null || _m === void 0 ? void 0 : _m.tableToMd)
                ? MJ.docTeXTSV.convert(string, {
                    display: display,
                    em: em,
                    ex: ex,
