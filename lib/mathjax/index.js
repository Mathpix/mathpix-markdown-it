...
var OuterData = function (adaptor, node, math, outMath, forDocx, accessibility) {
    ...
    if (include_svg) {
        ...
        if (node) {
            if (node instanceof Element_js_1.LiteElement) {
                var svgElement = ((_a = node.children) === null || _a === void 0 ? void 0 : _a.length) ? node.children.find(function (item) { return item.kind === 'svg'; })
                    : null;
    ...
    res.labels = ((_d = (_c = math.inputJax.parseOptions) === null || _c === void 0 ? void 0 : _c.tags) === null || _d === void 0 ? void 0 : _d.labels) ? tslib_1.__assign({}, math.inputJax.parseOptions.tags.labels) : null;
    return res;
};
...
exports.OuterHTML = function (data, outMath) {
...
exports.MathJax = {
    ...
    Typeset: function (string, options, throwError) {
        ...
        return {
            html: exports.OuterHTML(data, options.outMath),
            labels: data.labels,
    ...
    TypesetSvgAndAscii: function (string, options) {
        ...
        return {
            html: exports.OuterHTML(data, outMath),
            ascii: data.asciimath,
            labels: data.labels,
            ascii_tsv: data === null || data === void 0 ? void 0 : data['asciimath_tsv'],
            ascii_csv: data === null || data === void 0 ? void 0 : data['asciimath_csv'],
    ...
    TypesetMathML: function (string, options) {
        ...
        return exports.OuterHTML(outerDataMathMl, options.outMath);
    },
    AsciiMathToSvg: function (string, options) {
        ...
        return exports.OuterHTML(outerDataAscii, options.outMath);
    },
    //
