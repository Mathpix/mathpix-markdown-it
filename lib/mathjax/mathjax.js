...
var MathJaxConfigure = /** @class */ (function () {
    function MathJaxConfigure() {
        ...
        this.resetValidateTex = function () { _this._validateTex = null; };
        this.setHandler = function (acssistiveMml, nonumbers) {
            ...
            _this._validateTex = null; // re-lazy: pick up the new mTex.mmlFactory next access
        };
    ...
    Object.defineProperty(MathJaxConfigure.prototype, "validateTex", {
        ...
        get: function () {
            if (!this._validateTex) {
                // @ts-ignore
                var fresh = new MTeX(Object.assign({}, texConfig, { tags: "none" }));
