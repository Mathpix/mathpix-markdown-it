...
require("./helpers/icon/IconConfiguration");
...
var patchVisitorTeXAtom = function (proto) {
    var orig = proto.visitTeXAtomNode;
    proto.visitTeXAtomNode = function (node, space) {
        var cmd = node.getProperty('data-custom-cmd');
        var unicode = cmd && (0, custom_cmd_map_1.getCustomCmdUnicode)(cmd);
        if (unicode) {
...
patchVisitorTeXAtom(assistive_mml_js_1.LimitedMmlVisitor.prototype);
patchVisitorTeXAtom(SerializedMmlVisitor_js_1.SerializedMmlVisitor.prototype);
...
var fix_unicode_1 = require("./fix-unicode");
Configuration_1.Configuration.create('fix-unicode', { fallback: { character: fix_unicode_1.Other } });
...
var origAutoTag = Tags_js_1.AbstractTags.prototype.autoTag;
Tags_js_1.AbstractTags.prototype.autoTag = function () {
    var hadTag = this.currentTag.tag != null;
...
var origGetTag = Tags_js_1.AbstractTags.prototype.getTag;
Tags_js_1.AbstractTags.prototype.getTag = function (force) {
    this['_isAutoTag'] = false;
    var labelKey = this.label || '';
    var node = origGetTag.call(this, force);
