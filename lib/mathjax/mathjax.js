...
exports.MathJaxConfigure = exports.asciimath = exports.chtml = exports.svg = exports.mml = void 0;
...
var chtml_js_1 = require("mathjax-full/js/output/chtml.js");
...
var chtmlConfig = Object.assign({}, mathJaxConfig_1.default.CHTML || {});
// @ts-ignore
...
exports.chtml = new chtml_js_1.CHTML(chtmlConfig);
...
var MathJaxConfigure = /** @class */ (function () {
    function MathJaxConfigure() {
        ...
        this.setHandler = function (acssistiveMml, nonumbers) {
            ...
            _this.docTeXCHTML = mathjax_js_1.mathjax.document(_this.domNode, {
                InputJax: _this.tex,
                OutputJax: exports.chtml,
            });
            ...
            _this.mDocTeXCHTML = mathjax_js_1.mathjax.document(_this.domNode, {
                InputJax: _this.mTex,
                OutputJax: exports.chtml,
            });
