...
var mtable = function () {
    return function (node, serialize) {
        ...
        try {
            ...
            var isNumberedEquation = node.childNodes.length === 1
                && node.childNodes[0].kind === 'mlabeledtr';
            var display = (_j = (_h = node.attributes) === null || _h === void 0 ? void 0 : _h.attributes) === null || _j === void 0 ? void 0 : _j.hasOwnProperty('displaystyle');
        ...
        try {
            ...
            for (var i = 0; i < node.childNodes.length; i++) {
                ...
                if (i > 0) {
                    ...
                    if (!isNotMatrix) {
                        isNotMatrix = Boolean(hasCommaBefore || (((_a = smd === null || smd === void 0 ? void 0 : smd.trim()) === null || _a === void 0 ? void 0 : _a.match(reOperations)) || (smdBefore === null || smdBefore === void 0 ? void 0 : smdBefore.match(reOperations))));
                    }
                    mtrContent += display || hasCommaBefore || (((_b = smd === null || smd === void 0 ? void 0 : smd.trim()) === null || _b === void 0 ? void 0 : _b.match(reOperations)) || (smdBefore === null || smdBefore === void 0 ? void 0 : smdBefore.match(reOperations)))
                        ? ''
                        : ', ';
                }
...
var mlabeledtr = function () {
    return function (node, serialize) {
        var mml = '';
        try {
            for (var i = 0; i < node.childNodes.length; i++) {
                var id = node.childNodes[i].attributes.get('id');
