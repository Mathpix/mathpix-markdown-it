...
var parseMmdElement = function (math_el, res) {
    ...
    if (!math_el)
        return res;
    if (((_a = math_el.tagName) === null || _a === void 0 ? void 0 : _a.toUpperCase()) === 'MOL' || ((_b = math_el.tagName) === null || _b === void 0 ? void 0 : _b.toUpperCase()) === 'SMILES' || ((_c = math_el.tagName) === null || _c === void 0 ? void 0 : _c.toUpperCase()) === 'SVG') {
        res.push({
