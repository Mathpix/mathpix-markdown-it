...
var parseMmdElement = function (math_el, res) {
    ...
    if (!math_el)
        return res;
    if (['SMILES', 'MOL', 'INCHI'].includes((_a = math_el.tagName) === null || _a === void 0 ? void 0 : _a.toUpperCase())) {
        res.push({
...
var parseMarkdownByElement = function (el, include_sub_math) {
    ...
    if (!el)
        return null;
    var querySelectorChem = 'pre > mol, svg > metadata > molecule > mol, svg > metadata > molecule > smiles, svg > metadata > molecule > inchi';
