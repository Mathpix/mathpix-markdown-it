...
var inlineDiagbox = function (state, silent) {
    try {
        ...
        if (isSW) {
            ...
            var styleTopLeft = ['grid-row-start: 1;', 'grid-column-start: 1;', 'text-align: left;'];
            ...
            var styleBottomRight = ['grid-row-start: 2;', 'grid-column-start: 2;', 'text-align: right;'];
            ...
            var styleTopRight = ['grid-row-start: 1;', 'grid-column-start: 2;', 'text-align: right;'];
            tokenRight.attrJoin('style', styleTopRight.join(' '));
            token.children.push(tokenRight);
            tokenLeft.attrJoin('class', "diagonal-cell-bottomLeft");
            var styleBottomLeft = ['grid-row-start: 2;', 'grid-column-start: 1;', 'text-align: left;'];
