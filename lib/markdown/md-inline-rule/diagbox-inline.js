...
var processContent = function (content) {
    try {
        ...
        var processedContent = parseMath || (0, common_1.getContent)(content, false, true);
...
var inlineDiagbox = function (state, silent) {
    try {
        ...
        var _a = tslib_1.__read((0, sub_cell_1.extractNextBraceContent)(str, match[0].length), 2), left = _a[0], newIndex = _a[1];
