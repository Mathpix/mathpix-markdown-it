...
var common_2 = require("../md-block-rule/begin-tabular/common");
...
var CODE_POSITIONS = Symbol('diagbox-code-positions');
...
var processContent = function (content) {
    try {
        ...
        var processedContent = parseMath || (0, common_2.getContent)(content, false, true);
...
var inlineDiagbox = function (state, silent) {
    try {
        ...
        var codeIndex = codeIndexOf(state);
        var _a = tslib_1.__read((0, sub_cell_1.extractNextBraceContent)(src, pos + match[0].length, codeIndex), 2), left = _a[0], newIndex = _a[1];
        var _b = tslib_1.__read((0, sub_cell_1.extractNextBraceContent)(src, newIndex, codeIndex), 2), right = _b[0], endIndex = _b[1];
        if (!silent) {
            var options = match[2] || '';
            var isSW = false;
            if (match[1] === 'slashbox') {
