...
var svgInlineRegex = /^<(svg)\b[^>]*>[\s\S]*<\/svg>/;
var preInlineRegex = /^<(pre)\b[^>]*>[\s\S]*<\/pre>/;
var codeInlineRegex = /^<(code)\b[^>]*>[\s\S]*<\/code>/;
var scriptInlineRegex = /^<(script)\b[^>]*>[\s\S]*<\/script>/;
var styleInlineRegex = /^<(style)\b[^>]*>[\s\S]*<\/style>/;
var textareaInlineRegex = /^<(textarea)\b[^>]*>[\s\S]*<\/textarea>/;
var optionInlineRegex = /^<(option)\b[^>]*>[\s\S]*<\/option>/;
