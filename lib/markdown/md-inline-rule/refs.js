...
var refInsideMathDelimiter = function (state, silent) {
    ...
    var reMathDelimiters = ((_c = (_b = (_a = state.md.options) === null || _a === void 0 ? void 0 : _a.renderOptions) === null || _b === void 0 ? void 0 : _b.disableRules) === null || _c === void 0 ? void 0 : _c.simpleMath)
        ? /^(?:\\\[|\[|\\\(|\()/
        : /^(?:\\\[|\[|\\\(|\(|\$\$|\$)/;
    var match = state.src
        .slice(startMathPos)
    ...
    if ((_d = contentAfter === null || contentAfter === void 0 ? void 0 : contentAfter.trim()) === null || _d === void 0 ? void 0 : _d.length) {
        return false;
    }
    if (!silent) {
