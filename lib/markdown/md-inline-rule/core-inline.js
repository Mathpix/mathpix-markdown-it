    ...
    for (var i = 0; i < tokens.length; i++) {
        ...
        if (token.type === 'inline'
            ...
            if (token.type === 'inline' && ((_e = token.children) === null || _e === void 0 ? void 0 : _e.length)) {
                var data = (0, textWidthByTokens_1.getTextWidthByTokens)(token.children, 'normal', widthEx, heightEx);
                if (data) {
                    token.widthEx = data.widthEx;
                    token.heightEx = data.heightEx;
                    (0, mdPluginText_1.setSizeCounter)(data.widthEx, data.heightEx);
                }
            }
            if (token.type === 'inline' && ((_f = token.children) === null || _f === void 0 ? void 0 : _f.length)) {
