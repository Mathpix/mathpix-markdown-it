...
var walkInlineInTokens = function (list, state, getCurrentTag, getRootEnvToInline, envStack, parentList) {
    ...
    var lastEnvToInline = null;
    var cachedMergedEnv = null;
    var cachedStateEnv = null;
    for (var i = 0; i < list.length; i++) {
        ...
        var tokEnv = tok === null || tok === void 0 ? void 0 : tok.envToInline;
        var nextStack = tokEnv ? tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(envStack), false), [tokEnv], false) : envStack;
        var mergedEnvToInline = tokEnv ? (tokEnv === lastEnvToInline ? cachedMergedEnv
            : Object.assign({}, baseEnv, tokEnv)) : baseEnv;
...
var coreInline = function (state) {
    ...
    for (var i = 0; i < tokens.length; i++) {
        ...
        if (token.type === 'inline'
            ...
            var inlineEnv = Object.assign({}, state.env, {
