 ...
 */
var applyLstListingOptionsToToken = function (token, // markdown-it Token (can be typed explicitly)
content, opts, state // markdown-it state (StateInline/StateBlock)
) {
    var _a, _b;
    if (!opts)
        return;
    var attributes = (_a = (0, parse_attribures_1.parseAttributes)(opts)) !== null && _a !== void 0 ? _a : {};
    var languageValue = typeof attributes.language === 'string' ? attributes.language : null;
