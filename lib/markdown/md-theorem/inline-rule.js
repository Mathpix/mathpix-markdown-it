...
exports.centeringLatex = exports.captionLatex = exports.labelLatex = exports.newCommandQedSymbol = exports.setCounterTheorem = exports.newTheorem = exports.theoremStyle = void 0;
...
exports.newTheorem = function (state) {
    ...
    if (state.src.charCodeAt(nextPos) === 123 /* { */) {
        data = common_1.findEndMarker(state.src, nextPos);
        if (!data || !data.res) {
        ...
        if (nextPos < max && state.src.charCodeAt(nextPos) === 0x5B /* [ */) {
            // \newtheorem{name}{print}[numbered]
            //                         ^^ get numbered
            dataNumbered = common_1.findEndMarker(state.src, nextPos, "[", "]");
    ...
    if (isNumbered) {
        helper_1.addEnvironmentsCounter({
            environment: envName,
            counter: 0
        });
    }
...
exports.setCounterTheorem = function (state) {
    var _a, _b;
    var startPos = state.pos;
    if (state.src.charCodeAt(startPos) !== 0x5c /* \ */) {
        return false;
    ...
    var res = helper_1.setCounterTheoremEnvironment(envName, num);
    if (!res) {
        return false;
    }
...
exports.labelLatex = function (state, md, env) {
    var _a;
    var startPos = state.pos;
    if (state.src.charCodeAt(startPos) !== 0x5c /* \ */) {
        return false;
    ...
    if (state.env.currentTag) {
        ...
        labels_1.addIntoLabelsList(label);
    }
    var latex = match[0];
    nextPos += match[0].length;
...
exports.captionLatex = function (state, md, env) {
    var _a;
...
exports.centeringLatex = function (state, md, env) {
    var _a;
