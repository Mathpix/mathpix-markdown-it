...
exports.BeginTheorem = function (state, startLine, endLine, silent) {
    ...
    var strBefore = "";
    var match = lineText.match(consts_1.openTagDescriptionIndices);
    if (!match) {
        match = lineText.match(consts_1.openTagIndices);
    }
    if (!match) {
        return false;
    }
    ...
    var namePositions = envName && ((_d = (_c = match.indices) === null || _c === void 0 ? void 0 : _c[1]) === null || _d === void 0 ? void 0 : _d.length) ? {
        startLine: startLine,
        endLine: startLine,
        bMarks: (_e = match.indices) === null || _e === void 0 ? void 0 : _e[1][0],
        eMarks: (_f = match.indices) === null || _f === void 0 ? void 0 : _f[1][1],
    } : null;
    var descriptiontPositions = envDescription && ((_h = (_g = match.indices) === null || _g === void 0 ? void 0 : _g[2]) === null || _h === void 0 ? void 0 : _h.length) ? {
        startLine: startLine,
        endLine: startLine,
        bMarks: (_j = match.indices) === null || _j === void 0 ? void 0 : _j[2][0],
        eMarks: (_k = match.indices) === null || _k === void 0 ? void 0 : _k[2][1],
    } : null;
    if (!envName) {
        return false;
    }
    ...
    helper_1.SetTokensBlockParse(state, resText, 0, 0, true, contentPositions);
