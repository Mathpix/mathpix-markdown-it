...
exports.newTheoremBlock = function (state, startLine) {
    ...
    for (var j = 0; j < children.length; j++) {
        ...
        if (((itemBefore === null || itemBefore === void 0 ? void 0 : itemBefore.type) === "newtheorem" || (itemBefore === null || itemBefore === void 0 ? void 0 : itemBefore.type) === "theoremstyle"
            || (itemBefore === null || itemBefore === void 0 ? void 0 : itemBefore.type) === "renewcommand_qedsymbol" || (itemBefore === null || itemBefore === void 0 ? void 0 : itemBefore.type) === "theorem_setcounter")
            && item.type === "softbreak") {
            itemBefore = item;
            if (state.md.options.forLatex) {
                token.children.push(item);
