...
var ListsInternal = function (state, startLine, endLine) {
    ...
    var processLine = function (lineText, lineIdx) {
        ...
        // Renders to nothing, so it joins without a break — that break survived as an orphan `<br>`.
        // Kept under forLatex: there the line is source to rebuild, not markup to render.
