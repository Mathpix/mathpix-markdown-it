...
var ENV_TRANSIENT_KEYS = env_transient_1.LIST_TRANSIENT_ENV_KEYS;
...
var Lists = function (state, startLine, endLine, silent) {
    ...
    var envSnap = {};
    try {
        for (var ENV_TRANSIENT_KEYS_1 = tslib_1.__values(ENV_TRANSIENT_KEYS), ENV_TRANSIENT_KEYS_1_1 = ENV_TRANSIENT_KEYS_1.next(); !ENV_TRANSIENT_KEYS_1_1.done; ENV_TRANSIENT_KEYS_1_1 = ENV_TRANSIENT_KEYS_1.next()) {
            var k = ENV_TRANSIENT_KEYS_1_1.value;
        ...
        try {
            if (ENV_TRANSIENT_KEYS_1_1 && !ENV_TRANSIENT_KEYS_1_1.done && (_a = ENV_TRANSIENT_KEYS_1.return)) _a.call(ENV_TRANSIENT_KEYS_1);
        }
    ...
    try {
        ...
        try {
            for (var ENV_TRANSIENT_KEYS_2 = tslib_1.__values(ENV_TRANSIENT_KEYS), ENV_TRANSIENT_KEYS_2_1 = ENV_TRANSIENT_KEYS_2.next(); !ENV_TRANSIENT_KEYS_2_1.done; ENV_TRANSIENT_KEYS_2_1 = ENV_TRANSIENT_KEYS_2.next()) {
                var k = ENV_TRANSIENT_KEYS_2_1.value;
                if (envHad[k]) {
            ...
            try {
                if (ENV_TRANSIENT_KEYS_2_1 && !ENV_TRANSIENT_KEYS_2_1.done && (_b = ENV_TRANSIENT_KEYS_2.return)) _b.call(ENV_TRANSIENT_KEYS_2);
            }
