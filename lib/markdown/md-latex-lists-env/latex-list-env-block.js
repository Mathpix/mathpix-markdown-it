...
var ListsInternal = function (state, startLine, endLine) {
    ...
    var openTokens = tokenStart ? [tokenStart] : [];
    // Summed indent of the current list's ancestors (an overflowing marker may hang into it).
    var sumAncestorP = function () {
        return openTokens.slice(0, -1).reduce(function (s, t) { var _a; return s + ((_a = t === null || t === void 0 ? void 0 : t.indentEm) !== null && _a !== void 0 ? _a : consts_1.LIST_DEFAULT_INDENT_EM); }, 0);
    };
    if (iOpen === 0) {
        nextLine += 1;
        state.line = nextLine;
    ...
    var processLine = function (lineText, lineIdx) {
        ...
        if (consts_1.END_LIST_ENV_INLINE_RE.test(lineText)) {
            ...
            if (endMatch) {
                ...
                var _g = (0, latex_list_items_1.splitInlineListEnv)(lineText, endMatch), sB = _g.sB, sE = _g.sE, isBacktickEscapedPair = _g.isBacktickEscapedPair;
                ...
                (_a = (0, latex_list_items_1.finalizeListItems)(state, items, itemizeLevelTokens, enumerateLevelTypes, li, iOpen, itemizeLevelContents, (_e = openTokens[openTokens.length - 1]) !== null && _e !== void 0 ? _e : null, sumAncestorP()), iOpen = _a.iOpen, items = _a.items, li = _a.li);
        ...
        if (consts_1.BEGIN_LIST_ENV_INLINE_RE.test(lineText)) {
            ...
            if (beginMatch) {
                ...
                var beginType = raw;
                var _h = (0, latex_list_items_1.splitInlineListEnv)(lineText, beginMatch), sB = _h.sB, sE = _h.sE, isBacktickEscapedPair = _h.isBacktickEscapedPair;
                if (isBacktickEscapedPair) {
                    items = (0, latex_list_items_1.ItemsListPush)(items, lineText, lineIdx, lineIdx);
                    return 'proceed';
                }
                ...
                (_b = (0, latex_list_items_1.finalizeListItems)(state, items, itemizeLevelTokens, enumerateLevelTypes, li, iOpen, itemizeLevelContents, (_f = openTokens[openTokens.length - 1]) !== null && _f !== void 0 ? _f : null, sumAncestorP()), iOpen = _b.iOpen, items = _b.items, li = _b.li);
...
var Lists = function (state, startLine, endLine, silent) {
    ...
    var envSnap = {};
    try {
        for (var LIST_TRANSIENT_ENV_KEYS_1 = tslib_1.__values(env_transient_1.LIST_TRANSIENT_ENV_KEYS), LIST_TRANSIENT_ENV_KEYS_1_1 = LIST_TRANSIENT_ENV_KEYS_1.next(); !LIST_TRANSIENT_ENV_KEYS_1_1.done; LIST_TRANSIENT_ENV_KEYS_1_1 = LIST_TRANSIENT_ENV_KEYS_1.next()) {
            var k = LIST_TRANSIENT_ENV_KEYS_1_1.value;
            envHad[k] = k in state.env;
            envSnap[k] = state.env[k];
        }
    }
    ...
    try {
        ...
        try {
            for (var LIST_TRANSIENT_ENV_KEYS_2 = tslib_1.__values(env_transient_1.LIST_TRANSIENT_ENV_KEYS), LIST_TRANSIENT_ENV_KEYS_2_1 = LIST_TRANSIENT_ENV_KEYS_2.next(); !LIST_TRANSIENT_ENV_KEYS_2_1.done; LIST_TRANSIENT_ENV_KEYS_2_1 = LIST_TRANSIENT_ENV_KEYS_2.next()) {
                var k = LIST_TRANSIENT_ENV_KEYS_2_1.value;
                if (envHad[k]) {
                    state.env[k] = envSnap[k];
                }
                else {
                    delete state.env[k];
                }
            ...
            try {
                if (LIST_TRANSIENT_ENV_KEYS_2_1 && !LIST_TRANSIENT_ENV_KEYS_2_1.done && (_b = LIST_TRANSIENT_ENV_KEYS_2.return)) _b.call(LIST_TRANSIENT_ENV_KEYS_2);
            }
