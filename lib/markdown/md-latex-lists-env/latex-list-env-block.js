...
var ListsInternal = function (state, startLine, endLine) {
    ...
    var processLine = function (lineText, lineIdx) {
        ...
        if (RENEWCOMMAND_LINE_RE.test(lineText)) {
            items = (0, latex_list_items_1.ItemsAddToPrev)(items, lineText, lineIdx, false);
            return 'proceed';
        }
        ...
        while (env) {
            ...
            var _e = (0, latex_list_items_1.splitInlineListEnv)(tail, envMatch), sB = _e.sB, sE = _e.sE, isBacktickEscapedPair = _e.isBacktickEscapedPair;
