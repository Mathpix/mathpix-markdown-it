...
var Lists = function (state, startLine, endLine, silent) {
    ...
    var probeKey = silent
        ? "".concat(startLine, ":").concat(endLine, ":").concat(state.parentType, ":").concat(state.prentLevel, ":").concat((_a = state.env) === null || _a === void 0 ? void 0 : _a.inheritedListType)
        : '';
    if (silent) {
    ...
    var captionEnvSnap = (0, env_transient_1.snapshotEnvKeys)(state.env, env_transient_1.LIST_SPECULATIVE_CAPTION_ENV_KEYS);
    var committed = false;
    try {
        ...
        if (!committed) {
            ...
            (0, env_transient_1.restoreEnvKeys)(state.env, env_transient_1.LIST_SPECULATIVE_CAPTION_ENV_KEYS, captionEnvSnap.had, captionEnvSnap.snap);
        }
    }
};
exports.Lists = Lists;
