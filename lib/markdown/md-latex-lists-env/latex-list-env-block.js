...
var ListsInternal = function (state, startLine, endLine) {
    ...
    var allListTokens = tokenStart ? [tokenStart] : [];
    if (iOpen === 0) {
        nextLine += 1;
        state.line = nextLine;
    ...
    var processLine = function (lineText, lineIdx) {
        ...
        if (consts_1.END_LIST_ENV_INLINE_RE.test(lineText)) {
            ...
            if (endMatch) {
                ...
                (_a = (0, latex_list_items_1.finalizeListItems)(state, items, itemizeLevelTokens, enumerateLevelTypes, li, iOpen, itemizeLevelContents, (_e = openTokens[openTokens.length - 1]) !== null && _e !== void 0 ? _e : null), iOpen = _a.iOpen, items = _a.items, li = _a.li);
        ...
        if (consts_1.BEGIN_LIST_ENV_INLINE_RE.test(lineText)) {
            ...
            if (beginMatch) {
                ...
                (_b = (0, latex_list_items_1.finalizeListItems)(state, items, itemizeLevelTokens, enumerateLevelTypes, li, iOpen, itemizeLevelContents, (_f = openTokens[openTokens.length - 1]) !== null && _f !== void 0 ? _f : null), iOpen = _b.iOpen, items = _b.items, li = _b.li);
