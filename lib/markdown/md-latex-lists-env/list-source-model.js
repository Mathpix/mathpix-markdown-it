...
exports.firstUsableCloser = exports.nextListEnvMatch = exports.hasCloserAhead = exports.closersLeftAfter = exports.absoluteOffsetOf = exports.wrapperBeginAt = exports.pairArgumentSpans = exports.lastListEndPos = exports.listCloserOffsets = exports.unclosedEnvsIn = exports.maskNonStructure = exports.splitInlineListEnv = void 0;
...
var structuralSuffix = function (state, all, key) {
    var cached = (0, src_pos_cache_1.srcValueCached)(state, key, function () { return buildStructuralSuffix(state, all); });
    if (cached.all === all) {
    ...
    (0, warn_distinct_1.warnDistinct)('suffix-key-mismatch', '[list] structural suffix asked with a key from another array', { size: all.length });
