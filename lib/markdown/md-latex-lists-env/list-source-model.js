...
exports.firstUsableCloser = exports.nextListEnvMatch = exports.hasCloserAhead = exports.structuralCountIn = exports.absoluteOffsetOf = exports.wrapperBeginAt = exports.pairArgumentSpans = exports.lastListEndPos = exports.listCloserOffsets = exports.CLOSER_SUFFIX_KEY = exports.unclosedEnvsIn = void 0;
...
exports.CLOSER_SUFFIX_KEY = Symbol('mmd.closerSuffix');
...
var closesOurListWithin = function (state, from, to) {
    ...
    for (var step = 0; step < closersAhead + openersAhead; step++) {
        ...
        if ((0, verbatim_ranges_1.isInsideRanges)(spans, at)) {
...
var structuralCountIn = function (state, all, key, from, to) {
    ...
    var endAt = to === Infinity ? all.length : all.length - (0, src_pos_cache_1.countPositionsAtOrAfter)(all, to);
    return suffix[startAt] - suffix[endAt];
};
exports.structuralCountIn = structuralCountIn;
...
var closersLeftAfter = function (state, at) {
    return (0, exports.structuralCountIn)(state, (0, exports.listCloserOffsets)(state), exports.CLOSER_SUFFIX_KEY, at, Infinity)
        - (0, exports.structuralCountIn)(state, listOpenerOffsets(state), OPENER_SUFFIX_KEY, at, Infinity);
};
...
var hasCloserAhead = function (state, from, name) {
    ...
    for (var i = offsets.length - (0, src_pos_cache_1.countPositionsAtOrAfter)(offsets, from); i < offsets.length; i++) {
        ...
        if (closesOurListWithin(state, from, at)) {
            var opensInside = (0, exports.structuralCountIn)(state, listOpenerOffsets(state), OPENER_SUFFIX_KEY, from, at);
