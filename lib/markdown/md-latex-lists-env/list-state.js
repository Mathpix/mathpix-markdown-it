...
var LIST_INLINE_SRC = Symbol('mmd.listInlineSrc');
var setListInlineSrc = function (env, src) {
    var _a;
    var previous = (_a = env[LIST_INLINE_SRC]) !== null && _a !== void 0 ? _a : null;
    env[LIST_INLINE_SRC] = src;
    return previous;
};
exports.setListInlineSrc = setListInlineSrc;
...
var isListOwnParse = function (state) { var _a; return ((_a = state.env) === null || _a === void 0 ? void 0 : _a[LIST_INLINE_SRC]) === state.src; };
exports.isListOwnParse = isListOwnParse;
