...
var markerPaddingStyle = function (padAttr) {
    ...
    if (parseFloat(padAttr) > consts_1.LIST_MAX_INDENT_EM) {
        return "padding-inline-start: ".concat(consts_1.LIST_MAX_INDENT_EM, "em; ");
    }
...
var hostFlag = function (tokens, idx) {
    ...
    if (!cached || cached.epoch !== parseEpoch || cached.sig !== sig || idx <= cached.lastIdx) {
        cached = { epoch: parseEpoch, sig: sig, flags: (0, latex_list_tokens_1.listHostFlags)(tokens), lastIdx: idx };
