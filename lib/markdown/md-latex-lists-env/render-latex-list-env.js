...
var renderLatexListItemCore = function (tokens, index, options, env, slf, sContent, mode) {
    ...
    if (isEnumerate) {
        ...
        token.meta = tslib_1.__assign(tslib_1.__assign({}, ((_a = token.meta) !== null && _a !== void 0 ? _a : {})), { enumerateLevel: level_enumerate });
        ...
        var className_2 = ((_b = token.meta) === null || _b === void 0 ? void 0 : _b.isBlock)
            ? 'li_enumerate block'
            : 'li_enumerate';
        if (options === null || options === void 0 ? void 0 : options.lineNumbering) {
    ...
    token.meta = tslib_1.__assign(tslib_1.__assign({}, ((_c = token.meta) !== null && _c !== void 0 ? _c : {})), { itemizeLevel: level_itemize });
    htmlMarker = itemizeInfo.htmlMarker;
    dataAttr += itemizeInfo.dataAttr || "";
    var className = ((_d = token.meta) === null || _d === void 0 ? void 0 : _d.isBlock)
        ? 'li_itemize block'
        : 'li_itemize';
    if (options === null || options === void 0 ? void 0 : options.lineNumbering) {
