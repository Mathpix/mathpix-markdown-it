...
var styleAttr = function (style) { return style ? " style=\"".concat(style, "\"") : ''; };
var level_itemize = 0;
...
var render_itemize_list_open = function (tokens, idx, options, env, slf) {
    ...
    var style = level_itemize > 1
        ? "".concat((0, render_helpers_1.canvasListRootStyle)(options, '', true), "list-style-type: none")
        : "".concat((0, render_helpers_1.canvasListRootStyle)(options, paddingInlineStyle, false), "list-style-type: none");
...
var render_enumerate_list_open = function (tokens, idx, options, env, slf) {
    ...
    var style = level_enumerate > 1
        ? "".concat((0, render_helpers_1.canvasListRootStyle)(options, '', true), "list-style-type: ").concat(currentStyle)
        : "".concat((0, render_helpers_1.canvasListRootStyle)(options, paddingInlineStyle, false), "list-style-type: ").concat(currentStyle);
...
var renderLatexListItemCore = function (tokens, index, options, env, slf, sContent, mode) {
    ...
    if (isEnumerate) {
        ...
        if (hasCustomMarker) {
            ...
            var canvasStyles_1 = (0, render_helpers_1.canvasListStyles)(options);
            /** The Canvas style sets its own `display`, so keeping `display: block` would be dead. */
            var liStyle = canvasStyles_1.itemCustom || 'display: block';
            var prefix_1 = "<li".concat(slf.renderAttrs(token)).concat(dataAttr, " style=\"").concat(liStyle, "\">") +
                ((0, render_helpers_1.skipEmptyMarker)(options, dataAttr)
                    ? ''
                    : "<span class=\"li_level\"".concat(dataAttr).concat(styleAttr(canvasStyles_1.marker), ">").concat(htmlMarker, "</span>"));
            if (isOpen) {
                return prefix_1;
            }
    ...
    var canvasStyles = (0, render_helpers_1.canvasListStyles)(options);
    var prefix = "<li".concat(slf.renderAttrs(token)).concat(dataAttr).concat(styleAttr(canvasStyles.item), ">") +
        ((0, render_helpers_1.skipEmptyMarker)(options, dataAttr)
            ? ''
            : "<span class=\"li_level\"".concat(dataAttr).concat(styleAttr(canvasStyles.marker), ">").concat(htmlMarker, "</span>"));
    if (isOpen) {
        if (needsPptxLeadingSpace()) {
