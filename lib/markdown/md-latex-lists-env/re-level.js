...
var parseMarkerTokens = function (state, level, cacheable) {
    var _a;
    var env = cacheable ? state.env : null;
    var bucket = env
        ? ((_a = env[MARKER_TOKENS_ENV_KEY]) !== null && _a !== void 0 ? _a : (env[MARKER_TOKENS_ENV_KEY] = new Map()))
        : null;
    ...
    bucket === null || bucket === void 0 ? void 0 : bucket.set(level, children);
    return children;
};
/**
