...
var resolveListPadding = function (listTokens) {
    ...
    try {
        for (var listTokens_2 = tslib_1.__values(listTokens), listTokens_2_1 = listTokens_2.next(); !listTokens_2_1.done; listTokens_2_1 = listTokens_2.next()) {
            ...
            if ((token.padding || 0) > consts_1.LIST_MAX_INDENT_EM) {
                // Clamped: this level gets the clamp itself, the levels under it the default, so a marker may overlap.
                (0, warn_distinct_1.warnDistinct)('padding-clamped:' + depth, '[list] marker indent hit the ' + consts_1.LIST_MAX_INDENT_EM + 'em clamp; markers may overlap their text', { depth: depth });
            }
