...
exports.splitInlineListEnv = exports.resolveListPadding = exports.finalizeListItems = exports.ItemsAddToPrev = exports.ItemsListPush = exports.ListItems = exports.ListItemsBlock = void 0;
...
var resolveListPadding = function (listTokens) {
    ...
    try {
        for (var listTokens_1 = tslib_1.__values(listTokens), listTokens_1_1 = listTokens_1.next(); !listTokens_1_1.done; listTokens_1_1 = listTokens_1.next()) {
            ...
            for (var i = indentByDepth.length; i < depth; i++) {
                indentByDepth[i] = consts_1.LIST_DEFAULT_INDENT_EM;
            }
            var ancestorSum = indentByDepth.slice(0, depth).reduce(function (s, v) { return s + v; }, 0);
            var total = Math.min(token.padding || 0, consts_1.LIST_MAX_INDENT_EM);
            var em = Math.round((total - ancestorSum) * 100) / 100;
            if (em > consts_1.LIST_DEFAULT_INDENT_EM) {
                token.indentEm = em;
                token.attrSet("data-padding-inline-start", String(em) + "em");
            }
            else {
                token.indentEm = consts_1.LIST_DEFAULT_INDENT_EM;
            }
