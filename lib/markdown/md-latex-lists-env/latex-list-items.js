...
exports.resolveListPadding = exports.finalizeListItems = exports.ItemsAddToPrev = exports.ItemsListPush = exports.ListItems = void 0;
...
var ListItems = function (state, items, itemizeLevelTokens, enumerateLevelTypes, li, iOpen, itemizeLevelContents, openTokens, allListTokens) {
    ...
    try {
        for (var items_1 = tslib_1.__values(items), items_1_1 = items_1.next(); !items_1_1.done; items_1_1 = items_1.next()) {
            ...
            var inlineChildren = [];
            var chunkFrom = state.tokens.length;
            var chunk = listItem.content.trim();
            var outerSrc = (0, list_state_1.setListInlineSrc)(state.env, chunk);
            try {
            ...
            (0, latex_list_tokens_1.wrapListLevelRuns)(state, chunkFrom);
            if (looseFrom >= 0) {
                (0, latex_list_tokens_1.wrapLooseRun)(state, looseFrom);
            }
...
var ItemsAddToPrev = function (items, lineText, nextLine, keepLineBreak) {
    ...
    if (!consts_1.ONLY_LIST_CLOSERS_RE.test((0, list_source_model_1.maskNonStructure)(lineText))) {
...
var resolveListPadding = function (listTokens) {
    ...
    var prefix = [0];
    try {
        for (var listTokens_2 = tslib_1.__values(listTokens), listTokens_2_1 = listTokens_2.next(); !listTokens_2_1.done; listTokens_2_1 = listTokens_2.next()) {
            var token = listTokens_2_1.value;
        ...
        try {
            if (listTokens_2_1 && !listTokens_2_1.done && (_b = listTokens_2.return)) _b.call(listTokens_2);
        }
