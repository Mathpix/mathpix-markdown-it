...
var flushTokensToInline = function (inlineState, tokens, baseOffset) {
    ...
    try {
        for (var tokens_1 = tslib_1.__values(tokens), tokens_1_1 = tokens_1.next(); !tokens_1_1.done; tokens_1_1 = tokens_1.next()) {
            ...
            var tok = inlineState.push(srcToken.type, srcToken.tag, srcToken.nesting);
            // Copy fields safely
            (0, exports.safeAssignToken)(tok, srcToken);
            // Fix positions
            (0, exports.shiftTokenAbsolutePositions)(tok, baseOffset);
        }
    }
