...
exports.safeAssignToken = exports.flushBufferedTokens = exports.flushTokensToInline = exports.parseListEnvRawToTokens = exports.createBufferedState = exports.buildBlockStateFromRaw = exports.shiftTokenAbsolutePositions = exports.warnListRuleFailed = exports.resetListRuleFailures = exports.listRuleFailureCount = void 0;
...
var ruleFailures = 0;
var listRuleFailureCount = function () { return ruleFailures; };
exports.listRuleFailureCount = listRuleFailureCount;
var resetListRuleFailures = function () {
    ruleFailures = 0;
};
exports.resetListRuleFailures = resetListRuleFailures;
...
var createBufferedState = function (state) {
    ...
    if (Array.isArray(state.types)) {
        tempState.types = state.types.slice();
    }
