            ...
            md.renderer.rules[key] = function (tokens, idx, options, env, slf) {
                switch (tokens[idx].type) {
                    ...
                    case "textit_close":
                        return '</em>';
                    case "underline":
                        return underline_2.renderUnderlineText(tokens, idx, options, env, slf);
                    case "underline_open":
                        return underline_2.renderUnderlineOpen(tokens, idx, options, env, slf);
                    case "underline_close":
                        return underline_2.renderUnderlineClose(tokens, idx, options, env, slf);
                    case "out":
                        return underline_2.renderOutText(tokens, idx, options, env, slf);
                    case "out_open":
                        return underline_2.renderOutOpen(tokens, idx, options, env, slf);
                    case "out_close":
                        return '</span>';
                    case "texttt":
