...
var pageBreaksBlock = function (state, startLine) {
    ...
    if (state.md.options.showHiddenTags || (strAfterEnd === null || strAfterEnd === void 0 ? void 0 : strAfterEnd.trim())) {
        token = state.push('paragraph_open', 'div', 1);
        token.map = [startLine, nextLine];
    }
...
var renderPageBreaks = function (tokens, idx, options, env, slf) {
    if (env === void 0) { env = {}; }
    if (options === null || options === void 0 ? void 0 : options.showHiddenTags) {
