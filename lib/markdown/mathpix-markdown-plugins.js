...
var mathpixMarkdownPlugin = function (md, options) {
    var _a;
    var _b = options.width, width = _b === void 0 ? 1200 : _b, _c = options.outMath, outMath = _c === void 0 ? {} : _c, _d = options.smiles, smiles = _d === void 0 ? {} : _d, _e = options.mathJax, mathJax = _e === void 0 ? {} : _e, _f = options.renderElement, renderElement = _f === void 0 ? {} : _f, _g = options.forDocx, forDocx = _g === void 0 ? false : _g, _h = options.forLatex, forLatex = _h === void 0 ? false : _h, _j = options.forMD, forMD = _j === void 0 ? false : _j, _k = options.forPptx, forPptx = _k === void 0 ? false : _k, _l = options.maxWidth, maxWidth = _l === void 0 ? '' : _l, _m = options.maxNesting, maxNesting = _m === void 0 ? 100 : _m, _o = options.enableFileLinks, enableFileLinks = _o === void 0 ? false : _o, _p = options.validateLink, validateLink = _p === void 0 ? null : _p, _q = options.toc, toc = _q === void 0 ? {} : _q, _r = options.accessibility, accessibility = _r === void 0 ? null : _r, _s = options.nonumbers, nonumbers = _s === void 0 ? false : _s, _t = options.showPageBreaks, showPageBreaks = _t === void 0 ? false : _t, _u = options.centerImages, centerImages = _u === void 0 ? true : _u, _v = options.centerTables, centerTables = _v === void 0 ? true : _v, _w = options.enableCodeBlockRuleForLatexCommands, enableCodeBlockRuleForLatexCommands = _w === void 0 ? false : _w, _x = options.addPositionsToTokens, addPositionsToTokens = _x === void 0 ? false : _x, _y = options.highlights, highlights = _y === void 0 ? [] : _y, _z = options.parserErrors, parserErrors = _z === void 0 ? mathpix_markdown_model_1.ParserErrors.show : _z, _0 = options.codeHighlight, codeHighlight = _0 === void 0 ? {} : _0, _1 = options.footnotes, footnotes = _1 === void 0 ? {} : _1, _2 = options.copyToClipboard, copyToClipboard = _2 === void 0 ? false : _2, _3 = options.renderOptions, renderOptions = _3 === void 0 ? null : _3, _4 = options.previewUuid, previewUuid = _4 === void 0 ? "" : _4, _5 = options.enableSizeCalculation, enableSizeCalculation = _5 === void 0 ? false : _5;
    ...
    md
        ...
        .use(mdPluginConfigured_1.mdPluginLatexCodeEnvs)
...
var setBaseOptionsMd = function (baseOption, mmdOptions) {
    var _a = mmdOptions.htmlTags, htmlTags = _a === void 0 ? false : _a, _b = mmdOptions.xhtmlOut, xhtmlOut = _b === void 0 ? false : _b, _c = mmdOptions.breaks, breaks = _c === void 0 ? true : _c, _d = mmdOptions.typographer, typographer = _d === void 0 ? true : _d, _e = mmdOptions.linkify, linkify = _e === void 0 ? true : _e, _f = mmdOptions.openLinkInNewWindow, openLinkInNewWindow = _f === void 0 ? true : _f, _g = mmdOptions.maxNesting, maxNesting = _g === void 0 ? 100 : _g;
