...
exports.setBaseOptionsMd = function (baseOption, mmdOptions) {
    var _a = mmdOptions.htmlTags, htmlTags = _a === void 0 ? false : _a, _b = mmdOptions.xhtmlOut, xhtmlOut = _b === void 0 ? false : _b, _c = mmdOptions.breaks, breaks = _c === void 0 ? true : _c, _d = mmdOptions.typographer, typographer = _d === void 0 ? true : _d, _e = mmdOptions.linkify, linkify = _e === void 0 ? true : _e;
...
exports.initMathpixMarkdown = function (md, callback) {
    ...
    renderer.render = function (tokens, options, env) {
        ...
        if (html.indexOf('clickable-link') !== -1) {
            html = mathpix_markdown_model_1.MathpixMarkdownModel.checkEquationNumber(html);
        }
