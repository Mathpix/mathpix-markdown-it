...
exports.mathpixMarkdownPlugin = function (md, options) {
    var _a = options.width, width = _a === void 0 ? 1200 : _a, _b = options.outMath, outMath = _b === void 0 ? {} : _b, _c = options.smiles, smiles = _c === void 0 ? {} : _c, _d = options.mathJax, mathJax = _d === void 0 ? {} : _d, _e = options.renderElement, renderElement = _e === void 0 ? {} : _e, _f = options.forDocx, forDocx = _f === void 0 ? false : _f, _g = options.forLatex, forLatex = _g === void 0 ? false : _g, _h = options.maxWidth, maxWidth = _h === void 0 ? '' : _h, _j = options.enableFileLinks, enableFileLinks = _j === void 0 ? false : _j, _k = options.validateLink, validateLink = _k === void 0 ? null : _k, _l = options.toc, toc = _l === void 0 ? {} : _l, _m = options.accessibility, accessibility = _m === void 0 ? null : _m, _o = options.nonumbers, nonumbers = _o === void 0 ? false : _o, _p = options.showPageBreaks, showPageBreaks = _p === void 0 ? false : _p, _q = options.centerImages, centerImages = _q === void 0 ? true : _q, _r = options.centerTables, centerTables = _r === void 0 ? true : _r, _s = options.enableCodeBlockRuleForLatexCommands, enableCodeBlockRuleForLatexCommands = _s === void 0 ? false : _s, _t = options.addPositionsToTokens, addPositionsToTokens = _t === void 0 ? false : _t;
    ...
    if (addPositionsToTokens) {
        md.block.parse = function (src, md, env, outTokens) {
            ...
            if (!env.lines) {
                ...
                env.lines = {
                    bMarks: tslib_1.__spread(state.bMarks),
                    eMarks: tslib_1.__spread(state.eMarks),
                    line: tslib_1.__spread(state.line),
                    lineMax: tslib_1.__spread(state.lineMax),
                    sCount: tslib_1.__spread(state.sCount),
                    tShift: tslib_1.__spread(state.tShift),
                };
            }
    ...
    rules_1.injectLabelIdToParagraph(md);
};
