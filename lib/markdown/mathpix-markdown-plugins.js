...
var render_latex_list_env_1 = require("./md-latex-lists-env/render-latex-list-env");
...
var coreRuleExists = function (ruler, name) {
    return typeof (ruler === null || ruler === void 0 ? void 0 : ruler.__find__) === 'function' && ruler.__find__(name) >= 0;
};
var mathpixMarkdownPlugin = function (md, options) {
    var _a;
    var _b = options.width, width = _b === void 0 ? 1200 : _b, _c = options.outMath, outMath = _c === void 0 ? {} : _c, _d = options.smiles, smiles = _d === void 0 ? {} : _d, _e = options.mathJax, mathJax = _e === void 0 ? {} : _e, _f = options.renderElement, renderElement = _f === void 0 ? {} : _f, _g = options.forDocx, forDocx = _g === void 0 ? false : _g, _h = options.forLatex, forLatex = _h === void 0 ? false : _h, _j = options.forMD, forMD = _j === void 0 ? false : _j, _k = options.forPptx, forPptx = _k === void 0 ? false : _k, _l = options.maxWidth, maxWidth = _l === void 0 ? '' : _l, _m = options.enableFileLinks, enableFileLinks = _m === void 0 ? false : _m, _o = options.validateLink, validateLink = _o === void 0 ? null : _o, _p = options.toc, toc = _p === void 0 ? {} : _p, _q = options.accessibility, accessibility = _q === void 0 ? null : _q, _r = options.nonumbers, nonumbers = _r === void 0 ? false : _r, _s = options.showPageBreaks, showPageBreaks = _s === void 0 ? false : _s, _t = options.centerImages, centerImages = _t === void 0 ? true : _t, _u = options.centerTables, centerTables = _u === void 0 ? true : _u, _v = options.defaultCellVerticalAlign, defaultCellVerticalAlign = _v === void 0 ? undefined : _v, _w = options.mathDelimiterMode, mathDelimiterMode = _w === void 0 ? 'strict' : _w, _x = options.enableCodeBlockRuleForLatexCommands, enableCodeBlockRuleForLatexCommands = _x === void 0 ? false : _x, _y = options.addPositionsToTokens, addPositionsToTokens = _y === void 0 ? false : _y, _z = options.highlights, highlights = _z === void 0 ? [] : _z, _0 = options.parserErrors, parserErrors = _0 === void 0 ? mathpix_markdown_model_1.ParserErrors.show : _0, _1 = options.codeHighlight, codeHighlight = _1 === void 0 ? {} : _1, _2 = options.footnotes, footnotes = _2 === void 0 ? {} : _2, _3 = options.copyToClipboard, copyToClipboard = _3 === void 0 ? false : _3, _4 = options.renderOptions, renderOptions = _4 === void 0 ? null : _4, _5 = options.previewUuid, previewUuid = _5 === void 0 ? "" : _5, _6 = options.enableSizeCalculation, enableSizeCalculation = _6 === void 0 ? false : _6;
    ...
    var resetHook = function (state) {
        ...
        (0, render_latex_list_env_1.resetListRenderDepth)();
        (0, env_transient_1.resetEnvSnapshotPool)();
        (0, src_pos_cache_1.clearSrcPosCaches)(state.env);
        (0, re_level_1.clearMarkerTokens)(state.env);
    ...
    var releaseHook = function (state) {
        (0, src_pos_cache_1.clearSrcPosCaches)(state.env);
        (0, re_level_1.clearMarkerTokens)(state.env);
    };
