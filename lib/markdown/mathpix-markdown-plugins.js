...
exports.mathpixMarkdownPlugin = function (md, options) {
    var _a = options.width, width = _a === void 0 ? 1200 : _a, _b = options.outMath, outMath = _b === void 0 ? {} : _b, _c = options.smiles, smiles = _c === void 0 ? {} : _c, _d = options.mathJax, mathJax = _d === void 0 ? {} : _d, _e = options.renderElement, renderElement = _e === void 0 ? {} : _e, _f = options.forDocx, forDocx = _f === void 0 ? false : _f;
