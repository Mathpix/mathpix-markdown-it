...
var reset_mmd_state_1 = require("./common/reset-mmd-state");
...
var mathpixMarkdownPlugin = function (md, options) {
    var _a;
    var _b = options.width, width = _b === void 0 ? 1200 : _b, _c = options.outMath, outMath = _c === void 0 ? {} : _c, _d = options.smiles, smiles = _d === void 0 ? {} : _d, _e = options.mathJax, mathJax = _e === void 0 ? {} : _e, _f = options.renderElement, renderElement = _f === void 0 ? {} : _f, _g = options.forDocx, forDocx = _g === void 0 ? false : _g, _h = options.forLatex, forLatex = _h === void 0 ? false : _h, _j = options.forMD, forMD = _j === void 0 ? false : _j, _k = options.forPptx, forPptx = _k === void 0 ? false : _k, _l = options.forCanvas, forCanvas = _l === void 0 ? false : _l, _m = options.maxWidth, maxWidth = _m === void 0 ? '' : _m, _o = options.enableFileLinks, enableFileLinks = _o === void 0 ? false : _o, _p = options.validateLink, validateLink = _p === void 0 ? null : _p, _q = options.toc, toc = _q === void 0 ? {} : _q, _r = options.accessibility, accessibility = _r === void 0 ? null : _r, _s = options.nonumbers, nonumbers = _s === void 0 ? false : _s, _t = options.showPageBreaks, showPageBreaks = _t === void 0 ? false : _t, _u = options.centerImages, centerImages = _u === void 0 ? true : _u, _v = options.centerTables, centerTables = _v === void 0 ? true : _v, _w = options.defaultCellVerticalAlign, defaultCellVerticalAlign = _w === void 0 ? undefined : _w, _x = options.mathDelimiterMode, mathDelimiterMode = _x === void 0 ? 'strict' : _x, _y = options.enableCodeBlockRuleForLatexCommands, enableCodeBlockRuleForLatexCommands = _y === void 0 ? false : _y, _z = options.addPositionsToTokens, addPositionsToTokens = _z === void 0 ? false : _z, _0 = options.highlights, highlights = _0 === void 0 ? [] : _0, _1 = options.parserErrors, parserErrors = _1 === void 0 ? mathpix_markdown_model_1.ParserErrors.show : _1, _2 = options.codeHighlight, codeHighlight = _2 === void 0 ? {} : _2, _3 = options.footnotes, footnotes = _3 === void 0 ? {} : _3, _4 = options.copyToClipboard, copyToClipboard = _4 === void 0 ? false : _4, _5 = options.renderOptions, renderOptions = _5 === void 0 ? null : _5, _6 = options.previewUuid, previewUuid = _6 === void 0 ? "" : _6, _7 = options.enableSizeCalculation, enableSizeCalculation = _7 === void 0 ? false : _7;
    ...
    var resetHook = function (state) {
        var isPartial = state.md.options.renderElement
            && Object.prototype.hasOwnProperty.call(state.md.options.renderElement, 'startLine');
        if (isPartial) {
            return;
        }
        (0, reset_mmd_state_1.resetMmdGlobalState)();
    };
    var hasGlobalHook = typeof md.core.ruler.__find__ === 'function'
