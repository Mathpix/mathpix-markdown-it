...
var renderAsciiMath = function (tokens, idx, options) {
    ...
    try {
        ...
        (0, utils_2.formatMathJaxError)(e, math, 'renderAsciiMath');
        ...
        if (token.type === 'display_mathML' || token.type === 'inline_mathML') {
            mathEquation = "<span class=\"math-error\">".concat(math, "</span>");
        }
        else {
            mathEquation = math;
            return "<p class=\"math-error\">".concat(mathEquation, "</p>");
        }
    }
    return "<span class=\"math-inline ascii\">".concat(mathEquation, "</span>");
};
