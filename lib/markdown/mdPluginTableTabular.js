...
var tabular_td_1 = require("./md-block-rule/begin-tabular/tabular-td");
var clearTabularState = function () {
    (0, caption_counters_1.clearTableNumbers)();
    (0, caption_counters_1.clearFigureNumbers)();
    (0, sub_tabular_1.ClearSubTableLists)();
    (0, sub_math_1.ClearSubMathLists)();
    (0, sub_cell_1.ClearDiagboxTable)();
    (0, parse_error_1.ClearParseError)();
    (0, sub_code_1.ClearExtractedCodeBlocks)();
    (0, tabular_td_1.clearColumnStyleCache)();
};
// Parse-only caches — never read during render; safe to drop post-parse.
var dropParseCaches = function () {
    (0, sub_tabular_1.ClearSubTableLists)();
    (0, sub_math_1.ClearSubMathLists)();
    (0, sub_cell_1.ClearDiagboxTable)();
    (0, sub_code_1.ClearExtractedCodeBlocks)();
...
exports.default = (function (md, options) {
    ...
    var resetTabularHook = function (state) {
    ...
    var hasHook = typeof md.core.ruler.__find__ === 'function'
    ...
    var cleanupHook = function (state) {
        var isPartial = state.md.options.renderElement
            && state.md.options.renderElement.hasOwnProperty('startLine');
        if (!isPartial) {
            dropParseCaches();
    ...
    md.renderer.rules.includegraphics = function (tokens, idx, options, env, slf) {
        return (0, md_renderer_rules_1.IncludeGraphics)(tokens, idx, options, env, slf);
    };
});
