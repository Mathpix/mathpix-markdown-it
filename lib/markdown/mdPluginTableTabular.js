...
exports.default = (function (md, options) {
    ...
    md.block.ruler.after("fence", "BeginTabular", begin_tabular_1.BeginTabular, Object.assign({}, md.options, { alt: common_1.getTerminatedRules('BeginTabular') }));
    md.block.ruler.before("BeginTabular", "BeginAlign", begin_align_1.BeginAlign, { alt: common_1.getTerminatedRules('BeginAlign') });
    md.block.ruler.before("BeginAlign", "BeginTable", begin_table_1.BeginTable, { alt: common_1.getTerminatedRules('BeginTable') });
    md.block.ruler.after("BeginTabular", "BeginTheorem", block_rule_1.BeginTheorem, { alt: common_1.getTerminatedRules('BeginTheorem') });
    md.block.ruler.before("BeginTheorem", "BeginProof", block_rule_1.BeginProof, { alt: common_1.getTerminatedRules('BeginProof') });
    ...
    md.renderer.rules.includegraphics = function (tokens, idx, options, env, slf) {
        return md_renderer_rules_1.IncludeGraphics(tokens, tokens[idx], slf, width, options);
    };
});
