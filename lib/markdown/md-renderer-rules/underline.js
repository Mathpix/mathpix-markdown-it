...
var XOUT_STYLE = 'background: repeating-linear-gradient(-60deg, currentcolor, currentcolor, transparent 1px, transparent 6px);';
var LINE_THROUGH_STYLE = 'text-decoration: line-through;';
/** Canvas has no `text-decoration-thickness` in its allowlist, so it is left out there. */
var LINE_THROUGH_FROM_FONT_STYLE = 'text-decoration: line-through; text-decoration-thickness: from-font;';
...
var renderOutOpen = function (tokens, idx, options, env, slf) {
    ...
    else if (options === null || options === void 0 ? void 0 : options.forCanvas) {
