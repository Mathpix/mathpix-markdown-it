...
var htmlUnderlineOpen = function (underlineLevel, underlineType, underlinePadding) {
    ...
    if (underlineType === 'uwave') {
        var html_1 = "<span data-underline-level=\"" + underlineLevel + "\" ";
        html_1 += "data-underline-type=\"" + underlineType + "\" ";
        html_1 += 'style="';
...
exports.renderOutOpen = function (tokens, idx, options, env, slf) {
    var token = tokens[idx];
    var html = "<span ";
...
exports.renderOutText = function (tokens, idx, options, env, slf) {
    var token = tokens[idx];
    return mdPluginText_1.renderInlineContent(token, options, env, slf);
};
