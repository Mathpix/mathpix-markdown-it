...
exports.renderTabular = function (a, token, options, renderer) {
    var _a = options.outMath.include_table_html, include_table_html = _a === void 0 ? true : _a;
...
exports.renderTabularInline = function (a, token, options, renderer) {
    ...
    var tabular = include_table_html
