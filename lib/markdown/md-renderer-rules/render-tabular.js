...
var renderInlineTokenBlock = function (tokens, options, env, slf, isSubTable, highlight) {
    ...
    for (var idx = 0; idx < tokens.length; idx++) {
        ...
        if (!tableTokens.includes(token.token) && !tableTokens.includes(token.type)) {
            if ((token === null || token === void 0 ? void 0 : token.type) === 'tabular') {
                var data = (0, exports.renderInlineTokenBlock)(token.children, options, env, slf, token.isSubTable, highlight);
                result += data.table;
                continue;
            }
            if (((_b = token === null || token === void 0 ? void 0 : token.children) === null || _b === void 0 ? void 0 : _b.length) > 0) {
                var data = (0, render_table_cell_content_1.renderTableCellContent)(token, true, options, env, slf);
                result += data.content;
            }
            else {
        ...
        if ((options === null || options === void 0 ? void 0 : options.forPptx) && token.token === 'td_open' && ((_c = tokens[idx + 1]) === null || _c === void 0 ? void 0 : _c.token) === 'td_close') {
        ...
        if (options === null || options === void 0 ? void 0 : options.forPptx) {
            ...
            if (token.token === 'td_open' && ((_d = tokens[idx + 1]) === null || _d === void 0 ? void 0 : _d.token) === 'td_close') {
                result += 'x';
            }
        }
    }
