...
var renderNonTableTokenIntoCell = function (token, ctx, acc) {
    ...
    var needHtml = !forMD && outMath.include_table_html !== false;
    var needTsv = !!outMath.include_tsv;
    var needCsv = !!outMath.include_csv;
    var needSmoothed = !!(options === null || options === void 0 ? void 0 : options.forPptx);
...
var renderInlineTokenBlock = function (tokens, options, env, slf, isSubTable, highlight) {
    ...
    var needTsv = !!outMath.include_tsv;
    var needCsv = !!outMath.include_csv;
    var needMd = forMD || !!outMath.include_table_markdown;
    var needSmoothed = !!(options === null || options === void 0 ? void 0 : options.forPptx);
