...
var handleListTokensForCellMarkdown = function (token, ctx, acc) {
    ...
    if ((token === null || token === void 0 ? void 0 : token.type) === "latex_list_item_open") {
        ...
        var listLevel = isEnumerate ? (_c = token.meta) === null || _c === void 0 ? void 0 : _c.enumerateLevel : (_d = token.meta) === null || _d === void 0 ? void 0 : _d.itemizeLevel;
        ...
        if (token.hasOwnProperty('marker')) {
            if (((_e = token.markerTokens) === null || _e === void 0 ? void 0 : _e.length) === 1) {
            ...
            var itemizeLevel = Math.max(1, listLevel !== null && listLevel !== void 0 ? listLevel : 1);
            var plainMarker = (0, list_markers_1.getItemizePlainMarker)(itemizeLevel);
