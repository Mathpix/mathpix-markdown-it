...
var renderDiagBoxItem = function (tokens, idx, options, env, slf) {
    ...
    var _a = (0, render_table_cell_content_1.renderTableCellContent)(token, true, options, env, slf), content = _a.content, tsv = _a.tsv, csv = _a.csv, tableMd = _a.tableMd, liner_tsv = _a.liner_tsv;
    Object.assign(token, { tsv: tsv, csv: csv, tableMd: tableMd, liner_tsv: liner_tsv });
...
var renderDiagbox = function (tokens, idx, options, env, slf) {
    ...
    var styles = ((_b = token.meta) === null || _b === void 0 ? void 0 : _b.isBlock)
        ? ['display: grid; height: 100%; grid-auto-rows: 1fr; min-width: max-content;']
        : ['display: inline-grid;',
    ...
    var dataKeys = ["tsv", "csv", "tableMd", "liner_tsv"];
