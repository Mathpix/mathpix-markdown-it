export declare const render_itemize_list_open: (tokens: any, index: any, options: any, env: any, renderer: any) => string;
export declare const render_enumerate_list_open: (tokens: any, index: any, options: any, env: any, renderer: any) => string;
