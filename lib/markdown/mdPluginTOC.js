...
var renderList = function (tocList, options, env, slf) {
    ...
    for (var i = 0; i < tocList.length; i++) {
        ...
        var parentId = ((_b = options.toc) === null || _b === void 0 ? void 0 : _b.doNotGenerateParentId) ? '' : item.subHeadings && isSummary ? utils_1.uid() : '';
        var dataParentId = parentId
            ? "data-parent-id=\"" + parentId + "\" "
            : '';
        /** To generate a link to the corresponding header in the DOM tree */
        var renderLink = "<a href=\"" + link + "\" style=\"cursor: pointer; text-decoration: none;\" class=\"toc-link\" value=\"" + value + "\"";
...
var slugsTocItems = {};
exports.clearSlugsTocItems = function () {
    slugsTocItems = {};
};
/**
...
var getTocList = function (pos, tokens, options, levelSub, env, slf) {
    ...
    while (i < size) {
        ...
        var slugifiedContent = heading_id !== ''
            ? heading_id
            : common_1.uniqueSlug(common_1.slugify(heading.content), slugsTocItems);
