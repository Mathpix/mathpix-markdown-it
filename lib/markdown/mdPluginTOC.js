...
var TOC_ENV_KEY = '__mathpix_toc_tokens';
var defaults = {
...
var renderTocBody = function (tokens, index, options, env, slf) {
    var _a;
    var res = '';
    var allTokens = (env && env[TOC_ENV_KEY]) || tokens || [];
    var dataToc = getTocList(0, allTokens, options, -1, env, slf);
...
var getTocList = function (pos, tokens, options, levelSub, env, slf) {
    ...
    while (i < size) {
        ...
        var isHeadingClose = token.type === 'heading_close';
        var shouldExcludeUnnumbered = ((_a = options === null || options === void 0 ? void 0 : options.toc) === null || _a === void 0 ? void 0 : _a.excludeUnnumberedFromTOC) && token.type === 'addcontentsline_close';
        ...
        if (((_b = options === null || options === void 0 ? void 0 : options.toc) === null || _b === void 0 ? void 0 : _b.excludeUnnumberedFromTOC) && isHeadingClose && token.isUnNumbered) {
            i++;
            continue;
        }
        ...
        if (!currentLevel) {
            ...
            if (level > currentLevel) {
                ...
                if (last && (subHeadings === null || subHeadings === void 0 ? void 0 : subHeadings.length)) {
                    if ((_c = last.subHeadings) === null || _c === void 0 ? void 0 : _c.length) {
...
exports.default = (function (md, opts) {
    ...
    md.core.ruler.push('grab_state', function (state) {
        ...
        for (var i = 0; i < state.tokens.length; i++) {
            var children = state.tokens[i].children;
            if (!children) {
                continue;
            }
            for (var j = 0; j < children.length; j++) {
