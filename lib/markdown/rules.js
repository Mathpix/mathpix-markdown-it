...
var prependStyle = function (token, style) {
    if (!style) {
        return;
    }
    var current = token.attrGet("style");
    if (!current) {
...
function injectCenterTables(tokens, idx, options, env, slf) {
    ...
    if (token.level === 0) {
        ...
        if (options.forCanvas) {
            prependStyle(token, structural_1.TABLE_CENTER_STYLE);
        }
        else {
...
var injectCanvasTableStyles = function (renderer) {
    var e_1, _a;
    var styles = {
        table_open: (0, structural_1.canvasInlineStyle)(structural_1.TABLE_STYLE),
        td_open: (0, structural_1.canvasInlineStyle)((0, structural_1.tableCellStyle)(structural_1.DEFAULT_BORDER_COLOR)),
        th_open: (0, structural_1.canvasInlineStyle)((0, structural_1.tableCellStyle)(structural_1.DEFAULT_BORDER_COLOR) + structural_1.TABLE_HEADER_STYLE),
    };
    var _loop_1 = function (name_1) {
        var previous = renderer.renderer.rules[name_1];
        renderer.renderer.rules[name_1] = function (tokens, idx, options, env, slf) {
            prependStyle(tokens[idx], styles[name_1]);
            return previous
...
var injectRenderRules = function (renderer) {
    var _a = renderer.options, _b = _a.lineNumbering, lineNumbering = _b === void 0 ? false : _b, _c = _a.htmlSanitize, htmlSanitize = _c === void 0 ? {} : _c, _d = _a.html, html = _d === void 0 ? false : _d, _e = _a.forDocx, forDocx = _e === void 0 ? false : _e, _f = _a.forCanvas, forCanvas = _f === void 0 ? false : _f, _g = _a.centerTables, centerTables = _g === void 0 ? true : _g, _h = _a.renderOptions, renderOptions = _h === void 0 ? null : _h;
