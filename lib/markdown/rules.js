...
function html_inline_Sanitize(tokens, idx, options) {
    ...
    return htmlSanitize && Object.keys(htmlSanitize).length > 0
        ? sanitize_1.sanitize(tokens[idx].content, Object.assign({}, { skipCloseTag: hasNotCloseTag }, htmlSanitize))
        : sanitize_1.sanitize(tokens[idx].content, { skipCloseTag: hasNotCloseTag });
}
