...
function injectLineNumbers(tokens, idx, options, env, slf) {
    ...
    if (tokens[idx].map && tokens[idx].level === 0) {
        ...
        var rendered = slf.renderToken(tokens, idx, options, env, slf);
        if (((_a = options.addSeparateTagIntoResultHtml) === null || _a === void 0 ? void 0 : _a.countHtmlElements) > 0) {
