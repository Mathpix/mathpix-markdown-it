...
var FOOTNOTE_LIST_TERMINATOR_NAMES = new Set(["Lists"]);
...
var latex_footnote_block = function (state, startLine, endLine, silent) {
    ...
    try {
        ...
        if (!sawFootnoteToken || !consts_1.reOpenTagFootnoteG.test(lineText)) {
            ...
            var listRule = (_a = resolveEnabledRuleFns(state.md.block.ruler, FOOTNOTE_LIST_TERMINATOR_NAMES)[0]) !== null && _a !== void 0 ? _a : null;
