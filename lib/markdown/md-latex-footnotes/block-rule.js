...
var LIST_TERMINATOR_NAME = new Set(["Lists"]);
...
var latex_footnote_block = function (state, startLine, endLine, silent) {
    ...
    try {
        ...
        if (!sawFootnoteToken || !consts_1.reOpenTagFootnoteG.test(lineText)) {
            ...
            var _e = tslib_1.__read(resolveEnabledRuleFns(state.md.block.ruler, LIST_TERMINATOR_NAME), 1), listRule_1 = _e[0];
            ...
            var probes = function (line) {
                try {
                    return fence(state, line, endLine, true)
                        || (!!listRule_1 && listRule_1(state, line, endLine, true));
                }
                catch (e) {
                    return false;
                }
