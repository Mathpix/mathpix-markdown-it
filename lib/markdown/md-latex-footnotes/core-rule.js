...
var createFootnotesTokens = function (state, stateTokens, refTokens, meta, idx, itemLabel, itemCount, itemTokens, itemContent, isBlock) {
    ...
    for (var j = 0; j < t; j++) {
        ...
        var footnote = ((_b = (_a = state.env.footnotes) === null || _a === void 0 ? void 0 : _a.list) === null || _b === void 0 ? void 0 : _b.length) > token.meta.id
            ? (_c = state.env.footnotes) === null || _c === void 0 ? void 0 : _c.list[token.meta.id] : null;
        if (footnote) {
    ...
    try {
        ...
        state.tokens = state.tokens.filter(function (tok) {
            ...
            if (tok.type === 'footnote_reference_close') {
                ...
                state.env.footnotes.refsTokens[':' + currentLabel_1] = current_1;
        ...
        (0, utils_1.renameToken)(state.tokens, 'footnote_ref', 'mmd_footnote_ref', state.env);
        ...
        if (!(((_c = state.md.options) === null || _c === void 0 ? void 0 : _c.forMD) || ((_d = state.md.options) === null || _d === void 0 ? void 0 : _d.forLatex))) {
