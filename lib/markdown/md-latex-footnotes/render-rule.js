...
var render_footnote_caption = function (tokens, idx, options, env, slf) {
    ...
    if (!((_a = options === null || options === void 0 ? void 0 : options.footnotes) === null || _a === void 0 ? void 0 : _a.compact_refs) && tokens[idx].meta.subId > 0) {
...
var render_footnote_ref = function (tokens, idx, options, env, slf) {
    try {
        ...
        if (tokens[idx].meta.type === "footnotemark" && (footnote === null || footnote === void 0 ? void 0 : footnote.hasOwnProperty('textId'))) {
            id = (footnote.textId + 1).toString();
        }
        else {
            id = slf.rules.mmd_footnote_anchor_name(tokens, idx, options, env, slf);
        }
        var refid = slf.rules.mmd_footnote_anchor_name(tokens, idx, options, env, slf);
...
var render_footnote_block_open = function (tokens, idx, options) {
    var _a, _b;
    var cssFontSize = ((_a = options === null || options === void 0 ? void 0 : options.footnotes) === null || _a === void 0 ? void 0 : _a.fontSize)
        ? ' font-size: ' + ((_b = options === null || options === void 0 ? void 0 : options.footnotes) === null || _b === void 0 ? void 0 : _b.fontSize) + ';'
        : '';
    var html = (options.xhtmlOut ? '<hr class="footnotes-sep" />\n' : '<hr class="footnotes-sep">\n');
...
var render_footnote_anchor = function (tokens, idx, options, env, slf) {
    ...
    if (notFootnoteMarker) {
        if (footnote === null || footnote === void 0 ? void 0 : footnote.hasOwnProperty('markerId')) {
