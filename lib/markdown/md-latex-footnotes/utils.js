...
var addFootnoteToListForFootnotetext = function (state, token, tokens, envText, numbered, isBlock) {
    ...
    try {
        ...
        var nonumbers = !Boolean((_f = (_e = (_d = (_c = state.md) === null || _c === void 0 ? void 0 : _c.options) === null || _d === void 0 ? void 0 : _d.footnotes) === null || _e === void 0 ? void 0 : _e.footnotetext) === null || _f === void 0 ? void 0 : _f.autonumbers)
            && numbered === undefined;
        token.meta = {
            numbered: numbered,
            isBlock: isBlock,
