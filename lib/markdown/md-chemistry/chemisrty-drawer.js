...
exports.ChemistryDrawer = {
    drawSvgSync: function (content, id, options) {
        ...
        var _a = options.theme, theme = _a === void 0 ? 'light' : _a, stretch = options.stretch, _b = options.scale, scale = _b === void 0 ? 1 : _b, _c = options.fontSize, fontSize = _c === void 0 ? 14 : _c;
