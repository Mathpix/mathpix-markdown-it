...
var renderSmilesDrawerBlock = function (tokens, idx, options, env, slf) {
    ...
    var _b = outMath.include_smiles, include_smiles = _b === void 0 ? false : _b, _c = outMath.include_svg, include_svg = _c === void 0 ? true : _c, _d = outMath.include_smiles_svg, include_smiles_svg = _d === void 0 ? false : _d;
    var token = tokens[idx];
    if (!token.content) {
        return '';
    }
    var id = !options.isTesting
        ? (0, utils_1.uid)()
        : '';
    var resSvg = include_svg || include_smiles_svg || options.forDocx
