...
exports.renderMathHighlight = exports.renderTextUrlHighlight = exports.codeInlineHighlight = exports.textHighlight = void 0;
...
exports.codeInlineHighlight = function (tokens, idx, options, env, slf) {
    ...
    if ((_a = token.highlights) === null || _a === void 0 ? void 0 : _a.length) {
        ...
        for (var i = 0; i < token.highlights.length; i++) {
            var startPos = token.highlights[i].start - token.positions.start - ((_b = token.markup) === null || _b === void 0 ? void 0 : _b.length);
