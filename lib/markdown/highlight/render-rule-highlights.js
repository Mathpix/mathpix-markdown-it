...
var captionTableHighlight = function (tokens, idx, options, env, slf) {
    ...
    if ((_b = token.highlights) === null || _b === void 0 ? void 0 : _b.length) {
        if ((0, common_1.needToHighlightAll)(token)) {
            ...
            var htmlCaption_1 = ((_d = token.children) === null || _d === void 0 ? void 0 : _d.length)
                ? slf.renderInline(token.children, options, env)
                : token.content;
            var html = "<div class=\"".concat(className, "\">");
        ...
        var htmlCaption_2 = ((_e = token.children) === null || _e === void 0 ? void 0 : _e.length)
            ? slf.renderInline(token.children, options, env)
            : token.content;
        return "<div class=\"".concat(className, "\">").concat(token.print).concat(htmlCaption_2, "</div>");
    }
    var htmlCaption = ((_f = token.children) === null || _f === void 0 ? void 0 : _f.length)
        ? slf.renderInline(token.children, options, env)
        : token.content;
