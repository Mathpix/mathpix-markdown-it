...
exports.mergingHighlights = function (highlights) {
    ...
    var _loop_1 = function (i) {
        var index = (newArr === null || newArr === void 0 ? void 0 : newArr.length) ? newArr.findIndex(function (item) { return item.start >= highlights[i].start
...
exports.findPositionsInHighlights = function (highlights, positions) {
    var res = [];
...
exports.needToHighlightAll = function (token) {
    var res = false;
...
exports.highlightText = function (token, content) {
    ...
    if ((_a = token.highlights) === null || _a === void 0 ? void 0 : _a.length) {
        ...
        if (!token.highlightAll) {
            token.highlights = exports.mergingHighlights(token.highlights);
            for (var i = 0; i < token.highlights.length; i++) {
                var startPos = token.highlights[i].start;
        ...
        var textStr_1 = '';
        if (token.highlightAll) {
            textStr_1 += '<span class="mmd-highlight" style="' + exports.getStyleFromHighlight(token.highlights[0]) + '">';
        ...
        highlightContent.map(function (item) {
            ...
            textStr_1 += '<span class="mmd-highlight" style="' + exports.getStyleFromHighlight(item.highlight) + '">';
