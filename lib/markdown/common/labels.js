...
exports.getLabelsList = exports.groupLabelIdByUuidFromLabelsList = exports.getLabelByUuidFromLabelsList = exports.getLabelByKeyFromLabelsList = exports.clearLabelsList = exports.addIntoLabelsList = exports.labelsList = exports.sanitizeLabel = exports.eLabelType = void 0;
...
var sanitizeLabel = function (key) {
...
var labelsVersion = 0;
var labelsSnapshot = null;
var labelsSnapshotVersion = -1;
var getLabelsSnapshot = function () {
 ...
 */
exports.labelsList = new Proxy([], {
    get: function (_target, prop, receiver) {
        var snapshot = getLabelsSnapshot();
        if (prop === 'length') {
...
var addIntoLabelsList = function (label) {
    if (!label.sanitizedKey) {
        label.sanitizedKey = (0, exports.sanitizeLabel)(label.key);
    }
