...
exports.labelsList = [];
exports.addIntoLabelsList = function (label) {
    /** Label key should be unique */
    var index = (exports.labelsList === null || exports.labelsList === void 0 ? void 0 : exports.labelsList.length) ? exports.labelsList.findIndex(function (item) { return item.key === label.key; })
        : -1;
    ...
    label = exports.groupLabelIdByUuidFromLabelsList(label);
    exports.labelsList.push(label);
};
exports.clearLabelsList = function () {
    exports.labelsList = [];
};
exports.getLabelByKeyFromLabelsList = function (key) {
    return (exports.labelsList === null || exports.labelsList === void 0 ? void 0 : exports.labelsList.length) ? exports.labelsList.find(function (item) { return item.key === key; })
        : null;
};
exports.getLabelByUuidFromLabelsList = function (uuid) {
    return (exports.labelsList === null || exports.labelsList === void 0 ? void 0 : exports.labelsList.length) ? exports.labelsList.find(function (item) { return item.tokenUuidInParentBlock === uuid; })
        : null;
};
/** If the theorem has multiple labels, then we add all those labels to the id
 * that will be used to jump to the parent block for all references of those labels */
exports.groupLabelIdByUuidFromLabelsList = function (label) {
...
exports.getLabelsList = function (showAllInformation) {
    ...
    if (showAllInformation) {
        return tslib_1.__spread(exports.labelsList);
    }
    return (exports.labelsList === null || exports.labelsList === void 0 ? void 0 : exports.labelsList.length) ? exports.labelsList.map(function (item) {
        return {
            key: item.key,
            tag: item.tag,
            type: item.type
