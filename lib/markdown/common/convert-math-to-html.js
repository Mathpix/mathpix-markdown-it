...
var typesetMathForToken = function (params) {
    ...
    if (isCacheable) {
        ...
        if (cached) {
            ...
            return tslib_1.__assign(tslib_1.__assign({}, cached), fmt_1);
        }
    }
    ...
    if (isCacheable) {
        ...
        var sizeRaw = options.typesetCacheSize;
        var maxSize = typeof sizeRaw === 'number' && sizeRaw >= 0 ? sizeRaw : consts_2.DEFAULT_TYPESET_CACHE_SIZE;
