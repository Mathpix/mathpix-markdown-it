...
exports.convertMathToHtml = exports.convertAsciiMathToHtml = exports.clearTypesetCache = void 0;
...
var typesetMathForToken = function (params) {
    ...
    if (isCacheable) {
        var cacheKey = math + '|' + (isBlock ? 'D' : 'I');
        var cached = typesetCache.get(cacheKey);
        if (cached) {
            return cached;
        }
    }
...
var convertAsciiMathToHtml = function (state, token) {
    ...
    try {
        ...
        (0, utils_2.formatMathJaxError)(e, math, 'convertAsciiMathToHtml');
        token.error = { message: e.message, error: e };
    }
};
exports.convertAsciiMathToHtml = convertAsciiMathToHtml;
/**
