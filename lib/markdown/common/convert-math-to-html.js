...
var typesetMathForToken = function (params) {
    ...
    var skipMathToHtml = !!((_c = options.outMath) === null || _c === void 0 ? void 0 : _c.skipMathToHtml);
    var outMathForTypeset = skipMathToHtml && ((_d = options.outMath) === null || _d === void 0 ? void 0 : _d.include_svg) !== false
        ? tslib_1.__assign(tslib_1.__assign({}, options.outMath), { include_svg: false }) : options.outMath;
