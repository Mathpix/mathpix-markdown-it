...
var renderTableCellContent = function (token, isSubTable, options, env, slf) {
    ...
    try {
        for (var j = 0; j < token.children.length; j++) {
            ...
            mdCell += (0, table_markdown_1.getMdForChild)(child);
            if (child.latex) {
                if (((_h = (_g = options.outMath) === null || _g === void 0 ? void 0 : _g.table_markdown) === null || _h === void 0 ? void 0 : _h.math_as_ascii) && ascii) {
                    mdCell += child.ascii_md || ascii;
                    continue;
                }
                var mdContent = consts_1.mathTokenTypes.includes(child.type)
                    ? (0, table_markdown_1.getMdMath)(tslib_1.__assign(tslib_1.__assign({}, child), { content: (_j = child.content) === null || _j === void 0 ? void 0 : _j.trim() }), options)
                    : child.latex;
                mdCell += mdContent
                    .replace(/\|/g, '\\|')
                    .replace(/\n/g, ' ');
