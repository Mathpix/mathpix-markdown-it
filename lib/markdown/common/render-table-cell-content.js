    ...
    try {
        for (var j = 0; j < token.children.length; j++) {
            ...
            switch (child.type) {
                ...
                case 'includegraphics': {
                    ...
                    mdCell += (options === null || options === void 0 ? void 0 : options.forMD)
                        ? rendered
                        : "![".concat((_c = child.attrGet('alt')) !== null && _c !== void 0 ? _c : '', "](").concat(src, ")").replace(/\|/g, '\\|');
                    continue;
                }
                case 'code':
                case 'code_inline':
            ...
            if (child.latex) {
                ...
                if (((_g = outMath === null || outMath === void 0 ? void 0 : outMath.table_markdown) === null || _g === void 0 ? void 0 : _g.math_as_ascii) && ascii) {
                    mdCell += child.ascii_md || ascii;
                    continue;
                }
                var begin_math_inline_delimiters = '$';
                var end_math_inline_delimiters = '$';
                if (((_k = (_j = (_h = options.outMath) === null || _h === void 0 ? void 0 : _h.table_markdown) === null || _j === void 0 ? void 0 : _j.math_inline_delimiters) === null || _k === void 0 ? void 0 : _k.length) > 1) {
                ...
                var mdContent = consts_1.mathTokenTypes.includes(child.type)
                    ? begin_math_inline_delimiters + ((_l = child.content) === null || _l === void 0 ? void 0 : _l.trim()) + end_math_inline_delimiters
                    : child.latex;
                mdCell += mdContent
                    .replace(/\|/g, '\\|')
                    .replace(/\n/g, ' ');
