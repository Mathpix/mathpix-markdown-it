...
var renderTableCellContent = function (token, isSubTable, options, env, slf) {
    ...
    try {
        for (var j = 0; j < token.children.length; j++) {
            ...
            switch (child.type) {
                ...
                case 'includegraphics': {
                    ...
                    mdCell += (options === null || options === void 0 ? void 0 : options.forMD)
                        ? rendered
                        : "![".concat((_d = child.attrGet('alt')) !== null && _d !== void 0 ? _d : '', "](").concat(src, ")").replace(/\|/g, '\\|');
                    continue;
                }
                case 'code':
                case 'code_inline':
                ...
                case "latex_lstlisting_env": {
                    ...
                    var escape_1 = escapeHtml((_f = (_e = child.meta) === null || _e === void 0 ? void 0 : _e.codeText) !== null && _f !== void 0 ? _f : child.content);
            ...
            if ((_g = child.tableMd) === null || _g === void 0 ? void 0 : _g.length) {
            ...
            if (child.latex) {
                ...
                if (((_h = outMath === null || outMath === void 0 ? void 0 : outMath.table_markdown) === null || _h === void 0 ? void 0 : _h.math_as_ascii) && ascii) {
                    mdCell += child.ascii_md || ascii;
                    continue;
                }
                var begin_math_inline_delimiters = '$';
                var end_math_inline_delimiters = '$';
                if (((_l = (_k = (_j = options.outMath) === null || _j === void 0 ? void 0 : _j.table_markdown) === null || _k === void 0 ? void 0 : _k.math_inline_delimiters) === null || _l === void 0 ? void 0 : _l.length) > 1) {
