...
export declare const reFootnoteToken: RegExp;
...
export declare const reFootnotetextToken: RegExp;
...
export declare const FIGURE_TABLE_PLACEMENTS: readonly ["!H", "H!", "H", "!h", "h!", "h", "!t", "t!", "t", "!b", "b!", "b", "!p", "p!", "p"];
...
export declare const toFigureTablePlacement: (s: string | undefined) => FigureTablePlacement | undefined;
