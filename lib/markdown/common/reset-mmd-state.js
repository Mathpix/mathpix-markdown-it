...
var env_transient_1 = require("./env-transient");
...
var resetMmdGlobalState = function () {
    ...
    (0, render_latex_list_env_1.resetListRenderDepth)(); // also called from the plugin hook, which a partial render reaches
    (0, env_transient_1.resetEnvSnapshotPool)(); // same: per-render, so the hook calls it too
