...
exports.closeTagSpan = exports.openTagSpan = exports.reSpanG = exports.reSpan = exports.reOpenTagSmiles = exports.open_tag_smiles = exports.closeTagMML = exports.openTagMML = exports.attribute = exports.attr_value = void 0;
...
exports.reSpanG = /<(span\s*(?:class="([^>]*)")\s*([^>]*))>(.*)<\/span\>/g;
var open_tag_span = '<(span)' + exports.attribute + '*\\s*\\/?>';
var close_tag_span = '<\\/span*\\s*>';
exports.openTagSpan = new RegExp('(?:' + open_tag_span + ')');
