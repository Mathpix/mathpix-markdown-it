...
exports.firstPositionAtOrAfter = exports.countPositionsAtOrAfter = exports.srcValueCached = exports.matchPositionsCached = exports.lastMatchPosCached = exports.clearSrcPosCaches = void 0;
...
var bucketOf = function (state, key) {
    ...
    bucketKeys.add(key);
    return (host[key] = { hotSrc: null, hotValue: undefined, bySrc: new Map() });
};
 ...
 */
var srcValueCached = function (state, key, compute) {
    var bucket = bucketOf(state, key);
    var cached = recall(bucket, state.src);
