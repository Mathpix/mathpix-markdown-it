...
exports.tableMarkdownJoin = exports.getMdForChild = exports.getMdLink = exports.getMdMath = exports.asciiForMarkdown = exports.SMILES_CLOSE = exports.SMILES_OPEN = exports.mdHref = void 0;
...
var asciiForMarkdown = function (token) {
    return token.ascii_md || token.ascii_tsv || token.ascii;
};
exports.asciiForMarkdown = asciiForMarkdown;
...
var getMdMath = function (token, options, content) {
    ...
    var ascii = (0, exports.asciiForMarkdown)(token);
