...
exports.tableMarkdownJoin = exports.getMdForChild = exports.getMdLink = exports.getMdMath = exports.SMILES_CLOSE = exports.SMILES_OPEN = void 0;
...
var getMdMath = function (token, options) {
    var _a, _b;
    ...
    var isDisplay = token.type !== 'inline_math';
    var _c = tslib_1.__read((configured === null || configured === void 0 ? void 0 : configured.length) > 1
        ? [configured[0], configured[1]]
        : isDisplay ? ['$$', '$$'] : ['$', '$'], 2), open = _c[0], close = _c[1];
    return open + ((_b = token.content) !== null && _b !== void 0 ? _b : '') + close;
};
...
var getMdLink = function (child, token, j, options) {
    ...
    for (var i = j + 1; i < token.children.length; i++) {
        ...
        if (inner.type === 'text') {
            ...
            text += (0, exports.getMdMath)(inner, options);
        }
            ...
            text += "![".concat((_b = (_a = inner.attrGet('alt')) !== null && _a !== void 0 ? _a : inner.content) !== null && _b !== void 0 ? _b : '', "](").concat(mdHref(inner.attrGet('src')), ")");
        }
            ...
            text += escapeLabel((0, exports.getMdForChild)(inner) || ((_c = inner.content) !== null && _c !== void 0 ? _c : ''));
        }
    }
