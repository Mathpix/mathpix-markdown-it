...
exports.restoreEnvKeysFromAll = exports.resetEnvSnapshotPool = exports.restoreEnvAll = exports.releaseEnvSnapshot = exports.envSnapshotDepth = exports.snapshotEnvAll = exports.snapshotEnvForInline = exports.LIST_TRANSIENT_ENV_KEYS = void 0;
...
var snapshotEnvAll = function (env) {
    ...
    try {
        ...
        var keys = env ? Object.keys(env) : EMPTY_KEYS;
...
var envSnapshotDepth = function () { return snapshotDepth; };
exports.envSnapshotDepth = envSnapshotDepth;
...
var snapshotIsUsable = function (snap) {
...
var resetEnvSnapshotPool = function () {
    if (snapshotDepth > 0) {
        (0, warn_distinct_1.warnDistinct)('env-pool-nested', '[env] snapshot pool reset while a snapshot is live; the pool is kept');
        return;
    }
