 ...
 */
var nextMathSpan = function (str, from, mathEnvsOnly, until, lastEnd) {
    var _a;
    ...
    var lastEndAt = lastEnd !== null && lastEnd !== void 0 ? lastEnd : str.lastIndexOf('\\end');
    var match;
