...
exports.tokenDisplayWidth = exports.displayWidth = exports.isWideChar = exports.MARKER_GAP_EX = exports.EX_PER_CHAR_CELL = void 0;
...
var tokenDisplayWidth = function (token) {
    var _a, _b;
    if (token.type === 'text') {
        return (0, exports.displayWidth)((_a = token.content) !== null && _a !== void 0 ? _a : '');
    }
    if (typeof token.widthEx === 'number') {
        return token.widthEx / MATH_EX_PER_CHAR;
    }
    if (MATH_TOKEN_TYPES.has(token.type)) {
        return (0, exports.displayWidth)((_b = token.content) !== null && _b !== void 0 ? _b : '');
    }
