...
exports.linerTsvJoin = exports.TsvJoin = void 0;
...
var linerTsvJoin = function (tsv) {
    if (!tsv || tsv.length === 0) {
        return '';
    }
    return tsv.map(function (row) { return Array.isArray(row) ? row.join(' ') : row; }).join('\n');
};
exports.linerTsvJoin = linerTsvJoin;
