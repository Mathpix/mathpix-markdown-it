...
var afterCommandOptions = function (text, from, atName, codePositions) {
    if (atName === void 0) { atName = true; }
    var at = from;
    for (;;) {
        ...
        if (atName && text[at] === '\\' && (0, common_1.isAsciiLetter)(text.charCodeAt(at + 1))) {
            at++;
