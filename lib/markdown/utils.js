...
// Shared-attrs marker (see md-block-rule/begin-tabular/tabular-td.ts).
var ATTRS_SHARED = Symbol.for('mathpix.tabular.attrsShared');
    ...
    try {
        ...
        if (token.children.find(function (item) { return item.type === tokenType; })) {
            if ((_a = parentToken.attrs) === null || _a === void 0 ? void 0 : _a.length) {
                if (parentToken.attrs[ATTRS_SHARED]) {
