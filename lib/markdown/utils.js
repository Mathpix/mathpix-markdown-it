        ...
        for (var i = 0; i < str.length; i++) {
            ...
            if ((0, exports.isNotBackticked)(str, match[0])) {
                ...
                if (match[0] === "\\[" || match[0] === "\[") {
                    ...
                    result = new RegExp("end{".concat(match[1], "}"));
                }
                break;
            }
            else {
...
var findOpenCloseTags = function (str, tagOpen, tagClose, pendingBackTick) {
...
var renameToken = function (tokens, name, newName, env) {
    ...
    for (var i = 0; i < (tokens === null || tokens === void 0 ? void 0 : tokens.length); i++) {
        ...
        if (["mmd_footnote_ref", "footnote_latex"].includes(tokens[i].type)) {
            if (tokens[i].meta && ((_b = (_a = env.footnotes) === null || _a === void 0 ? void 0 : _a.list) === null || _b === void 0 ? void 0 : _b.length)) {
                var footnote = ((_d = (_c = env.footnotes) === null || _c === void 0 ? void 0 : _c.list) === null || _d === void 0 ? void 0 : _d.length) > tokens[i].meta.id
                    ? (_e = env.footnotes) === null || _e === void 0 ? void 0 : _e.list[tokens[i].meta.id] : null;
                if (footnote) {
        ...
        if ((_g = (_f = tokens[i]) === null || _f === void 0 ? void 0 : _f.children) === null || _g === void 0 ? void 0 : _g.length) {
            for (var j = 0; j < tokens[i].children.length; j++) {
                var child = tokens[i].children[j];
                if (child.type === name) {
                    child.type = newName;
                }
                if (["mmd_footnote_ref", "footnote_latex"].includes(child.type)) {
                    if (child.meta && ((_j = (_h = env.footnotes) === null || _h === void 0 ? void 0 : _h.list) === null || _j === void 0 ? void 0 : _j.length)) {
                        var footnote = ((_l = (_k = env.footnotes) === null || _k === void 0 ? void 0 : _k.list) === null || _l === void 0 ? void 0 : _l.length) > child.meta.id
                            ? (_m = env.footnotes) === null || _m === void 0 ? void 0 : _m.list[child.meta.id] : null;
                        if (footnote) {
                ...
                if ((_o = child.children) === null || _o === void 0 ? void 0 : _o.length) {
                    (0, exports.renameToken)(child.children, name, newName, env);
                }
            }
        }
    }
};
exports.renameToken = renameToken;
