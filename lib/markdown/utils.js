...
exports.findOpenCloseTagsMathEnvironment = exports.findOpenCloseTags = exports.findBackTick = exports.uid = exports.arrayResortFromElement = exports.arrayDelElement = exports.arraysCompare = exports.includesMultiMathTag = exports.includesMultiMathBeginTag = exports.includesSimpleMathTag = exports.isNotBackticked = exports.getWidthFromDocument = exports.getTextWidth = exports.beginTag = exports.endTag = void 0;
 ...
 * */
exports.findOpenCloseTagsMathEnvironment = function (str, tagOpen, tagClose) {
    var max = str.length;
    var arrOpen = [];
    var arrClose = [];
    var posStart = 0;
        ...
        if (str.charCodeAt(pos) === 0x5c /* \ */) {
            ...
            if (match) {
                ...
                if (match) {
                    ...
                    if (arrClose.length === (arrOpen === null || arrOpen === void 0 ? void 0 : arrOpen.length)) {
                        break;
                    }
                    pos = posEnd - 1;
                }
