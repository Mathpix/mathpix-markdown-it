        ...
        if (token.block) {
            ...
            if (token.map && ((_c = token.map) === null || _c === void 0 ? void 0 : _c.length) === 2 && token.map[0] >= 0 && token.map[1] >= 0) {
                ...
                if ((_f = token.highlights) === null || _f === void 0 ? void 0 : _f.length) {
                    ...
                    if (token.positions.start_content > ((_g = token.highlights) === null || _g === void 0 ? void 0 : _g[0].start)) {
                        if ((_h = token.highlights) === null || _h === void 0 ? void 0 : _h[0].highlight_color) {
                            dataAttrsStyle += "background-color: " + ((_j = token.highlights) === null || _j === void 0 ? void 0 : _j[0].highlight_color) + ";";
                        }
                        if ((_k = token.highlights) === null || _k === void 0 ? void 0 : _k[0].text_color) {
                            dataAttrsStyle += "color: " + ((_l = token.highlights) === null || _l === void 0 ? void 0 : _l[0].text_color) + ";";
                        }
            ...
            if (((_m = token.children) === null || _m === void 0 ? void 0 : _m.length) && token.positions) {
                ...
                var pos = token.positions.hasOwnProperty('start_content')
                    ...
                    : ((_o = token.positions) === null || _o === void 0 ? void 0 : _o.start) ? token.positions.start : 0;
                pos += offsetContent;
