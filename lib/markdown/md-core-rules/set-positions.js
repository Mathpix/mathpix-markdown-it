...
var setChildrenPositions = function (state, token, pos, highlights, isBlockquote) {
    ...
    for (var i = 0; i < token.children.length; i++) {
        ...
        var startPos = pos;
        // Skip the link_open branch unless the full link triple (link_open, text, link_close) is present and writable, AND link_close carries `nextPos` (used as the link end below — `undefined` would propagate as `NaN` into `.positions`). Falling through to the per-child guarded path is safe but degrades position accuracy for the link's text/close (link_open carries no `content`/`markup`).
        if (child.type === "link_open" && !child.hasOwnProperty('nextPos')
            ...
            && token.children[i + 2] && typeof token.children[i + 2].nextPos === 'number') {
        ...
        if (child.hasOwnProperty('nextPos')) {
            ...
            if ((_e = child.inlinePos) === null || _e === void 0 ? void 0 : _e.end) {
                ...
                pos += ((_f = child === null || child === void 0 ? void 0 : child.content) === null || _f === void 0 ? void 0 : _f.length)
                    ? (_g = child === null || child === void 0 ? void 0 : child.content) === null || _g === void 0 ? void 0 : _g.length
                    : ((_h = child === null || child === void 0 ? void 0 : child.markup) === null || _h === void 0 ? void 0 : _h.length)
                        ? (_j = child === null || child === void 0 ? void 0 : child.markup) === null || _j === void 0 ? void 0 : _j.length
                        : 0;
            }
