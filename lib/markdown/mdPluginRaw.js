...
function paragraphDiv(state, startLine /*, endLine*/) {
    ...
    var openBrackets = 0;
    var svgDepth = 0;
    var reSvgOpen = /<svg[\s>]/i;
    var reSvgClose = /<\/svg>/i;
    var count = function (re, s) { return (s.match(new RegExp(re.source, 'gi')) || []).length; };
    var emptyInsideSvgStreak = 0;
