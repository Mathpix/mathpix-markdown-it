    ...
    if (!silent) {
        ...
        if (type !== "reference_note") {
            if (state.md.options.addPositionsToTokens) {
                token.canonicalized = token.content ? utils_1.canonicalMath(token.content) : [];
            }
            if ((_c = state.md.options.highlights) === null || _c === void 0 ? void 0 : _c.length) {
                token.canonicalizedPositions = token.content ? utils_1.canonicalMathPositions(token.content) : [];
            }
        }
                ...
                var data = mathjax_1.MathJax.TypesetSvgAndAscii(math, {
                    ...
                    outMath: Object.assign({}, options.outMath, {
                        optionAscii: {
                            showStyle: false,
                            extraBrackets: true,
                            tableToTsv: ((_a = options.outMath) === null || _a === void 0 ? void 0 : _a.include_tsv) && consts_2.envArraysShouldBeFlattenInTSV.includes(token.math_env),
                            tableToCsv: ((_b = options.outMath) === null || _b === void 0 ? void 0 : _b.include_csv) && consts_2.envArraysShouldBeFlattenInTSV.includes(token.math_env),
                            tableToMd: ((_c = options.outMath) === null || _c === void 0 ? void 0 : _c.include_table_markdown) && consts_2.envArraysShouldBeFlattenInTSV.includes(token.math_env),
...
var renderReference = function (token, options, env, slf) {
    ...
    html += ((_c = token.highlights) === null || _c === void 0 ? void 0 : _c.length) ? common_2.highlightText(token, reference) : reference;
    html += '</a>';
