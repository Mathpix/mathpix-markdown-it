...
var core_inline_async_1 = require("./md-inline-rule/core-inline-async");
...
exports.default = (function (options) {
    ...
    return function (md) {
        ...
        if (!disableRuleTypes.includes(mmdRules_1.eMmdRuleType.latex)) {
            var rule = function (state) { return (0, core_inline_1.coreInline)(state); };
            if (md.options.asyncParsing) {
                rule.async = core_inline_async_1.coreInlineAsync;
            }
