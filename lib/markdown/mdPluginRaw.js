...
var renderMath = function (a, token, options) {
    ...
    if (((_a = token.mathData) === null || _a === void 0 ? void 0 : _a.error) && options.parserErrors !== mathpix_markdown_model_1.ParserErrors.show) {
    ...
    if (token.type === "equation_math") {
        return idLabels
            ? "<span id=\"".concat(idLabels, "\" class=\"math-block equation-number id=").concat(idLabels, "\" number=\"").concat(attrNumber, "\">").concat(mathEquation, "</span>")
            : "<span  class=\"math-block equation-number \" number=\"".concat(attrNumber, "\">").concat(mathEquation, "</span>");
    }
    else {
        return token.type === "inline_math" || token.type === "inline_mathML"
            ...
            : idLabels
                ? "<span id=\"".concat(idLabels, "\" class=\"math-block id=").concat(idLabels, "\">").concat(mathEquation, "</span>")
                : "<span class=\"math-block ".concat(idLabels, "\">").concat(mathEquation, "</span>");
    }
};
