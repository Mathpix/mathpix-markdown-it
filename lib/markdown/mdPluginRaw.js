...
var svg_inline_1 = require("./md-inline-rule/svg_inline");
...
var renderMath = function (a, token, options) {
    ...
    if (token.type === "equation_math") {
        ...
        return token.type === "inline_math" || token.type === "inline_mathML"
            ? idLabels
                ? "<span id=\"".concat(idLabels, "\" class=\"math-inline id=").concat(idLabels, "\">").concat(mathEquation, "</span>")
                : "<span class=\"math-inline ".concat(idLabels, "\">").concat(mathEquation, "</span>")
            : idLabels
...
exports.default = (function (options) {
    ...
    return function (md) {
        ...
        if (!md.options.htmlDisableTagMatching) {
            md.block.ruler.at("html_block", mmd_html_block_1.mmdHtmlBlock);
        }
        ...
        if (md.options.previewUuid) {
            md.block.ruler.at("fence", mmd_fence_1.fenceBlock);
        }
        ...
        md.inline.ruler.before("html_inline", "svg_inline", svg_inline_1.svg_inline);
