...
var renderMath = function (a, token, options) {
    var _a, _b;
    var _c = checkReference(token.content), tagId = _c.tagId, math = _c.math;
...
var renderReference = function (token) {
    ...
    var theoremNumber = helper_1.getTheoremNumberByLabel(token.content);
    var dataParentheses = token.attrGet("data-parentheses");
    var reference = mathNumber[token.content] || theoremNumber;
...
exports.default = (function (options) {
    ...
    return function (md) {
        ...
        md.block.ruler.before("ReNewCommand", "newTheoremBlock", block_rule_1.newTheoremBlock);
