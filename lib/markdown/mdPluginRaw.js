...
var tabulare_1 = require("./md-inline-rule/tabulare");
var render_tabulare_1 = require("./md-renderer-rules/render-tabulare");
var mathNumber = [];
...
var open_tag = '<(math)' + attribute + '*\\s*\\/?>';
var close_tag = '<\\/math*\\s*>';
var openTagMML = new RegExp('(?:' + open_tag + ')');
var closeTagMML = new RegExp('(?:' + close_tag + ')');
...
var renderMath = function (a, token, options) {
    ...
    try {
        ...
        if (token.type === 'display_mathML' || token.type === 'inline_mathML') {
            ...
            mathEquation = mathjax_1.MathJax.Typeset(math, isBlock, { cwidth: cwidth });
        }
    }
    catch (e) {
...
var renderUsepackage = function (token) {
...
function paragraphDiv(state, startLine /*, endLine*/) {
    ...
    var pickStartTag = /\\begin{(abstract|equation|equation|center|left|right|table|figure|tabular\*)}|\\\[/;
    var pickEndTag = /\\end{(abstract|equation|equation|center|left|right|table|figure|tabular\*)}|\\\]/;
...
exports.default = (function (options) {
    ...
    return function (md) {
        ...
        md.inline.ruler.before("multiMath", "inlineTabular", tabulare_1.inlineTabular);
        md.inline.ruler.push("simpleMath", simpleMath);
        Object.keys(mapping).forEach(function (key) {
            md.renderer.rules[key] = function (tokens, idx) {
                switch (tokens[idx].type) {
                    case "tabulare":
                        return render_tabulare_1.renderTabulare(tokens, tokens[idx], options, md.renderer);
                    case "reference_note":
