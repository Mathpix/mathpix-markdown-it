...
var renderReference = function (token) {
    ...
    var theoremNumber = md_theorem_1.getTheoremNumberByLabel(token.content);
...
exports.default = (function (options) {
    ...
    return function (md) {
        ...
        md_theorem_1.resetTheoremEnvironments();
        ...
        md.block.ruler.before("paragraphDiv", "newTheoremBlock", md_theorem_1.newTheoremBlock);
        ...
        md.inline.ruler.before("multiMath", "newTheorem", md_theorem_1.newTheorem); /** Parse \newtheorem */
