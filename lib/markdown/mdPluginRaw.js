...
var renderMath = function (tokens, idx, options) {
    ...
    var dataAttrMathInText = '';
    if ((0, utils_1.isMathInText)(tokens, idx, options)) {
        dataAttrMathInText = ' data-math-in-text="true"';
    }
    var mathEquation = dataAttrMathInText
        ? (0, utils_1.applyAttrToMathml)(token.mathEquation, dataAttrMathInText, options)
        : token.mathEquation;
    ...
    if (((_b = token.mathData) === null || _b === void 0 ? void 0 : _b.error) && options.parserErrors !== mathpix_markdown_model_1.ParserErrors.show) {
        var html = token.type === "inline_math" || token.type === "inline_mathML"
            ? "<span class=\"math-inline\"".concat(dataAttrMathInText, ">")
            : "<span class=\"math-block\"".concat(dataAttr, ">");
    ...
    if (token.type === "equation_math") {
        return idLabels
            ? "<span id=\"".concat(idLabels, "\" class=\"math-block equation-number id=").concat(idLabels, "\" number=\"").concat(attrNumber, "\"").concat(dataAttr, ">").concat(mathEquation, "</span>")
            : "<span  class=\"math-block equation-number \" number=\"".concat(attrNumber, "\"").concat(dataAttr, ">").concat(mathEquation, "</span>");
    }
    else {
        return token.type === "inline_math" || token.type === "inline_mathML"
            ? idLabels
                ? "<span id=\"".concat(idLabels, "\" class=\"math-inline id=").concat(idLabels, "\"").concat(dataAttrMathInText, ">").concat(mathEquation, "</span>")
                : "<span class=\"math-inline ".concat(idLabels, "\"").concat(dataAttrMathInText, ">").concat(mathEquation, "</span>")
            : idLabels
                ? "<span id=\"".concat(idLabels, "\" class=\"math-block id=").concat(idLabels, "\"").concat(dataAttr, ">").concat(mathEquation, "</span>")
                : "<span class=\"math-block ".concat(idLabels, "\"").concat(dataAttr, ">").concat(mathEquation, "</span>");
    }
};
...
function paragraphDiv(state, startLine /*, endLine*/) {
    ...
    token.parentToken = (_b = state.env) === null || _b === void 0 ? void 0 : _b.parentToken;
