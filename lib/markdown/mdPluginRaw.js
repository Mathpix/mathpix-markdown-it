...
var asciiMath = function (state, silent) {
    ...
    var endMarkerPos = exports.findEndMarkerPos(state.src, asciiMarker, startMathPos);
    if (endMarkerPos === -1) {
        return false;
    }
    ...
    var nextPos = endMarkerPos + asciiMarker.length;
    if (!silent) {
...
var renderAsciiMath = function (tokens, idx, options) {
    ...
    try {
        ...
        mathEquation = mathjax_1.MathJax.AsciiMathToSvg(math, false, { cwidth: cwidth });
