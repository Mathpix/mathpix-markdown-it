...
exports.checkTagOutsideInlineCode = exports.removeCaptionsSetupFromTableAndFigure = exports.removeCaptionsFromTableAndFigure = exports.getTerminatedRules = exports.renewCommandSpanEnd = exports.skipOptionalArg = exports.findEndMarker = exports.getInlineCodeListFromString = exports.buildInlineCodePositionSet = exports.uniqueSlug = exports.slugify = exports.findEndMarkerPos = exports.isWhitespace = exports.isSpace = exports.isAsciiLetter = exports.tocRegexp = void 0;
...
var isAsciiLetter = function (code) {
...
var findEndMarkerPos = function (str, endMarker, i) {
    var index = str.indexOf(endMarker, i);
 ...
 * */
var findEndMarker = function (str, startPos, beginMarker, endMarker, onlyEnd, openBracketsBefore, inlineCodePositions) {
    ...
    if (!str || (0, exports.isWhitespace)(str)) {
        return { res: false };
    }
    ...
    var codePositions = inlineCodePositions !== null && inlineCodePositions !== void 0 ? inlineCodePositions : (0, exports.buildInlineCodePositionSet)((0, exports.getInlineCodeListFromString)(str));
    for (var i = startPos + 1; i < str.length; i++) {
        var chr = str[i];
        nextPos = i;
        var shielded = isShielded;
...
var skipOptionalArg = function (text, at, sameLine, codePositions) {
    if (text[at] !== '[') {
        return at;
    }
    if (sameLine) {
    ...
    var found = (0, exports.findEndMarker)(text, at, '[', ']', false, 0, codePositions);
...
exports.skipOptionalArg = skipOptionalArg;
...
var renewCommandSpanEnd = function (text, from, codeIndex) {
    if (from === void 0) { from = 0; }
    consts_1.RENEWCOMMAND_STICKY_RE.lastIndex = from;
    var match = consts_1.RENEWCOMMAND_STICKY_RE.exec(text);
    // Left hot, a shared regex is one missing assignment away from starting mid-string.
    consts_1.RENEWCOMMAND_STICKY_RE.lastIndex = 0;
    if (!match) {
        return -1;
    }
    var pos = from + match[0].length;
    ...
    var codeSpans = codeIndex !== null && codeIndex !== void 0 ? codeIndex : null;
    var codePositions = function () {
        if (!codeSpans) {
            codeSpans = (0, exports.buildInlineCodePositionSet)((0, exports.getInlineCodeListFromString)(text));
        }
        return codeSpans;
    };
    ...
    for (var arg = 0; arg < 2; arg++) {
        ...
        while (arg === 1 && text[pos] === '[') {
            var past = (0, exports.skipOptionalArg)(text, pos, false, codePositions());
            if (past < 0) {
                return -1;
            }
            pos = past;
        ...
        if (text[pos] === '{') {
            var paired = (0, exports.findEndMarker)(text, pos, '{', '}', false, 0, codePositions());
        ...
        if (arg === 0 && text[pos] === '\\') {
            pos++;
            while (pos < text.length && (0, exports.isAsciiLetter)(text.charCodeAt(pos))) {
                pos++;
            }
            continue;
        }
...
exports.renewCommandSpanEnd = renewCommandSpanEnd;
