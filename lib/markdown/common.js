...
exports.checkTagOutsideInlineCode = exports.removeCaptionsSetupFromTableAndFigure = exports.removeCaptionsFromTableAndFigure = exports.getTerminatedRules = exports.renewCommandSpanEnd = exports.findEndMarker = exports.getInlineCodeListFromString = exports.buildInlineCodePositionSet = exports.uniqueSlug = exports.slugify = exports.findEndMarkerPos = exports.isWhitespace = exports.isSpace = exports.isAsciiLetter = exports.tocRegexp = void 0;
...
var renewCommandSpanEnd = function (text) {
    ...
    for (var arg = 0; arg < 2; arg++) {
        ...
        while (arg === 1 && text[pos] === '[') {
            var arity = (0, exports.findEndMarker)(text, pos, '[', ']', false, 0, codePositions());
