...
var getSanitizerConfig = function (options) {
    if (options === void 0) { options = {}; }
    return {
        allowedTags: sanitizeHtml.defaults.allowedTags.concat(consts_1.allowedTags),
        allowedClasses: consts_1.allowedClasses,
        allowedAttributes: consts_1.allowedAttributes,
        exclusiveFilter: function (frame) {
            // Allow YouTube iframes
            if (frame.tag !== 'iframe')
                return false;
            var parsed = url.parse(frame.attribs.src || '');
