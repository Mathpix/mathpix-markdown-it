...
function sanitizeHtml(html, options, _recursing) {
    ...
    var parser = new htmlparser.Parser({
        onopentag: function (name, attribs) {
            ...
            var allowChildTags = ((parentFrame === null || parentFrame === void 0 ? void 0 : parentFrame.tag) === 'svg' && name === 'metadata') || (parentFrame === null || parentFrame === void 0 ? void 0 : parentFrame.allowChildTags);
...
sanitizeHtml.defaults = {
    allowedTags: ['h3', 'h4', 'h5', 'h6', 'blockquote', 'p', 'a', 'ul', 'ol',
        ...
        'table', 'thead', 'caption', 'tbody', 'tr', 'th', 'td', 'pre', 'iframe', 'u'],
