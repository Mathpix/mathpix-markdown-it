...
exports.StatePushTabulars = function (state, cTabular, align, startLine) {
    var token;
...
exports.StatePushTabularBlock = function (state, startLine, nextLine, content, align, centerTables) {
    if (centerTables === void 0) { centerTables = false; }
    ...
    exports.StatePushTabulars(state, cTabular, align, startLine);
    StatePushParagraphClose(state);
    return true;
};
exports.BeginTabular = function (state, startLine, endLine, silent) {
    var _a, _b, _c, _d;
    ...
    var dataTags = utils_1.findOpenCloseTags(lineText, consts_1.openTagTabular, consts_1.closeTagTabular);
    ...
    for (; nextLine <= endLine; nextLine++) {
        ...
        if (iOpen > 0) {
            dataTags = utils_1.findOpenCloseTags(lineText, consts_1.openTagTabular, consts_1.closeTagTabular, pending);
    ...
    if (state.md.options.centerTables) {
        return exports.StatePushTabularBlock(state, startLine, nextLine, resString, 'center', true);
    }
    else {
        return exports.StatePushTabularBlock(state, startLine, nextLine, resString, '');
    }
};
