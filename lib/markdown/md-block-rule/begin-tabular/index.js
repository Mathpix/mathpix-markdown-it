        ...
        for (var j = 0; j < res.length; j++) {
            ...
            if (res[j].token === 'inline') {
                ...
                if (res[j].content) {
                    ...
                    if (consts_1.BEGIN_LIST_ENV_INLINE_RE.test(res[j].content)) {
                        var children = [];
                        var envIsInline = !!((_b = state.env) === null || _b === void 0 ? void 0 : _b.isInline);
                        state.env.isInline = true;
                        state.md.block.parse(res[j].content, state.md, state.env, children);
                        if (children === null || children === void 0 ? void 0 : children.length) {
                            try {
                                for (var children_1 = (e_1 = void 0, tslib_1.__values(children)), children_1_1 = children_1.next(); !children_1_1.done; children_1_1 = children_1.next()) {
