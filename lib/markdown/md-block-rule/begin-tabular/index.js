...
exports.BeginTabular = function (state, startLine, endLine) {
    ...
    var matchOpenG = null;
    var matchCloseG = null;
    var lineText = state.src.slice(pos, max);
    if (lineText.charCodeAt(0) !== 0x5c /* \ */) {
        return false;
    }
    var resString = '';
    matchOpenG = lineText.match(exports.openTagG);
    var iOpen = (matchOpenG === null || matchOpenG === void 0 ? void 0 : matchOpenG.length) ? matchOpenG.length : 0;
    if (!iOpen)
        return false;
    if (iOpen > 0) {
        ...
        if (closeTag.test(lineText)) {
            ...
            if (matchCloseG === null || matchCloseG === void 0 ? void 0 : matchCloseG.length) {
    ...
    for (; nextLine <= endLine; nextLine++) {
        ...
        resString += '\n' + lineText;
        matchOpenG = lineText.match(exports.openTagG);
        if (matchOpenG === null || matchOpenG === void 0 ? void 0 : matchOpenG.length) {
