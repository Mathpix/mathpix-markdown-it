        ...
        if (!cellsAll[i] || cellsAll[i].length === 0) {
            if (i < cellsAll.length - 1) {
                ...
                for (var k = 0; k < numCol; k++) {
                    ...
                    var data_1 = tabular_td_1.AddTd('', { h: cAlign[k], v: vAlign[k], w: cWidth[k] }, { left: cLeft, right: cRight, bottom: CellsHLines[i + 1][k], top: i === 0 ? CellsHLines[i][k] : '' }, CellsHLSpaces[i + 1][k]);
        ...
        for (var j = 0; j < numCol; j++) {
            ...
            if (j >= (cells.length) && ic < numCol) {
                for (var k = ic; k < numCol; k++) {
                    ...
                    var data_2 = tabular_td_1.AddTd('', { h: cAlign[k], v: vAlign[k], w: cWidth[k] }, { left: cLeft_1, right: cRight_1, bottom: CellsHLines[i + 1][k], top: i === 0 ? CellsHLines[i][k] : '' }, CellsHLSpaces[i + 1][k]);
            ...
            if (cells[j] && cells[j].trim().length > 0) {
                ...
                var data_3 = tabular_td_1.AddTd(content, { h: cAlign[ic], v: vAlign[ic], w: cWidth[ic] }, { left: cLeft, right: cRight, bottom: CellsHLines[i + 1][ic], top: i === 0 ? CellsHLines[i][ic] : '' }, CellsHLSpaces[i + 1][ic], decimal[ic]);
                ...
                var data_4 = tabular_td_1.AddTd('', { h: cAlign[ic], v: vAlign[ic], w: cWidth[ic] }, { left: cLeft, right: cRight, bottom: CellsHLines[i + 1][ic], top: i === 0 ? CellsHLines[i][ic] : '' }, CellsHLSpaces[i + 1][ic]);
                tsv_row[ic] = data_4.content;
                res = res.concat(data_4.res);
            }
        }
        index_1.tsvPush(tsv_row);
        res.push({ token: 'tr_close', tag: 'tr', n: -1 });
    }
