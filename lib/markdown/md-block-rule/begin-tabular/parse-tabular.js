    ...
    for (var i = 0; i < rows.length; i++) {
        ...
        for (var j = 0; j < numCol; j++) {
            ...
            if (cells[j] && cells[j].trim().length > 0) {
                var multi = (0, multi_column_row_1.getMultiColumnMultiRow)(cells[j], { lLines: cLines[ic], align: cAlign[ic], rLines: cRight }, forLatex);
                if (multi) {
                ...
                var parseSub = (0, sub_tabular_1.getSubTabular)(cells[j], 0, true, forLatex);
                if (parseSub && parseSub.length > 0) {
                    res = res.concat((0, tabular_td_1.AddTdSubTable)(parseSub, { h: cAlign[ic], v: vAlign[ic], w: cWidth[ic] }, { left: cLeft, right: cRight, bottom: CellsHLines[i + 1] ? CellsHLines[i + 1][ic] : 'none',
                ...
                if (parseMath) {
                    ...
                    content = (0, common_1.getContent)(cells[j]);
                }
...
var ParseTabular = function (str, i, align, options) {
    if (align === void 0) { align = ''; }
    if (options === void 0) { options = {}; }
    var res = [];
    ...
    if (posEnd > 0) {
        ...
        if (posBegin >= 0) {
            ...
            str = (0, sub_tabular_1.pushSubTabular)(str, subRes, 0, posEnd);
            res = (0, exports.ParseTabular)(str, 0, align, options);
        }
    }
    else {
