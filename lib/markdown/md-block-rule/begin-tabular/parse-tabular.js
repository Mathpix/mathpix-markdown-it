    ...
    var _loop_1 = function (i) {
        ...
        var _loop_2 = function (j) {
            ...
            if (cells[j] && cells[j].trim().length > 0) {
                var multi = (0, multi_column_row_1.getMultiColumnMultiRow)(cells[j], { lLines: cLines[ic], align: cAlign[ic], rLines: cRight }, forLatex, options === null || options === void 0 ? void 0 : options.forPptx, skipVisual);
                if (multi) {
                ...
                var handleSubTable = function (subTable) {
                    if (subTable.some(function (item) { return (0, common_1.detectLocalBlock)(item.content); })) {
                        colsToFixWidth.add(ic);
                    }
