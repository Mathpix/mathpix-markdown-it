...
// `\begin{tabular}` with optional [pos] and required {align}.
...
var setTokensTabular = function (str, align, options, isSubTabular, pos) {
    ...
    // Source bracket wins; option only injects 't'/'b' to preserve round-trip for unset/'c'.
    ...
    var _loop_1 = function (i) {
            ...
            if (i < cellsAll.length - 1) {
                ...
                for (var k = 0; k < numCol; k++) {
                    ...
                    var data_1 = (0, tabular_td_1.AddTd)('', { h: cAlign[k], v: vAlign[k], w: cWidth[k] }, { left: cLeft, right: cRight, bottom: CellsHLines[i + 1] ? CellsHLines[i + 1][k] : 'none',
                        top: i === 0 ? CellsHLines[i] ? CellsHLines[i][k] : 'none' : '' }, CellsHLSpaces[i + 1][k], null, skipVisual);
                    markColIfHasList(colsToFixWidth, k, data_1.content);
                    try {
                        for (var _d = (e_1 = void 0, tslib_1.__values(data_1.res)), _e = _d.next(); !_e.done; _e = _d.next()) {
                            var t = _e.value;
                            res.push(t);
                        }
                    }
        ...
        var _loop_2 = function (j) {
            var e_2, _f, e_3, _g, e_4, _h, e_5, _j, e_6, _k;
            ...
            if (j >= (cells.length) && ic < numCol) {
                for (var k = ic; k < numCol; k++) {
                    ...
                    try {
                        for (var _l = (e_2 = void 0, tslib_1.__values(data_2.res)), _m = _l.next(); !_m.done; _m = _l.next()) {
                            var t = _m.value;
                            res.push(t);
                        }
                    }
            ...
            if (cells[j] && cells[j].trim().length > 0) {
                ...
                if (multi) {
                    ...
                    if (multi.subTable) {
                        ...
                        try {
                            for (var _o = (e_3 = void 0, tslib_1.__values(multi.subTable)), _p = _o.next(); !_p.done; _p = _o.next()) {
                                var t = _p.value;
                                res.push(t);
                            }
                        }
                ...
                if (parseSub && parseSub.length > 0) {
                    try {
                        for (var _q = (e_4 = void 0, tslib_1.__values(handleSubTable(parseSub))), _r = _q.next(); !_r.done; _r = _q.next()) {
                            var t = _r.value;
                            res.push(t);
                        }
                    }
                ...
                var data_3 = (0, tabular_td_1.AddTd)(content, { h: cAlign[ic], v: vAlign[ic], w: cWidth[ic] }, { left: cLeft, right: cRight, bottom: CellsHLines[i + 1] ? CellsHLines[i + 1][ic] : 'none',
                    top: i === 0 ? CellsHLines[i] ? CellsHLines[i][ic] : 'none' : '' }, CellsHLSpaces[i + 1][ic], decimal[ic], skipVisual);
                markColIfHasList(colsToFixWidth, ic, data_3.content);
                try {
                    for (var _s = (e_5 = void 0, tslib_1.__values(data_3.res)), _t = _s.next(); !_t.done; _t = _s.next()) {
                        var t = _t.value;
                        res.push(t);
                    }
                }
                    ...
                    try {
                        if (_t && !_t.done && (_j = _s.return)) _j.call(_s);
                    }
                ...
                var data_4 = (0, tabular_td_1.AddTd)('', { h: cAlign[ic], v: vAlign[ic], w: cWidth[ic] }, { left: cLeft, right: cRight, bottom: CellsHLines[i + 1] ? CellsHLines[i + 1][ic] : 'none',
                    top: i === 0 ? CellsHLines[i] ? CellsHLines[i][ic] : 'none' : '' }, CellsHLSpaces[i + 1][ic], null, skipVisual);
                markColIfHasList(colsToFixWidth, ic, data_4.content);
                try {
                    for (var _u = (e_6 = void 0, tslib_1.__values(data_4.res)), _v = _u.next(); !_v.done; _v = _u.next()) {
                        var t = _v.value;
                        res.push(t);
                    }
                }
