...
var getVerticallyColumnAlign = function (align, numCol, posDefault) {
    var aH = ['c', 'S', 'r', 'l'];
    var aV = ['m', 'p', 'b'];
    var hAlign = [];
    var vAlign = [];
    ...
    var defaultV = posToVAlign(posDefault);
...
var getParams = function (str, i) {
    ...
    return { align: res, index: ires, pos: pos };
};
