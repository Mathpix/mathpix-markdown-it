...
exports.detectLocalBlock = exports.shouldRewriteColSpec = exports.getRowLines = exports.getCellsAll = exports.getDecimal = exports.getParams = exports.getVerticallyColumnAlign = exports.bracketToVAlign = exports.normalizeDefaultCellVerticalAlign = exports.parseTabularPos = exports.getColumnAlign = exports.getColumnLines = exports.generateUniqueId = exports.getContent = void 0;
...
var parseTabularPos = function (raw) {
    if (!raw)
        return undefined;
...
exports.parseTabularPos = parseTabularPos;
// Maps the `defaultCellVerticalAlign` option to the internal bracket form.
var normalizeDefaultCellVerticalAlign = function (value) {
    if (!value)
        return undefined;
    switch (value.trim()) {
        case 'top': return 't';
...
exports.normalizeDefaultCellVerticalAlign = normalizeDefaultCellVerticalAlign;
// Bracket → CSS vertical-align (default 'middle').
var bracketToVAlign = function (bracket) {
    switch (bracket) {
        case 't': return 'top';
...
exports.bracketToVAlign = bracketToVAlign;
...
var getVerticallyColumnAlign = function (align, numCol, bracketDefault) {
    var aH = ['c', 'S', 'r', 'l'];
    var aV = ['m', 'p', 'b'];
    var hAlign = [];
    var vAlign = [];
    ...
    var defaultV = (0, exports.bracketToVAlign)(bracketDefault);
...
var getParams = function (str, i) {
    ...
    var bracket;
    var scanFrom = i;
    while (scanFrom < str.length && /\s/.test(str[scanFrom]))
        scanFrom++;
    if (str[scanFrom] === '[') {
        var closeIdx = str.indexOf(']', scanFrom + 1);
        var openBrace = str.indexOf('{', scanFrom);
        if (closeIdx > scanFrom && (openBrace < 0 || closeIdx < openBrace)) {
            bracket = (0, exports.parseTabularPos)(str.slice(scanFrom + 1, closeIdx));
            scanFrom = closeIdx + 1;
        }
    }
    var index = str.indexOf('{', scanFrom);
    var res = '';
    var ires = 0;
    if (index < 0) {
        return null;
    ...
    return { align: res, index: ires, bracket: bracket };
};
 ...
 */
var detectLocalBlock = function (content) {
    return consts_1.BEGIN_LIST_ENV_INLINE_RE.test(content);
};
exports.detectLocalBlock = detectLocalBlock;
