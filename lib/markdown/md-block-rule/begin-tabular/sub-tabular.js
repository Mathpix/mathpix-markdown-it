...
var pushSubTabular = function (str, subTabularContent, subRes, posBegin, posEnd, i, level) {
    ...
    var beginIdx = subTabularContent.indexOf('\\begin{tabular}');
    var bracket = beginIdx >= 0
        ? (_c = (0, common_1.getParams)(subTabularContent, beginIdx + '\\begin{tabular}'.length)) === null || _c === void 0 ? void 0 : _c.bracket
        : undefined;
    subTabular.set(id, {
