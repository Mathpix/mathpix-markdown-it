...
var CODE_FENCE = '```';
var CODE_FENCE_RE = /```/;
var extractedCodeBlocks = new Map();
...
var getExtractedCodeBlockContent = function (inputStr, i) {
    ...
    for (var j = 0; j < cellM.length; j++) {
        ...
        var original = extractedCodeBlocks.get(id);
        ...
        var _a = (0, placeholder_utils_1.getInlineContextAroundSpan)(resContent, start, end), beforeNonSpace = _a.beforeNonSpace, afterNonSpace = _a.afterNonSpace;
