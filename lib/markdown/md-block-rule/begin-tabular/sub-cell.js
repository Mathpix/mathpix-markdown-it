...
var getSubDiagbox = function (str) {
    ...
    var codePositions = function () {
        if (!codeIndex) {
            codeIndex = (0, common_2.buildInlineCodePositionSet)((0, common_2.getInlineCodeListFromString)(str));
        }
        return codeIndex;
    };
    while ((match = consts_1.reDiagboxG.exec(str))) {
        var index = match.index;
        var _a = tslib_1.__read((0, exports.extractNextBraceContent)(str, index + match[0].length, codePositions()), 2), left = _a[0], newIndex = _a[1];
        var _b = tslib_1.__read((0, exports.extractNextBraceContent)(str, newIndex, codePositions()), 2), right = _b[0], endIndex = _b[1];
...
var extractNextBraceContent = function (str, startIndex, codeIndex) {
    if (str[startIndex] !== '{') {
        return ['', startIndex];
    }
    // Handed in by a caller reading several commands of one string: built here it cost the whole string.
    var codePositions = codeIndex !== null && codeIndex !== void 0 ? codeIndex : (0, common_2.buildInlineCodePositionSet)((0, common_2.getInlineCodeListFromString)(str));
