...
var getMultiColumnMultiRow = function (str, params, forLatex, forPptx, skipVisual) {
    ...
    var effectivePos = (_f = (0, common_1.parseTabularPos)(vpos)) !== null && _f !== void 0 ? _f : params.posDefault;
    var cellV = effectivePos === 't' ? 'top'
    ...
    var mrWidthNormalized = (width || '').trim().replace('*', '');
    var multi = {
        mc: matchMC ? { span: mc, alignSpec: matchMC[2] } : null,
        mr: matchMR ? { span: mr, vpos: vpos, widthRaw: width || '', width: mrWidthNormalized } : null,
    };
    ...
    if (parseSub === null || parseSub === void 0 ? void 0 : parseSub.length) {
        return { mr: mr, mc: mc, attrs: attrs, content: '', subTable: parseSub, latex: latex, multi: multi };
    }
    content = (0, sub_code_1.getExtractedCodeBlockContent)(content, 0);
    return { mr: mr, mc: mc, attrs: attrs, content: content, subTable: null, latex: latex, multi: multi };
};
