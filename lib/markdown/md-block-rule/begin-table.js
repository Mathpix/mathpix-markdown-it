...
var StatePushCaptionTable = function (state, type) {
    ...
    token.content = ((_b = (_a = state.md) === null || _a === void 0 ? void 0 : _a.options) === null || _b === void 0 ? void 0 : _b.nonumbers) ? "" + type[0].toUpperCase() + type.slice(1) + ": " + caption
        : "" + type[0].toUpperCase() + type.slice(1) + " " + num + ": " + caption;
    token.print = ((_d = (_c = state.md) === null || _c === void 0 ? void 0 : _c.options) === null || _d === void 0 ? void 0 : _d.nonumbers) ? "" + type[0].toUpperCase() + type.slice(1) + ": "
...
exports.BeginTable = function (state, startLine, endLine, silent) {
    var pos = state.bMarks[startLine] + state.tShift[startLine];
    var max = state.eMarks[startLine];
    var token;
