...
var StatePushCaptionTable = function (state, type) {
    ...
    token.content = ((_b = (_a = state.md) === null || _a === void 0 ? void 0 : _a.options) === null || _b === void 0 ? void 0 : _b.nonumbers)
        ? "".concat(type[0].toUpperCase()).concat(type.slice(1), ": ") + caption
        : "".concat(type[0].toUpperCase()).concat(type.slice(1), " ").concat(num, ": ") + caption;
    token.print = ((_d = (_c = state.md) === null || _c === void 0 ? void 0 : _c.options) === null || _d === void 0 ? void 0 : _d.nonumbers)
