...
exports.parseBlockIntoTokenChildren = exports.SetTokensBlockParse = exports.appendEnvAwareContentLine = void 0;
 ...
 */
var appendEnvAwareContentLine = function (state, nextLine, lineText, resText, envDepth) {
    var wasInsideLst = envDepth > 0;
    ...
    if (wasInsideLst) {
        ...
        return { resText: resText, envDepth: envDepth };
    }
    resText = resText && lineText ? resText + '\n' + lineText : resText + lineText;
    return { resText: resText, envDepth: envDepth };
};
exports.appendEnvAwareContentLine = appendEnvAwareContentLine;
/**
