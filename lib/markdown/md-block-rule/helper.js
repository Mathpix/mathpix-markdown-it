...
var parseBlockIntoTokenChildren = function (state, content, token, opts) {
    ...
    var _c, _d;
    if (opts === void 0) { opts = {}; }
    var _e = opts.disableBlockRules, disableBlockRules = _e === void 0 ? false : _e;
    var children = [];
    ...
    var safeContent = disableBlockRules
        ...
        : content;
    if (disableBlockRules) {
        var blockRuler = (_d = (_c = state.md) === null || _c === void 0 ? void 0 : _c.block) === null || _d === void 0 ? void 0 : _d.ruler;
        // 1. Let's remember which of these rules were included
        var rulesToReEnable = [];
        try {
