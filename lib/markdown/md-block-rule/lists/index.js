...
var setTokenListItemOpenBlock = function (state, startLine, endLine, marker, li, iLevel, eLevel, iLevelC) {
    ...
    token.parentType = ((_b = state.types) === null || _b === void 0 ? void 0 : _b.length) > 0
        ? state.types[state.types.length - 1]
        : '';
...
var ListItemsBlock = function (state, items) {
    ...
    items.forEach(function (item) {
        var _a;
        var rawContent = (_a = item === null || item === void 0 ? void 0 : item.content) !== null && _a !== void 0 ? _a : '';
            ...
            items.forEach(function (item) {
                ...
                if (blockStartTag.test(item.content) || (item.content.indexOf('`') > -1) //&& item.content.charCodeAt(0) === 0x5c /* \ */
                    ...
                    if (match) {
                        ...
                        var rawContent = (_b = (_a = item === null || item === void 0 ? void 0 : item.content) === null || _a === void 0 ? void 0 : _a.slice(match.index + match[0].length + 1)) !== null && _b !== void 0 ? _b : '';
                        var itemContent = rawContent.trim();
                        (0, helper_1.SetTokensBlockParse)(state, itemContent, { disableBlockRules: true });
                ...
                for (var j = 0; j < children.length; j++) {
                    ...
                    if (child.hasOwnProperty('marker')) {
                        ...
                        var paddingChild = 0;
                        for (var i = 0; i < ((_c = child.markerTokens) === null || _c === void 0 ? void 0 : _c.length); i++) {
...
var ReRenderListsItem = function (state, startLine, endLine, silent) {
    ...
    if (match) {
        ...
        var rawContent = (_a = content === null || content === void 0 ? void 0 : content.slice(match.index + match[0].length + 1)) !== null && _a !== void 0 ? _a : '';
        var itemContent = rawContent.trim();
        (0, helper_1.SetTokensBlockParse)(state, itemContent, { disableBlockRules: true });
