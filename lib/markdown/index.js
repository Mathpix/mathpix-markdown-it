...
var markdownToHtmlPipeline = function (content, options) {
    ...
    if (options.renderElement && options.renderElement.inLine) {
        ...
        var _a = options.textDirection, textDirection = _a === void 0 ? mathpix_markdown_model_1.TextDirection.unset : _a;
        if (textDirection !== mathpix_markdown_model_1.TextDirection.unset) {
            (0, injectTextDirection_1.injectTextDirection)(md, textDirection);
        }
