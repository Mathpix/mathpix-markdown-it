...
exports.applyMathpixMarkdownPlugins = exports.markdownToHTML = exports.markdownToHtmlPipeline = void 0;
...
var applyMathpixMarkdownPlugins = function (options) {
    if (options === void 0) { options = {}; }
    var md = mdInit(options);
    md = (0, rules_1.injectRenderRules)(md);
    return md;
};
exports.applyMathpixMarkdownPlugins = applyMathpixMarkdownPlugins;
