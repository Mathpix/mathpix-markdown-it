...
var markdownToHtmlPipelineSegments = function (content, options) {
    ...
    md.renderer.render = function (tokens, options, env) {
        ...
        for (var i = 0; i < tokens.length; i++) {
            ...
            if (pendingCloseTag) {
                var openType = pendingCloseTag.replace('_close', '_open');
