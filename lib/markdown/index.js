...
var mdInit = function (options) {
    ...
    if (renderOptions === null || renderOptions === void 0 ? void 0 : renderOptions.disableMarkdown) {
        md.use(mdPluginConfigured_1.mdDisableRulesForRendering, options.renderOptions);
    }
    return md;
};
