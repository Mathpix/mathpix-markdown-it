...
var MathpixMarkdown_Model = /** @class */ (function () {
    function MathpixMarkdown_Model() {
        ...
        this.parseMathmlWordDocumentByHTML = function (html) {
            var parser = new DOMParser();
            var doc = parser.parseFromString(html, "text/html");
            return _this.parseMathmlWordDocument(doc);
        };
        this.parseMathmlWordDocument = parse_mmd_element_1.parseMathmlWordDocument;
