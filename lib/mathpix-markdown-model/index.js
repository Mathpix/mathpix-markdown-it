...
var MathpixMarkdown_Model = /** @class */ (function () {
    function MathpixMarkdown_Model() {
        ...
        this.markdownToDOCX = function (str, options) {
            if (options === void 0) { options = {}; }
            var mathString = _this.isCheckFormula ? _this.checkFormula(str, _this.showTimeLog) : str;
            options.lineNumbering = false;
            var outMath = {
            ...
            var htmlString = _this.markdownToHTML(mathString, options);
            return htmlString;
        };
        this.markdownToDOCX2 = function (str, options) {
            if (options === void 0) { options = {}; }
            return tslib_1.__awaiter(_this, void 0, void 0, function () {
                var mathString, outMath, htmlString, fileBuffer;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            mathString = this.isCheckFormula ? this.checkFormula(str, this.showTimeLog) : str;
                            options.lineNumbering = false;
                            outMath = {
                                include_mathml_word: true,
                                include_latex: false,
                            ...
                            options.outMath = outMath;
                            htmlString = this.markdownToHTML(mathString, options);
                            return [4 /*yield*/, html_to_docx_1.default(htmlString, null, { table: { row: { cantSplit: true } } })];
                        case 1:
                            fileBuffer = _a.sent();
