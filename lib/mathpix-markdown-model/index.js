...
var styles_fonts_1 = require("../mathjax/styles-fonts");
var styles_lists_1 = require("../mathjax/styles-lists");
...
var MathpixMarkdown_Model = /** @class */ (function () {
    function MathpixMarkdown_Model() {
        ...
        this.loadMathJax = function (notScrolling, setTextAlignJustify, isResetBodyStyles) {
            ...
            try {
                ...
                if (!elStyle) {
                    ...
                    style.innerHTML = bodyStyles + styles_1.MathpixStyle(setTextAlignJustify) + styles_1.codeStyles + styles_tabular_1.tabularStyles + styles_lists_1.listsStyles;
        ...
        this.getMathpixStyleOnly = function () {
            var style = _this.getMathjaxStyle() + styles_1.MathpixStyle(false) + styles_1.codeStyles + styles_tabular_1.tabularStyles + styles_lists_1.listsStyles;
            return style;
        };
        this.getMathpixStyle = function (stylePreview, showToc, tocContainerName) {
            ...
            var style = styles_1.ContainerStyle + _this.getMathjaxStyle() + styles_1.MathpixStyle(stylePreview) + styles_1.codeStyles + styles_tabular_1.tabularStyles + styles_lists_1.listsStyles;
            if (showToc) { }
            return stylePreview
