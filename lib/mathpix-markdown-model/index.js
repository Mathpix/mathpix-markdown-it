...
var mdPluginText_1 = require("../markdown/mdPluginText");
...
var MathpixMarkdown_Model = /** @class */ (function () {
    function MathpixMarkdown_Model() {
        ...
        this.markdownToHTMLWithSize = function (markdown, options, fonts) {
            if (options === void 0) { options = {}; }
            if (fonts === void 0) { fonts = null; }
            (0, mdPluginText_1.resetSizeCounter)();
            if (fonts) {
                text_dimentions_1.fontMetrics.loadFont(fonts);
            }
            var html = _this.markdownToHTML(markdown, options);
            return {
                html: html,
                size: mdPluginText_1.size
            };
        };
