...
var MathpixMarkdown_Model = /** @class */ (function () {
    function MathpixMarkdown_Model() {
        var _this = this;
        this.disableFancyArrayDef = ['replacements', 'list', 'usepackage', 'toc', 'emoji'];
        ...
        this.loadMathJax = function (notScrolling, setTextAlignJustify, isResetBodyStyles, maxWidth) {
            ...
            try {
                ...
                if (!elStyle) {
                    ...
                    style.innerHTML = bodyStyles + styles_1.MathpixStyle(setTextAlignJustify, true, maxWidth) + styles_code_1.codeStyles + styles_tabular_1.tabularStyles() + styles_lists_1.listsStyles;
