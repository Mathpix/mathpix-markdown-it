    ...
    function MathpixMarkdown_Model() {
            ...
            try {
                ...
                if (!elStyle) {
                    ...
                    style.innerHTML = bodyStyles
                        + (0, styles_1.MathpixStyle)(setTextAlignJustify, useColors, maxWidth, scaleEquation)
                        + (0, styles_code_1.codeStyles)(useColors)
                        + (0, styles_tabular_1.tabularStyles)(useColors)
        ...
        this.getMathpixStyleOnly = function (scaleEquation, useColors) {
            ...
            var style = _this.getMathjaxStyle()
                + (0, styles_1.MathpixStyle)(false, useColors, '', scaleEquation)
                + (0, styles_code_1.codeStyles)(useColors)
                + (0, styles_tabular_1.tabularStyles)(useColors)
                + styles_lists_1.listsStyles
                + (0, styles_2.menuStyle)()
        ...
        this.getMathpixStyle = function (stylePreview, showToc, tocContainerName, scaleEquation, isPptx, useColors) {
            ...
            if (useColors === void 0) { useColors = true; }
            var style = (0, styles_container_1.ContainerStyle)(useColors) + _this.getMathjaxStyle() + (0, styles_1.MathpixStyle)(false, useColors, '', scaleEquation, isPptx) + (0, styles_code_1.codeStyles)(useColors) + (0, styles_tabular_1.tabularStyles)(useColors) + styles_lists_1.listsStyles;
            if (!stylePreview) {
                return style;
            }
            return showToc
        ...
        this.getMathpixMarkdownStyles = function (useColors, scaleEquation) {
            ...
            style += (0, styles_1.MathpixStyle)(false, useColors, '', scaleEquation);
