        ...
        this.checkEquationNumber = function (html) {
            try {
                ...
                for (var i = 0; i < links.length; i++) {
                    ...
                    var dataParentheses = links[i].getAttribute("data-parentheses");
                    if (!equationNumber) {
