...
var MathpixMarkdown_Model = /** @class */ (function () {
    function MathpixMarkdown_Model() {
        ...
        this.loadMathJax = function (notScrolling, setTextAlignJustify, isResetBodyStyles, maxWidth, scaleEquation, useColors) {
        ...
        this.buildStyles = function (opts) {
            if (opts === void 0) { opts = {}; }
            var _a = opts.setTextAlignJustify, setTextAlignJustify = _a === void 0 ? false : _a, _b = opts.useColors, useColors = _b === void 0 ? true : _b, _c = opts.maxWidth, maxWidth = _c === void 0 ? '' : _c, _d = opts.scaleEquation, scaleEquation = _d === void 0 ? true : _d, _e = opts.isPptx, isPptx = _e === void 0 ? false : _e, _f = opts.resetBody, resetBody = _f === void 0 ? false : _f, _g = opts.container, container = _g === void 0 ? false : _g, _h = opts.mathjax, mathjax = _h === void 0 ? false : _h, _j = opts.code, code = _j === void 0 ? true : _j, _k = opts.preview, preview = _k === void 0 ? false : _k, _l = opts.toc, toc = _l === void 0 ? false : _l, _m = opts.tocContainerName, tocContainerName = _m === void 0 ? 'toc' : _m, _o = opts.menu, menu = _o === void 0 ? false : _o;
            var css = '';
            if (resetBody)
                css += styles_1.resetBodyStyles;
            if (container)
                css += (0, styles_container_1.ContainerStyle)(useColors);
            if (mathjax)
                css += _this.getMathjaxStyle();
            css += (0, styles_1.MathpixStyle)(setTextAlignJustify, useColors, maxWidth, scaleEquation, isPptx);
            if (code)
                css += (0, styles_code_1.codeStyles)(useColors);
            css += (0, styles_tabular_1.tabularStyles)(useColors);
            css += styles_lists_1.listsStyles;
            if (preview)
                css += styles_1.PreviewStyle;
            if (toc)
                css += (0, styles_1.TocStyle)(tocContainerName);
            if (menu) {
                css += (0, styles_2.menuStyle)();
                css += (0, clipboard_copy_styles_1.clipboardCopyStyles)();
            }
            return css;
        };
        this.getMathpixStyleOnly = function (scaleEquation, useColors) {
            if (scaleEquation === void 0) { scaleEquation = true; }
            if (useColors === void 0) { useColors = true; }
        ...
        this.getMathpixStyle = function (stylePreview, showToc, tocContainerName, scaleEquation, isPptx, useColors) {
