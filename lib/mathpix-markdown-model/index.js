...
var canvas_1 = require("../markdown/canvas");
...
var MathpixMarkdown_Model = /** @class */ (function () {
    function MathpixMarkdown_Model() {
         ...
         */
        this.markdownToCanvasHTML = function (markdown, options) {
            if (options === void 0) { options = {}; }
             ...
             */
            var canvasOptions = tslib_1.__assign(tslib_1.__assign({}, options), { forCanvas: true, htmlWrapper: false, outMath: tslib_1.__assign(tslib_1.__assign({}, options.outMath), { output_format: 'mathml' }) });
            /** Runs on the finished HTML so raw HTML from the document is covered too. */
            var rendered = (0, markdown_1.markdownToHTML)(markdown, canvasOptions);
            var html = (0, canvas_1.applyCanvasProfile)(rendered);
            if (!lineNumbering) {
                mathjax_1.MathJax.Reset();
            }
            return { html: html, warnings: (0, canvas_1.canvasWarnings)(html, rendered) };
        };
