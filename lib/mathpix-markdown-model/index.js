...
var text_dimentions_1 = require("../markdown/common/text-dimentions");
var counters_1 = require("../markdown/common/counters");
var TTocStyle;
(function (TTocStyle) {
...
var MathpixMarkdown_Model = /** @class */ (function () {
    function MathpixMarkdown_Model() {
        ...
        this.markdownToHTMLWithSize = function (markdown, options, fontMetricsOptions) {
            if (options === void 0) { options = {}; }
            if (fontMetricsOptions === void 0) { fontMetricsOptions = null; }
            (0, counters_1.resetSizeCounter)();
            if (fontMetricsOptions) {
                text_dimentions_1.fontMetrics.loadFont(fontMetricsOptions);
            }
            options.enableSizeCalculation = true;
            var html = _this.markdownToHTML(markdown, options);
            return {
                html: html,
                size: counters_1.size
            };
        };
        this.markdownToHTMLSegments = function (markdown, options) {
            if (options === void 0) { options = {}; }
            ...
            return (0, markdown_1.markdownToHTMLSegments)(markdown, options);
        };
        this.markdownToHTMLSegmentsAsync = function (markdown, options) {
            if (options === void 0) { options = {}; }
            return tslib_1.__awaiter(_this, void 0, void 0, function () {
                var _a, isDisableFancy, disableRules;
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = options.isDisableFancy, isDisableFancy = _a === void 0 ? false : _a;
                            disableRules = isDisableFancy ? this.disableFancyArrayDef : options ? options.disableRules || [] : [];
                            this.setOptions(disableRules);
                            return [4 /*yield*/, (0, markdown_1.markdownToHTMLSegmentsAsync)(markdown, options)];
        ...
        this.markdownToHTMLAsync = function (markdown, options) {
            if (options === void 0) { options = {}; }
            return tslib_1.__awaiter(_this, void 0, void 0, function () {
                var _a, lineNumbering, _b, isDisableFancy, _c, htmlWrapper, disableRules, html, title, styles, fonts;
                return tslib_1.__generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            _a = options.lineNumbering, lineNumbering = _a === void 0 ? false : _a, _b = options.isDisableFancy, isDisableFancy = _b === void 0 ? false : _b, _c = options.htmlWrapper, htmlWrapper = _c === void 0 ? false : _c;
                            disableRules = isDisableFancy ? this.disableFancyArrayDef : options ? options.disableRules || [] : [];
                            this.setOptions(disableRules);
                            return [4 /*yield*/, (0, markdown_1.markdownToHTMLAsync)(markdown, options)];
                        case 1:
                            html = _d.sent();
                            if (!lineNumbering) {
                                mathjax_1.MathJax.Reset();
                            ...
                            if (typeof htmlWrapper !== "boolean") {
                                title = htmlWrapper.title
                                    ? htmlWrapper.title
                                    : '';
                                styles = htmlWrapper.includeStyles
                                    ? "<style>".concat(this.getMathpixStyle(true), "</style>")
                                    : '';
                                fonts = htmlWrapper.includeFonts
                                    ? '<link rel="stylesheet" href="https://cdn.mathpix.com/fonts/cmu.css"/>'
                                    : '';
                                return [2 /*return*/, (0, html_page_1.generateHtmlPage)(title, html, styles, fonts)];
                            }
                            return [2 /*return*/, (0, html_page_1.generateHtmlPage)('Title', html, '', '')];
                    }
                });
            });
        };
