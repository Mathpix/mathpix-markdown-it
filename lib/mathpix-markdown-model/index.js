...
var MathpixMarkdown_Model = /** @class */ (function () {
    function MathpixMarkdown_Model() {
        var _this = this;
        this.disableFancyArrayDef = consts_1.fancyRulesDef;
        ...
        this.markdownToHTML = function (markdown, options) {
            ...
            var disableRules = (0, mmdRulesToDisable_1.mergeDisableRulesWithDisableFancy)(isDisableFancy, options === null || options === void 0 ? void 0 : options.disableRules);
