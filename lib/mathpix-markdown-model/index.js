...
var MathpixMarkdown_Model = /** @class */ (function () {
    function MathpixMarkdown_Model() {
        ...
        this.getMathpixStyleOnly = function () {
            var style = _this.getMathjaxStyle() + styles_1.MathpixStyle(false) + styles_1.codeStyles + styles_tabular_1.tabularStyles;
            return style;
        };
        this.getMathpixStyle = function (stylePreview, showToc, tocContainerName) {
            ...
            var style = styles_1.ContainerStyle + _this.getMathjaxStyle() + styles_1.MathpixStyle(stylePreview) + styles_1.codeStyles + styles_tabular_1.tabularStyles;
            if (showToc) { }
            return stylePreview
