...
var MathpixMarkdown_Model = /** @class */ (function () {
    function MathpixMarkdown_Model() {
        ...
        this.loadMathJax = function (notScrolling, setTextAlignJustify, isResetBodyStyles, maxWidth, _scaleEquation, useColors) {
            ...
            if (_scaleEquation === void 0) { _scaleEquation = true; }
        ...
        this.buildStyles = function (opts) {
            ...
            css += (0, styles_1.MathpixStyle)(setTextAlignJustify, useColors, maxWidth, isPptx);
            if (code)
        ...
        this.getMathpixStyleOnly = function (_scaleEquation, useColors) {
            if (_scaleEquation === void 0) { _scaleEquation = true; }
            if (useColors === void 0) { useColors = true; }
         ...
         *  @deprecated _scaleEquation is unused — kept for backward compatibility */
        this.getMathpixStyle = function (stylePreview, showToc, tocContainerName, _scaleEquation, isPptx, useColors) {
         ...
         *  @deprecated _scaleEquation is unused — kept for backward compatibility */
        this.getMathpixMarkdownStyles = function (useColors, _scaleEquation) {
            if (useColors === void 0) { useColors = true; }
            if (_scaleEquation === void 0) { _scaleEquation = true; }
            return _this.buildStyles({
                useColors: useColors,
