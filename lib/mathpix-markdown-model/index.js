...
var MathpixMarkdown_Model = /** @class */ (function () {
    function MathpixMarkdown_Model() {
        ...
        this.getMathjaxStyle = function () {
            try {
                var MathJaxStyle = mathjax_1.MathJax.Stylesheet();
                var mathJaxStyleSvg = MathJaxStyle.children[0] && MathJaxStyle.children[0].value
                    ? MathJaxStyle.children[0].value
                    : MathJaxStyle.innerHTML;
                var MathJaxStyleCHTML = mathjax_1.MathJax.StylesheetCHTML();
                var mathJaxStyleChtml = MathJaxStyleCHTML.children[0] && MathJaxStyleCHTML.children[0].value
        ...
        this.getMathpixStyle = function (stylePreview, showToc, tocContainerName, scaleEquation, isPptx) {
            ...
            var mathjaxStyle = _this.getMathjaxStyle();
            var style = (0, styles_container_1.ContainerStyle)() + mathjaxStyle + (0, styles_1.MathpixStyle)(false, true, '', scaleEquation, isPptx) + styles_code_1.codeStyles + (0, styles_tabular_1.tabularStyles)() + styles_lists_1.listsStyles;
            if (showToc) { }
            if (!stylePreview) {
                return style;
            }
