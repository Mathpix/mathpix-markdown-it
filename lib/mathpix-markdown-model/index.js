...
var MathpixMarkdown_Model = /** @class */ (function () {
    function MathpixMarkdown_Model() {
        ...
        this.loadMathJax = function (notScrolling, setTextAlignJustify, isResetBodyStyles, maxWidth, scaleEquation) {
            ...
            try {
                ...
                if (!elStyle) {
                    ...
                    style.innerHTML = bodyStyles + styles_1.MathpixStyle(setTextAlignJustify, true, maxWidth, scaleEquation) + styles_code_1.codeStyles + styles_tabular_1.tabularStyles() + styles_lists_1.listsStyles;
        ...
        this.getMathpixStyleOnly = function (scaleEquation) {
            if (scaleEquation === void 0) { scaleEquation = true; }
            var style = _this.getMathjaxStyle() + styles_1.MathpixStyle(false, true, '', scaleEquation) + styles_code_1.codeStyles + styles_tabular_1.tabularStyles() + styles_lists_1.listsStyles;
            return style;
        };
        this.getMathpixStyle = function (stylePreview, showToc, tocContainerName, scaleEquation) {
            ...
            if (scaleEquation === void 0) { scaleEquation = true; }
            var style = styles_container_1.ContainerStyle() + _this.getMathjaxStyle() + styles_1.MathpixStyle(stylePreview, true, '', scaleEquation) + styles_code_1.codeStyles + styles_tabular_1.tabularStyles() + styles_lists_1.listsStyles;
            if (showToc) { }
            return stylePreview
