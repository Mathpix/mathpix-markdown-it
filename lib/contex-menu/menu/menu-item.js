...
var createMathMenuItem = function (type, value) {
    try {
        var itemTitle = '';
        var sourceStr = '';
        switch (type) {
            case consts_1.eMathType.latex:
                itemTitle = 'LaTeX';
                sourceStr = (0, parse_mmd_element_1.formatSource)(value);
                break;
            case consts_1.eMathType.asciimath:
                itemTitle = 'Asciimath';
                sourceStr = (0, parse_mmd_element_1.formatSource)(value);
                break;
            case consts_1.eMathType.linearmath:
                itemTitle = 'Linearmath';
                sourceStr = (0, parse_mmd_element_1.formatSource)(value);
                break;
            case consts_1.eMathType.mathml:
                itemTitle = 'Mathml';
                sourceStr = (0, parse_mmd_element_1.formatSourceMML)(value);
                break;
            case consts_1.eMathType.mathmlword:
                itemTitle = 'Mathml (MS Word)';
                sourceStr = value;
                break;
            case consts_1.eMathType.typst:
                itemTitle = 'Typst';
                sourceStr = (0, parse_mmd_element_1.formatSource)(value);
                break;
            case consts_1.eMathType.typst_inline:
                itemTitle = 'Typst (inline)';
                sourceStr = (0, parse_mmd_element_1.formatSource)(value);
                break;
            case consts_1.eMathType.tsv:
                itemTitle = 'TSV';
                sourceStr = (0, parse_mmd_element_1.formatSource)(value, true);
                break;
            case consts_1.eMathType.csv:
                itemTitle = 'CSV';
                sourceStr = (0, parse_mmd_element_1.formatSource)(value, true);
                break;
            case consts_1.eMathType.table_markdown:
                itemTitle = 'Markdown';
                sourceStr = (0, parse_mmd_element_1.formatSource)(value, true);
                break;
            case consts_1.eMathType.smiles:
                itemTitle = 'Smiles';
                sourceStr = value;
                break;
        }
...
exports.createMathMenuItem = createMathMenuItem;
