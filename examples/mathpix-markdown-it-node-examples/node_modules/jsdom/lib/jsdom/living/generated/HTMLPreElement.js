...
exports.create = function create(globalObject, constructorArgs, privateData) {
  ...
  const ctor = globalObject[ctorRegistry]["HTMLPreElement"];
  if (ctor === undefined) {
...
exports.install = function install(globalObject) {
  ...
  class HTMLPreElement extends globalObject.HTMLElement {
    ...
    set width(V) {
      ...
      this[impl].setAttributeNS(null, "width", String(V));
    }
  }
  ...
  globalObject[ctorRegistry]["HTMLPreElement"] = HTMLPreElement;

  Object.defineProperty(globalObject, "HTMLPreElement", {
    configurable: true,
    writable: true,
