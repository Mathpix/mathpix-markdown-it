...
declare const SVGmunder_base: Constructor<CommonMunder<SVGWrapper<any, any, any>>> & Constructor<SVGmsub<any, any, any>>;
export declare class SVGmunder<N, T, D> extends SVGmunder_base {
    static kind: string;
    static useIC: boolean;
    toSVG(parent: N): void;
}
declare const SVGmover_base: Constructor<CommonMover<SVGWrapper<any, any, any>>> & Constructor<SVGmsup<any, any, any>>;
export declare class SVGmover<N, T, D> extends SVGmover_base {
    static kind: string;
    static useIC: boolean;
    toSVG(parent: N): void;
}
declare const SVGmunderover_base: Constructor<CommonMunderover<SVGWrapper<any, any, any>>> & Constructor<SVGmsubsup<any, any, any>>;
